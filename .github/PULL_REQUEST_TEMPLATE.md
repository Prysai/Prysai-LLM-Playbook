...
<!-- What single coherent problem does this PR solve? What is intentionally outside scope? -->
...
<!-- State original / adapted / vendored / reference-only. List URLs, access dates, licenses, attribution, and asset-register updates. -->
...
<!-- What remains not_run, unreviewed, unavailable, or not proved by this PR? -->

## Status claim

<!-- Does this change request draft/candidate/verified/production-ready or fact-status changes? Link the evidence; otherwise say none. -->

## Checklist

- [ ] I changed the canonical source, not only a generated projection.
- [ ] I recorded volatile facts with URL, access date, scope, owner, and next review.
- [ ] I registered external assets and license decisions before adaptation.
