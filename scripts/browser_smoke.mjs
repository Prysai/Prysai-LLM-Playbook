...
try {
  ...
  assert.equal(await page.locator('.site-header .wordmark').getAttribute('target'), '_top', 'the Playbook logo does not leave the hosted iframe wrapper for the canonical Docs site');
  ...
  assert.equal(await page.locator('.site-footer .wordmark').getAttribute('target'), '_top', 'the footer logo does not leave the hosted iframe wrapper for the canonical Docs site');
