...
try {
  ...
  for (const locale of ['en', 'zh', 'es', 'ja', 'ko', 'de', 'zh-tw', 'fr']) {
    ...
    const localizedJourney = {
      ...
      ko: { title: '경로를 고르기 전에 Playbook 전체 흐름을 보세요.', steps: ['LLM 기초 코어', '첫 번째 범위가 정해진 작업', '증거 루프', '선택 실습 경로'], alt: 'LLM 기초 코어에서 첫 번째 범위가 정해진 작업, 증거 루프와 선택 실습 경로로 이어지는 Playbook 학습 여정' },
  ...
  const visualJourneyLabels = {
    ...
    ko: ['LLM 기초 코어', '첫 번째 범위가 정해진 작업', '증거 루프', '선택 실습 경로'],
