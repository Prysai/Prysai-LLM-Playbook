...
REQUIRED = (
    ...
    "docs/research/pr-workflow-benchmark-2026-08-30.md",
    ...
    "docs/governance/core-content-inventory.yaml",
    "docs/governance/core-release-scope.md",
    "docs/governance/quality-register.yaml",
    "docs/governance/first-win-pilot-kit.yaml",
    "docs/governance/release-evidence.yaml",
    "docs/governance/repository-security-policy.yaml",
    ...
    "docs/adr/0036-repository-security-policy-and-pr-gate.md",
    "docs/quality/first-win-pilot-protocol-v2.md",
    "book/table-of-contents-EN.md",
    "book/labs/README-EN.md",
    "site/index.html",
    "site/app.js",
    "site/styles.css",
    "package.json",
    ...
    "scripts/validate_core_release_scope.py",
    "scripts/test_validate_core_release_scope.py",
    "scripts/validate_core_course.py",
    "scripts/test_core_course.py",
    "evals/candidates/core-course-v1/README.md",
    "evals/candidates/core-course-v1/fixture.json",
    "evals/candidates/core-course-v1/scoring-rubric.json",
    "evals/candidates/core-course-v1/run-record-template.json",
