...
DEEP_CONTRACTS: dict[str, tuple[ContractGroup, ...]] = {
    "lab-006-agent-stop-conditions": (
        ...
        ContractGroup("lost_response", (r"lost response", r"réponse perdue", r"respuesta perdida", r"verlorene Antwort", r"応答喪失", r"응답 손실|응답 유실", r"丢失响应", r"回應遺失|響應丟失")),
    ...
    "lab-007-action-boundaries": (
        ...
        ContractGroup("stop_conditions", (r"stop conditions?", r"conditions? d.?arrêt", r"condiciones? de parada", r"Stoppbedingungen", r"停止条件", r"停止條件", r"停止条件", r"중지 조건|중지")),
        ContractGroup("evidence_table", (r"evidence table", r"tableau de preuves|table de preuves", r"tabla de pruebas|tabla de evidencia", r"Beweistabelle|Evidenztabelle", r"証拠.*表", r"증거\s*표|최소 증거", r"证据表", r"證據表")),
