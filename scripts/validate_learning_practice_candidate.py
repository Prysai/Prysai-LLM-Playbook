...
TEXT_REQUIREMENTS = {
    ...
    SITE: [
        "reader.html?path=book%2Fcommunication-clinic-EN.md&amp;lang=en#first-practice-intake",
        "reader.html?path=book%2Fcommunication-clinic-EN.md&amp;lang=en#language-practice-route",
