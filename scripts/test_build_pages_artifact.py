...
def main() -> int:
    ...
    require('href="https://docs.prysai.com/llm-playbook/" target="_blank" rel="noreferrer"' in root_entry, "Playbook logo must open the canonical Docs URL in a new tab")
