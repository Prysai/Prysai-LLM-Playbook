<!-- content_id: french-practice-loop | locale: EN | language: en | default_locale: EN | translation_status: source | source_revision: worktree-2026-08-16 -->
...
Save the target, first attempt, help, revision, changed task, and unknowns.
One loop is a recorded practice attempt, not mastery or independent
assessment. For the Spanish version of the same loop, open
[spanish-practice-loop-EN.md](spanish-practice-loop-EN.md).
