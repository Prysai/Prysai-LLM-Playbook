...
Usa estos mensajes con cualquier LLM de texto para un intercambio ficticio de cuatro turnos en francés, en un café o en un hotel. No prometen fluidez, un aprendizaje más rápido ni correcciones correctas. Usa solo datos inventados; detente si el modelo pide identidad, reserva, pasaporte, dirección, contacto o datos de pago reales.
