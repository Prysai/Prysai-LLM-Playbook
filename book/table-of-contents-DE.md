<!-- content_id: book-table-of-contents | locale: DE | language: de | default_locale: EN | translation_status: in-progress | translated_from: EN | source_revision: worktree-2026-08-15 -->

# Prysai LLM Playbook: Inhaltsverzeichnis auf Deutsch

Dies ist ein deutscher Leseweg. Der kanonische Katalog enthält 22 Kapitel im
Status `candidate` und 18 Labs im Status `draft`; alle 40 Einheiten haben einen
deutschen Pfad. Jeder Link auf dieser Seite führt zum entsprechenden deutschen
Inhalt und wechselt nicht die Sprache.

## Hier beginnen

1. [Erste universelle LLM-Aufgabe](routes/universal-core-foundations-DE.md) —
...
## Verfügbarkeit nach Kapitel

| Kanonisches Kapitel | Status des deutschen Lesewegs |
| --- | --- |
...
| 15 — Forschungspfad: Von der Frage zu prüfbarem Wissen | [Verfügbar: Kapitel 15](chapters/15-research-track-DE.md) · `candidate / in-progress` |
