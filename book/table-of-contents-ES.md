...
- Capítulo: fuente ES del capítulo 1 (versión en español aún no disponible)
- Experimento: fuente ES de lab-011 (versión en español aún no disponible)
...
- Capítulo: Capítulo 2 · versión ES candidata (versión en español aún no disponible)
- Experimento: Lab 001 · versión ES candidata (versión en español aún no disponible)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-002 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: Capítulo 4 · fuente ES (versión en español aún no disponible)
- Experimento: Lab 007 · fuente ES (versión en español aún no disponible)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-004 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento principal: lab-013 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento de apoyo: lab-009 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-003 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimentos: lab-002 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md) · lab-013 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-005 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-006 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimentos: lab-004 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md) · lab-005 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-008 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-009 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-010 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimentos: lab-003 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md) · lab-009 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimentos: lab-001 · versión ES candidata (versión en español aún no disponible) · lab-010 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimento: lab-012 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
- Capítulo: [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
- Experimentos: lab-008 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md) · lab-010 · [migración en curso · ruta fuente actual](chapters/02-first-safe-task-ES.md)
...
|---|---|---|---|
| lab-001 | Primera tarea segura | `draft` · `not_run` | versión ES candidata (versión en español aún no disponible) |
| lab-002 | Protocolo de tarea | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-003 | Revisión de evidencia | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-004 | Selección de Skills | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-005 | Diseño de Skills | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-006 | Condiciones de parada del Agent | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-007 | Límites de acción | `draft` · `not_run` | fuente ES (versión en español aún no disponible) |
| lab-008 | Pregunta de investigación | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-009 | Ciclo de vida de ingeniería | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-010 | Contexto del producto | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-011 | GPT, Codex, herramientas y Agents | `draft` · `not_run` | fuente ES (versión en español aún no disponible) |
| lab-012 | Migración de capacidades de equipo | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |
| lab-013 | Corte vertical L3 auditable | `draft` · `not_run` | [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md) |

## Evaluación, estados e investigación de problemas reales

- Índice de experimentos — [migración en curso · fuente actual](labs/lab-001-first-safe-task-ES.md): 13 archivos reales, niveles, dominios, foco de migración y `lab_status`.
...
Los experimentos principales independientes de L0, L3 y L6 son lab-011 · fuente ES (versión en español aún no disponible), lab-013 · migración en curso (versión en español aún no disponible) y lab-012 · migración en curso (versión en español aún no disponible).
