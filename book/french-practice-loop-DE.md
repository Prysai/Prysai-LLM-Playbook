<!-- content_id: french-practice-loop | locale: DE | language: de | default_locale: EN | translation_status: candidate | translated_from: EN | source_revision: worktree-2026-08-16 -->

# Kleine Französischübung: sechs kopierbare Nachrichten

Mit jedem Text-LLM kannst du einen fiktiven Austausch im Café oder Hotel über vier Turns üben. Die Nachrichten versprechen weder Flüssigkeit noch schnelleres Lernen oder richtige Rückmeldung. Nutze nur erfundene Angaben und stoppe, sobald das Modell nach echter Identität, Buchung, Pass, Adresse, Kontakt oder Zahlung fragt.
