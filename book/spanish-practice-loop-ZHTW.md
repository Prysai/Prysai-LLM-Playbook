...
<!-- content_id: spanish-practice-loop | locale: ZHTW | language: zh-TW | default_locale: EN | translation_status: in-progress | source_revision: worktree-2026-08-16 -->

# 西班牙語小練習：六條可複製訊息

把下面訊息用於任意文字 LLM，完成一次虛構的四輪西班牙語學習小組時間確認練習。它們展示可遷移的 LLM 練習迴圈：定小目標、先嚐試、接受一處有限糾錯、換題、日後複測。它們不承諾流利、學習加速或反饋一定正確。只用虛構細節；模型索要真實身份、學校、日曆、賬號、地址、聯絡方式或付款資訊時停止。
...
儲存目標、第一次嘗試、幫助、修訂、變化任務和未知項。一次迴圈只是有記錄的練習，不是掌握或獨立測評。
