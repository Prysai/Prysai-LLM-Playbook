<!-- content_id: french-practice-loop | locale: ZH | language: zh-CN | default_locale: EN | translation_status: candidate | translated_from: EN | source_revision: worktree-2026-08-16 -->

# 法语小练习：六条可复制消息

用这六条消息配合任意文本大语言模型，进行虚构的四轮法语学习小组对话练习，再换成一次作业计划对话。这些消息不承诺流利、更快学会或反馈一定正确。只使用虚构信息；如果模型索要真实身份、学校记录、地址、联系方式或支付信息，立即停止。
