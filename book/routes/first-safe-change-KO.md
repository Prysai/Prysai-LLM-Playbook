...
Lab 001은 폐기 가능한 프로젝트에서 실제로 사용할 명령어가 어디에서 왔는지 확인하고, 범위가 제한된 README만
변경하는 연습입니다. 실제 프로젝트에서는 좋은 조건이지만, 첫 실습에서는 순환처럼
...
2. **`index.html`만** 수정합니다. 같은 가상 독자를 대상으로 화면에 보이는 문장 하나를 바꿉니다.
