...
- [LLM platform and client encyclopedia](routes/platform-adapter-guide-EN.md) — an optional reference for choosing web, mobile, desktop, IDE, terminal, and hosted surfaces, with dated installation and first-use boundaries; `candidate / not_run`
