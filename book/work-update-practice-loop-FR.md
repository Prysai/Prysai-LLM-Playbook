...
```text
Je veux pratiquer une mise à jour de travail fictive. Demande-moi un lecteur,
jusqu’à trois faits confirmés, une inconnue ou un blocage et une demande possible.
N’invente ni progrès, ni dates, ni causes, ni approbations, ni promesses. Renvoie
uniquement une courte liste de faits et attends mon brouillon.
```
...
## 3. Repérer une lacune importante
```text
Compare ma première version avec ce contrôle : le lecteur peut trouver les
faits confirmés, l’inconnue ou le blocage et la demande ; aucun progrès ni aucune
promesse sans preuve n’apparaît. Signale au plus une lacune importante et cite
les mots concernés. Si les faits ne permettent pas de trancher, dis « inconnu ».
Ne réécris pas la mise à jour.
```

## 4. Réviser avec mes propres mots
```text
Donne un seul indice partiel pour cette lacune, puis attends ma révision. N’écris
pas une mise à jour de remplacement, sauf si je la demande explicitement après
avoir essayé. Garde séparés ma première version, ton indice et ma révision.
```
