...
현재 한국어로 읽을 수 있는 것은 장 2개와 Lab 3개입니다. 이 페이지의 모든 링크는
...
| 02 — 첫 안전하고 검증 가능한 작업 완료하기 | 아직 한국어 파일이 없습니다. |
...
- 아직 `locale-neutral`인 거버넌스와 출처 문서는 한국어 번역으로 제시하지 않습니다. 수와 상태는 [현재 프로젝트 상태](../docs/governance/content-status.yaml)에서 확인하세요.
