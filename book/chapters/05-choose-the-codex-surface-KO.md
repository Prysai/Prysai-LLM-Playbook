...
<nav class="chapter-navigation" aria-label="장 탐색">
  <table role="presentation" width="100%">
    <tr>
      ...
      <td align="right"><a data-chapter-nav="next" href="../table-of-contents-KO.md" aria-label="한국어 목차로 돌아가기: 6장은 아직 번역되지 않음">다음 장 준비 중 →<br><strong>6장 제공 상태 보기</strong></a></td>
    </tr>
  </table>
</nav>
