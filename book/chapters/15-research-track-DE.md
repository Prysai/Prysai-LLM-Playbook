...
Fragen, Belegketten und Konfliktprotokolle sind stabile Methoden. Erreichbare Seiten, Produktfakten, Forenbeiträge und Suchergebnisse ändern sich; protokolliere Zugriffstag, Umfang und nächste Prüfung, statt sie als zeitlose Fakten zu behandeln. Die [Quellennotizen der Evidenzbibliothek](../evidence-library-DE.md#source-notes) halten Kontext und Status der jeweiligen Referenz fest. Für die in diesem Kapitel verwendeten Fälle und Grenzen sind außerdem das [Register der Feldprobleme](../evidence-library-DE.md#source-notes), die [Prüfung offizieller Fakten](../evidence-library-DE.md#source-notes) und das [Register für Assets und Lizenzen](../evidence-library-DE.md#source-notes) die ersten Anlaufstellen.
