<!-- content_id: lab-018-language-transfer | locale: ES | language: es | default_locale: EN | translation_status: in-progress | translated_from: EN | source_revision: worktree-2026-08-16 -->
...
reflection: "¿Qué respuesta sobrevivió al cambio sin ayuda y qué afirmación sigue sin respaldo hasta ejecutar la tarea retrasada?"
status: draft
run_status: not_run
...
| Criterio | 0 | 1 | 2 |
|---|---|---|---|
| Información requerida | Falta o es incorrecta | Parcial | Todos los hechos transmitidos |
| Significado | Intercambio se rompe | Requiere reparación | Comprensible sin reparación |
| Aclaración | Ninguna cuando hace falta | Guiada o confusa | Pregunta y respuesta pertinentes |
...
<hr>
<nav class="lab-navigation" aria-label="Navegación de Labs"><table role="presentation" width="100%"><tr><td align="left"><a data-lab-nav="previous" href="lab-017-skill-discovery-audit-ES.md">← Anterior<br><strong>Lab 017 · auditoría del descubrimiento de Skills</strong></a></td><td align="right"></td></tr></table></nav>
<!-- lab-navigation:end -->
