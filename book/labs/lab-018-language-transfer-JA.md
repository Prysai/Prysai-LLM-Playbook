...
title: "初心者向けの学習調整会話を使った入力練習で、保持と転移を試す"
level: L2
...
# Lab 018: 初心者向けの学習調整会話を使った入力練習で、保持と転移を試す
...
これらの出典は想起、フィードバック、遅延確認、転移の設計判断を支えます。この
Lab が学習を改善することや、どのモデル／プラットフォームも有効な教師であることは
証明しません。状態は `draft / not_run` のままです。
