...
<nav class="lab-navigation" aria-label="Lab 탐색">
  <table role="presentation" width="100%">
    <tr>
      <td align="left"><a data-lab-nav="previous" href="lab-002-task-protocol-KO.md" aria-label="이전 Lab: Lab 002 · 막연한 요청을 작업 프로토콜로 바꾸기">← 이전 Lab<br><strong>Lab 002 · 작업 프로토콜</strong></a></td>
