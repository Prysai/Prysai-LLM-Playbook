<!-- content_id: lab-018-language-transfer | locale: DE | language: de | default_locale: EN | translation_status: in-progress | translated_from: EN | source_revision: worktree-2026-08-16 -->

---
id: lab-018-language-transfer
title: "Einen getippten Reiseaustausch für Anfänger auf Behalten und Transfer testen"
level: L2
domain: language-learning
goal: "Unter festen Bedingungen einen fünfminütigen getippten Reiseaustausch durchführen, einen geänderten Fall und eine vorab deklarierte verzögerte Aufgabe testen, ohne eine Beobachtung in Flüssigkeit umzudeuten"
setup: "Synthetische Reisekarten, feste Rubrik, Wegwerf-Lokalprotokoll; kein Netzwerk, Zugangsdaten, externer Kontakt, Produktion oder automatisierte Erinnerung"
...
transfer_task: "Nach einem vorab deklarierten Sieben-Tage-Fenster (± ein Tag) einen vorverfassten Reiseaustausch mit geändertem Ort, Wortschatz und Mehrdeutigkeit durchführen"
transfer_domain: "Reiseinformationsaustausch für Anfänger"
...
# Lab 018: Einen getippten Reiseaustausch für Anfänger auf Behalten und Transfer testen
...
Tippe in fünf Minuten Begrüßung, Reservierungs- oder Zielinformation, eine Klärungsfrage, eine Antwort und Abschluss, sodass die praktische Bedeutung verständlich bleibt. Arbeite nur in einem lokalen Markdown-Protokoll. Nicht browsen, anmelden, Zugangsdaten nutzen, Menschen oder Unternehmen kontaktieren, Reisen buchen, kaufen, veröffentlichen oder automatisierte Erinnerungen anlegen.

Bei Basis- und bewerteten Aufgaben sind nur Aufgabenkarte und leere Notizen erlaubt: kein Übersetzer, Wörterbuch, Transkript, Modellantwort oder generierter Vorschlag. Der Coach darf die Anweisung klären, aber vor dem Speichern der Basis keinen Inhalt der Zielsprache liefern.

| Kriterium | 0 | 1 | 2 |
|---|---|---|---|
| Erforderliche Information | Fehlt oder falsch | Teilweise | Alle Fakten vermittelt |
| Bedeutung | Austausch bricht ab | Reparatur nötig | Ohne Reparatur verständlich |
| Klärung | Keine bei Bedarf | Angestoßen/unklar | Relevante Frage und Antwort |
...
Nutze B1: Hotelrezeption; du bist Rivera mit Reservierung für zwei Nächte, bestätigst Frühstückszeit und fragst nach dem Aufzug; die Rezeption hört zunächst eine Nacht. Tippe in der geübten Sprache, Zug um Zug, höchstens fünf Minuten. Bewahre genauen Versuch, Fehler, Score und Unbekanntes vor dem Unterrichten.
...
Nutze C1 ohne Modellantwort: Bahnhofsauskunft; du reist nach Valencia mit Ticket 16:40, bestätigst Bahnsteig und Umstieg; die Person nennt zunächst 16:14. Halte Zeit, Hilfen und Rubrik gleich und bewerte getrennt. Ein Pass belegt nur engen Transfer zum Bahnhofsaustausch, nicht Behalten.
...
- [ ] Kein Netzwerk, Geheimnis, Kontakt, Buchung, Kauf, Veröffentlichung oder automatische Erinnerung trat auf.
...
<hr>
<nav class="lab-navigation" aria-label="Labnavigation"><table role="presentation" width="100%"><tr><td align="left"><a data-lab-nav="previous" href="lab-017-skill-discovery-audit-DE.md">← Vorheriges<br><strong>Lab 017 · Audit der Skill-Erkennung</strong></a></td><td align="right"></td></tr></table></nav>
<!-- lab-navigation:end -->
