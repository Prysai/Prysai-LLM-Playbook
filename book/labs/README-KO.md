...
| --- | --- | --- |
| 코드나 프로젝트 폴더 없이 더 명확한 요청이 도움이 되는지 알아보기 | [Lab 001, 파트 A](lab-001-first-safe-task-KO.md#readme-전에파일-없이-하는-프롬프트-비교) | 같은 무해한 메모에 대한 두 응답과 짧은 비교 기록 |
...
| 로컬 파일을 아주 작게 변경하기 | [첫 번째 안전한 변경](../routes/first-safe-change-KO.md) 뒤 [Lab 001, 작업 공간 부분](lab-001-first-safe-task-KO.md#이-실습의-목적) | 폐기 가능한 복사본 안의 검토한 README diff와 범위를 좁힌 로컬 검사 |
