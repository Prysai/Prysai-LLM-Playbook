...
この日本語ルートには Lab 001–004 の四つだけがあります。残りは、日本語ファイルと翻訳状態の
記録ができるまで、このページから英語へリンクしません。
...
| 005 | Skill の設計 | L4 | 日本語版は未提供 |
| 006 | Agent の停止条件 | L5 | 日本語版は未提供 |
| 007 | 行動の境界 | L3 | 日本語版は未提供 |
| 008 | 調査の問い | L3 | 日本語版は未提供 |
| 009 | エンジニアリングのライフサイクル | L3 | 日本語版は未提供 |
| 010 | 共有するプロダクト文脈 | L3 | 日本語版は未提供 |
| 011 | GPT と Codex の境界 | L0 | 日本語版は未提供 |
