...
これは入口ページの日本語訳であり、すべての Lab が日本語で利用できるという意味ではありません。
リンクは `-JA` ファイルだけを開きます。まだないものは明示し、知らないうちに英語へ移動させません。
...
この日本語ルートでは Lab 001–009 と 011 の十件を開けます。未提供の Lab は、日本語ファイルと
翻訳状態の記録ができるまで、このページから英語へリンクしません。
...
| 010 | 共有するプロダクト文脈 | L3 | 日本語版は未提供 |
| 011 | GPT と Codex の境界 | L0 | [Lab 011 を開く](lab-011-gpt-codex-boundaries-JA.md) |
| 012 | チーム能力の移行 | L6 | 日本語版は未提供 |
| 013 | 監査可能な縦方向スライス | L3 | 日本語版は未提供 |
| 014 | 再開時の照合 | L3 | 日本語版は未提供 |
| 015 | 証拠を添えた引き渡し | L5 | 日本語版は未提供 |
| 016 | 副作用の境界 | L3 | 日本語版は未提供 |
| 017 | Skill 発見の監査 | L4 | 日本語版は未提供 |
| 018 | 固定した練習契約での言語転移 | L2 | 日本語版は未提供 |
