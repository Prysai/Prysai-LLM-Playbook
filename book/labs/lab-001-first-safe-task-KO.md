...
setup: "README와 실제 로컬 실행 명령의 근거가 있는 폐기 가능 또는 비운영 Git 프로젝트. 비밀, 고객 데이터, 운영 파일, 외부 쓰기는 사용하지 않는다"
task: "Codex에게 먼저 조사와 계획을 요청하고, 확인 후 README.md만 수정하며 실제 diff와 검증 기록을 남긴다"
evidence:
