...
4. 只讀檢查檔案、路徑形狀、設定結構、host 字串和脫敏日誌。
...
秘密或未脫敏個人資料、審批未說明準確物件和載荷、需要外部帳戶或持久環境、
...
遷移時不要複製 GitHub 或組織名稱。把同一結構改寫為「研究來源表」或「發佈
...
復現或官方修復。本文夾具是原創、可回滾練習輸入，不能證明真實帳戶、連接器、
