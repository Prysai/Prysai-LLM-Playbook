...
路径目前有实验 001–004；其余实验会在拥有自己的中文文件和翻译状态记录后再出现在链接中，
不会由本页直接跳去英文。
...
| 005 | 设计 Skill | L4 | 尚未提供中文版本 |
| 006 | Agent 停止条件 | L5 | 尚未提供中文版本 |
| 007 | 行动边界 | L3 | 尚未提供中文版本 |
| 008 | 研究问题 | L3 | 尚未提供中文版本 |
| 009 | 工程生命周期 | L3 | 尚未提供中文版本 |
| 010 | 共享产品上下文 | L3 | 尚未提供中文版本 |
| 011 | GPT 与 Codex 的边界 | L0 | 尚未提供中文版本 |
| 012 | 团队能力迁移 | L6 | 尚未提供中文版本 |
| 013 | 可审计的垂直切片 | L3 | 尚未提供中文版本 |
| 014 | 恢复时的对账 | L3 | 尚未提供中文版本 |
| 015 | 带证据的交付 | L5 | 尚未提供中文版本 |
| 016 | 副作用边界 | L3 | 尚未提供中文版本 |
