...
- 章：第 1 章・JA ソース（日本語版は未提供）
- 実験：lab-011・JA ソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：[lab-001・日本語候補訳](labs/lab-001-first-safe-task-JA.md)（独立した言語レビュー待ち）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-002・移行中・現在のソース（日本語版は未提供）
...
- 章：第 4 章・JA ソース（日本語版は未提供）
- 実験：Lab 007・JA ソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-004・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 主実験：lab-013・移行中・現在のソース（日本語版は未提供）
- 支援実験：lab-009・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-003・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-002・移行中・現在のソース（日本語版は未提供） · lab-013・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-005・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-006・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-004・移行中・現在のソース（日本語版は未提供） · lab-005・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-008・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-009・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-010・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-003・移行中・現在のソース（日本語版は未提供） · lab-009・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：[lab-001・日本語候補訳](labs/lab-001-first-safe-task-JA.md)（独立した言語レビュー待ち） · lab-010・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-012・移行中・現在のソース（日本語版は未提供）
...
- 章：移行中・現在のソース（日本語版は未提供）
- 実験：lab-008・移行中・現在のソース（日本語版は未提供） · lab-010・移行中・現在のソース（日本語版は未提供）
...
| 実験 | 焦点 | 状態 | 入口 |
|---|---|---|---|
 | lab-001 | 最初の安全なタスク | `draft` · `not_run` | [日本語候補訳](labs/lab-001-first-safe-task-JA.md)（独立した言語レビュー待ち） |
| lab-002 | タスク・プロトコル | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-003 | 証拠レビュー | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-004 | Skill の選択 | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-005 | Skill の設計 | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-006 | Agent の停止条件 | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-007 | 行動境界 | `draft` · `not_run` | JA ソース（日本語版は未提供） |
| lab-008 | 研究質問 | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-009 | エンジニアリング・ライフサイクル | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-010 | 製品コンテキスト | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-011 | GPT、Codex、ツール、Agent | `draft` · `not_run` | JA ソース（日本語版は未提供） |
| lab-012 | チーム能力の移行 | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |
| lab-013 | 監査可能な L3 垂直スライス | `draft` · `not_run` | 移行中・現在のソース（日本語版は未提供） |

## 評価、状態、現実の問題研究

- 実験インデックス — 移行中・現在のソース（日本語版は未提供）：13 個の実験、レベル、分野、移行焦点、`lab_status`。
...
L0、L3、L6 の独立した主実験は、lab-011・JA ソース（日本語版は未提供）、lab-013・移行中（日本語版は未提供）、lab-012・移行中（日本語版は未提供）です。
