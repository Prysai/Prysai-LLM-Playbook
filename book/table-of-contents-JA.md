...
あります。現在、日本語で読めるのは 16 章と 11 Lab です。このページのリンクは
...
| 17 — マーケティング・トラック：製品理解から成長実験へ | 日本語ファイルはまだありません。 |
| 18 — コンテンツ、デザイン、データ、自動化トラック | 日本語ファイルはまだありません。 |
| 19 — モデルとワークフローを評価する | 日本語ファイルはまだありません。 |
