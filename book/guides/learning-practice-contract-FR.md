...
- [Apprentissage durable assisté par LLM](../../docs/research/durable-llm-assisted-learning-and-skill-candidates-2026-08-12.md) — synthèse candidate sur le rappel, le feedback, l’espacement, la rétention, le transfert et les limites d’affirmation ; consultée le 12/08/2026.
- [Terminologie du projet](../../CONTEXT.md) — distinction entre modèles, outils, Skills, Agents, preuves et parcours d’apprentissage.
