...
[fiche dՎvaluation Luna](../docs/model-evaluation-luna.md) et la
[recherche de base officielle](../docs/research/openai-codex-baseline.md) pour
...
[source dՎtat courant](../docs/governance/content-status.yaml) et le
[cadre dՎvaluation](../docs/quality/evaluation-framework.md).
