...
当前是 v0.1 的产品地基阶段：六个输入来源已完成目录级审计，22 章书籍结构、13 个实验、真实问题研究、7 个候选 Skill 和 39 项评测夹具已经建立。书籍正文当前以简体中文为主；公开展示页默认英文，可切换中文。章节 19–22、全部候选 Skill 和模型/工作流评测仍需要 fresh-context 前测与运行日志；外部材料不会未经来源、许可证和内容审查直接进入主线。
