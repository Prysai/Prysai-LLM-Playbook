...
- [LLM Foundation Core v1 candidate fixture](candidates/core-course-v1/README.md) — five-outcome route fixtures with correct, boundary, and failure cases. It is `candidate / not_run`; it checks the static learning contract and cannot produce a learner, model, transfer, or release claim.
