...
| A time-sensitive product brief or public signal | [`docs/governance/timely-content-policy.md`](timely-content-policy.md), [`docs/templates/timely-content.md`](../templates/timely-content.md), then `docs/governance/locale-matrix.yaml` | An English `field-note` in `docs/research/`, followed by explicit Reader and generated-index projections | Reader question, why now, source URL, access date, scope, owner, next review, fact status, licence boundary, stale action, and unverified claims | Timely-content focused checks, locale-manifest/search-index checks, local links, and the affected Reader/browser review |
