...
| M05 | 证据审查与恢复 | S05；[真实问题后续研究](research/field-problems-follow-up-2026-08-10.md)；[P2 研究](research/field-problems-follow-up-2026-08-10-p2.md) | [第 9 章 EN 源文件](../book/chapters/09-verification-and-recovery-EN.md)、[第 19 章](../book/chapters/19-evaluate-models-and-workflows.md) | [实验 003](../book/labs/lab-003-evidence-review.md) | [Evidence Review](../skills/prysai-evidence-review/SKILL.md) | 从检查 diff 增加断言—证据对应、未知状态和最小补证动作；本轮补充长等待、自动重试、授权循环、子 Agent 状态错位和 UI/运行时证据分离 | candidate | draft | candidate | current |
...
| M11 | 从定义到交付的工程生命周期 | S05 | [第 8 章](../book/chapters/08-full-lifecycle-workflow-EN.md)、[第 16 章](../book/chapters/16-engineering-track.md) | [实验 009](../book/labs/lab-009-engineering-lifecycle.md) | [Workflow Orchestrator](../skills/prysai-workflow-orchestrator/SKILL.md) | 从单次任务增加两次对照、返工记录、检查点和竖向切片 | candidate | draft | candidate | current |
