...
| S27 | `assets/cases/product-context-real-estate-desktop.png`, `assets/cases/product-context-real-estate-mobile.png` | Prysai Lab synthetic buyer-guide sandbox, remediated and browser-rendered 2026-08-12 | Original HTML/CSS rendered in Edge at 1440×1100 and 390×844; project-aligned red/black institutional guide with no external resources, images, fonts, console errors, page errors, or horizontal overflow | Project-owned synthetic evidence limited to the recorded render scopes; replaces a rejected generic lifestyle concept | `original-rewrite / project-owned`: static-artifact and design-handoff evidence only; not autonomous Skill, customer, inventory, advice, conversion, accessibility-completion, or production evidence |
...
| S48 | `evals/candidates/communication-clinic-v1/` | Prysai Lab original candidate derived from this repository's Lab 002, evaluation framework, and S47 first-party architecture research; created 2026-08-12 | Original synthetic evidence packet, one fixed task contract, three communication conditions, acceptance rubric, run-record template, and static validator; no vendor prompts, answers, course prose, code, screenshots, workflows, credentials, customer data, or external actions | `original-rewrite / project-owned`: repository release license remains unresolved; S47 and its external sources stay reference-only, with Anthropic course material not adapted | Candidate fixture and evaluation plan only; `not_run`, not Lab 018, not in the formal task set, and not evidence that any communication condition, model, learner, or platform performs better |
