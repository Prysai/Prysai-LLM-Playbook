...
- [Platform and client encyclopedia: unified source receipt](platform-encyclopedia-sources-2026-09-05.md) — a dated cross-check of the official product names, client surfaces, installation entries, and deliberately unverified boundaries for Grok Bot, Codex, Claude Code, Google Cloud Code, DeepSeek Harness, and the minimal ChatGPT/Gemini taxonomy. It is a source index, not a runtime or account-access test.
...
- [PR workflow benchmark: Microsoft, Google, and GitHub](pr-workflow-benchmark-2026-08-30.md) — a dated comparison of public first-party contribution guidance, reduced to a portable PR contract for structured disclosure, contribution rights, automated checks, maintainer routing, protected branches, and native auto-merge. It does not claim that Microsoft or Google use one universal template or approval policy, and it does not prove this repository's runtime workflow, reviewer, or merge result.
...
- [Context Packet Builder responsibility audit](context-packet-builder-and-official-curriculum-structures-2026-08-13.md) — an original proposed responsibility boundary for selecting, redacting, and tracing already supplied mixed material. Its fictional admission fixture is `proposed / not_run`; it has not created a Skill, model result, routing result, or security-control finding.
...
- [Coding-agent observability and evidence map](coding-agent-observability-and-evidence-map-2026-08-11.md)
- [Field problem to practice map](field-problem-to-practice-map-2026-08-11.md)
- [English curriculum practical-value and repetition audit](english-curriculum-practical-value-and-repetition-audit-2026-08-11.md)
...
- [Six-locale contract audit](six-locale-contract-audit-2026-08-11.md)
