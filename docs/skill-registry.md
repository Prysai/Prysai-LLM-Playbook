...
| `prysai-dialogue-brief` | Dialogue Brief | Original | Turn an untried low-risk request into one copy-ready first-turn dialogue brief. | `skills/prysai-dialogue-brief` | `0.1.0` | communication-systems maintainer | 2026-09-12 | candidate | `S76` |
...
| `prysai-first-turn-check` | First-Turn Check | Original | Inspect an unsent text-only request for visible outcome, context, response, limits, check, and stop fields. | `skills/prysai-first-turn-check` | `0.1.0` | communication-systems maintainer | 2026-09-12 | candidate | `S83` |
| `prysai-learning-coach` | Learning Coach | Original | Coach observable skills through baseline, retrieval, correction, spacing, and unseen transfer. | `skills/prysai-learning-coach` | `0.4.0` | learning-systems maintainer | 2026-09-12 | candidate | `S52`, `S60`, `S66` |
...
| `prysai-prompt-card-editor` | Prompt Card Editor | Original | Turn an authorized, project-authored prompt idea into one bounded, source-aware teaching card. | `skills/prysai-prompt-card-editor` | `0.1.0` | communication-systems maintainer | 2026-09-14 | candidate | `S91` |
