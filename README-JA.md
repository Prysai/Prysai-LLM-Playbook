...
英語の基礎コアが現在の正規ソースで、その日本語版は再翻訳とレビューを待っています。英語の原文へ自動的にフォールバックせず、この入口は日本語のファイルだけで読める候補経路を維持します。

スペイン語、業務報告、リサーチ確認のカードは、この日本語の補助ルートの後に行う**任意の応用練習**です。LLM を理解する最初の授業ではなく、効率、流暢さ、能力向上も約束しません。

## このルートで残すもの

このプロジェクトの価値は、AI 用語の一覧を増やすことではなく、あと
から確認でき、次の課題にも持っていける成果物を残すことにあります。
この日本語の学習経路は、学習者が次の 3 つを自分で作ることを目指します。
