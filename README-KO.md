...
라이선스: 강의 본문과 교육 자료는 CC BY 4.0, 스크립트와 도구는 Apache-2.0입니다(파일이 달리 명시하지 않는 한). [`LICENSE`](LICENSE), [`LICENSE-CODE`](LICENSE-CODE) 및 라이선스 경계 문서를 참조하세요.
...
데 있습니다. 5개 단원으로 구성된 기초 경로는 학습자가 다음 세 가지를 직접 작성하도록
설계되었습니다.
