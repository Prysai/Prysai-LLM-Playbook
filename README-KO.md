...
현재 프로젝트는 v0.1 제품 기반 단계입니다. 여섯 개 입력 출처에 대한 디렉터리 수준 감사, 22장 책 구조, 13개 실험, 실제 문제 연구, 7개 후보 Skill, 39개 평가 fixture가 마련되어 있습니다. 기존 책 본문은 아직 간체 중국어를 주된 언어로 사용하며, 공개 쇼케이스 페이지는 영어를 기본으로 하고 중국어 전환을 제공합니다.
