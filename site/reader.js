(() => {
  ...
  const coreUnitArtifacts = {
    ...
    'zh-tw': ['一張解釋卡與三項觀察表', '一張四欄位任務卡與第一次輸出', '四個附來源引文的失敗標記', '一張檢查表、最小差異與一項限制', '一份獨立任務回執'],
  };
