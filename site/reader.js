(() => {
  ...
  readerCopy.ja = Object.assign({}, readerCopy.en, {
    skip: '本文へ移動', back: '概要に戻る', githubBadgeAria: 'GitHub でプロジェクトを見る', language: '言語', languageAria: '閲覧言語を選択', detailsAria: 'ページの詳細', chapterList: '章の一覧', labSequence: 'Lab の順序', pageDetails: 'ページの詳細', previousChapter: '前の章', nextChapter: '次の章', previousLab: '前の Lab', nextLab: '次の Lab', onThisPageAria: 'このページの目次', onThisPage: 'このページの目次', openSource: 'ソースファイルを開く ↗', loading: 'ソースページを読み込んでいます…', copyPrompt: 'プロンプトをコピー', copiedPrompt: 'プロンプトをコピーしました', copyFailed: 'コピーできませんでした', retry: 'もう一度読み込む', missingTranslation: (name) => `このページでは${name}版はまだ利用できません。リーダーが別の言語へ自動的に切り替えることはありません。概要に戻り、利用可能なユニットを選んでください。`, translationInProgress: () => '日本語訳は候補として利用できますが、独立した言語レビュー待ちです。検証済みの翻訳ではありません。',
  });
  readerCopy.ko = Object.assign({}, readerCopy.en, {
    skip: '본문으로 건너뛰기', back: '개요로 돌아가기', githubBadgeAria: 'GitHub에서 프로젝트 보기', language: '언어', languageAria: '읽기 언어 선택', detailsAria: '페이지 세부 정보', chapterList: '장 목록', labSequence: 'Lab 순서', pageDetails: '페이지 세부 정보', previousChapter: '이전 장', nextChapter: '다음 장', previousLab: '이전 Lab', nextLab: '다음 Lab', onThisPageAria: '이 페이지의 목차', onThisPage: '이 페이지의 목차', openSource: '원본 파일 열기 ↗', loading: '원본 페이지를 불러오는 중…', copyPrompt: '프롬프트 복사', copiedPrompt: '프롬프트를 복사했습니다', copyFailed: '복사하지 못했습니다', retry: '다시 불러오기', missingTranslation: (name) => `이 페이지에서는 ${name} 버전을 아직 사용할 수 없습니다. 리더는 다른 언어로 자동 전환하지 않습니다. 개요로 돌아가 사용 가능한 단위를 선택하세요.`, translationInProgress: () => '한국어 번역은 후보 상태로 제공되며 독립 언어 검토를 기다리고 있습니다. 검증된 번역이 아닙니다.',
  });
  readerCopy.de = Object.assign({}, readerCopy.en, {
    skip: 'Zum Inhalt springen', back: 'Zur Übersicht', githubBadgeAria: 'Projekt auf GitHub ansehen', language: 'Sprache', languageAria: 'Lesesprache wählen', detailsAria: 'Seitendetails', chapterList: 'Kapitelliste', labSequence: 'Lab-Reihenfolge', pageDetails: 'Seitendetails', previousChapter: 'Vorheriges Kapitel', nextChapter: 'Nächstes Kapitel', previousLab: 'Vorheriges Lab', nextLab: 'Nächstes Lab', onThisPageAria: 'Auf dieser Seite', onThisPage: 'Auf dieser Seite', openSource: 'Quelldatei öffnen ↗', loading: 'Quellseite wird geladen…', copyPrompt: 'Prompt kopieren', copiedPrompt: 'Prompt kopiert', copyFailed: 'Kopieren fehlgeschlagen', retry: 'Erneut laden', missingTranslation: (name) => `${name} ist für diese Seite noch nicht verfügbar. Der Reader wechselt nicht automatisch in eine andere Sprache. Kehre zur Übersicht zurück und wähle eine verfügbare Einheit.`, translationInProgress: () => 'Die deutsche Übersetzung ist als Kandidat verfügbar und wartet auf eine unabhängige Sprachprüfung. Sie ist keine verifizierte Übersetzung.',
  });
