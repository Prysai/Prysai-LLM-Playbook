(() => {
  ...
  const officialSiteCopyByLocale = {
    en: 'Prysai official website',
    zh: 'Prysai 官网',
    es: 'Sitio web oficial de Prysai',
    ja: 'Prysai 公式サイト',
    ko: 'Prysai 공식 웹사이트',
    de: 'Offizielle Prysai-Website',
    'zh-tw': 'Prysai 官方網站',
    fr: 'Site officiel de Prysai',
  };
  Object.entries(officialSiteCopyByLocale).forEach(([locale, label]) => {
    readerCopy[locale].officialSite = label;
  });
