const copy = {
  en: {
    ...
    labsEyebrow: 'The lab', labsTitle: 'Make the principle observable.', labsIntro: 'Labs are low-risk, reproducible tasks. Each one names setup, evidence, a failure variant, a secret boundary, and a reflection.', draftStatus: 'draft', startingLab: 'starting lab', lab01Title: 'First safe task', lab01Body: 'In a sandbox project, ask Codex to inspect before editing. Turn “done” into a checkable diff.', lab02Title: 'Task protocol', lab02Body: 'Break a vague request into goal, inputs, constraints, acceptance, and failure handling.', lab03Title: 'Evidence review', lab03Body: 'Find a result that looks complete but has no evidence for its claim.', lab04Title: 'Skill selection', lab04Body: 'Explain the choice and refuse to use directory size as a proxy for fit.', lab05Title: 'Design a Skill', lab05Body: 'Turn a stable method into a capability with boundaries, evidence, and failure cases.', lab06Title: 'Agent stop conditions', lab06Body: 'Define stop points for success, missing input, recoverable failure, and permission conflict.', lab07Title: 'Action boundaries', lab07Body: 'Compare the evidence needed for reading, editing, running, committing, pushing, and publishing.', lab08Title: 'Research question', lab08Body: 'Turn a broad topic into a question, source plan, and minimum evidence table.', lab09Title: 'Engineering lifecycle', lab09Body: 'Compare direct implementation with a full lifecycle and record the rework evidence.', lab10Title: 'Shared product context', lab10Body: 'Version a shared product understanding and separate facts from hypotheses.', lab11Title: 'GPT and Codex boundaries', lab11Body: 'Use static task cards to separate generation, execution, verification, and external effects.', lab12Title: 'Team capability migration', lab12Body: 'Create a contract for version, owner, permissions, independent reproduction, and rollback.', labsIndexLink: 'Open the lab rules and all 17 entries',
    skillsEyebrow: 'Capability layer', skillsTitle: 'Nine Skills. Nine jobs.', skillsIntro: 'A Skill is a method with a trigger, an input check, boundaries, stop conditions, an output contract, and a way to verify it.', skillCoach: 'Choose a learning path and practice boundary.', skillProtocol: 'Turn a vague request into an executable contract.', skillEvidence: 'Split completion claims into checkable evidence.', skillSelector: 'Choose a minimum viable capability set.', skillWorkflow: 'Manage stages, checkpoints, and hand-off.', skillResearch: 'Converge a question into auditable knowledge.', skillContext: 'Keep stable principles separate from changing facts.', skillLearningName: 'Learning Coach', skillLearning: 'Practise with recall, correction, delayed review, and transfer.', skillSourceName: 'Source Investigator', skillSource: 'Turn broad searches into bounded source-backed investigations.', skillFootnote: 'All 9 project Skills pass structural checks and remain candidate; 3 have a basic pretest, 2 have only a minimal fresh-task sample, and 4 remain static-review only.', lab13Status: 'maintainer reference accepted · learner not run',
...
Object.assign(copy.en, {
  ...
  labsIndexLink: 'Open the lab rules and all 17 entries',
...
Object.assign(copy.zh, {
  ...
  labsIndexLink: '\u6253\u5f00\u5b9e\u9a8c\u89c4\u5219\u548c\u5168\u90e8 17 \u4e2a\u5165\u53e3',
  featuredLab: '\u7cbe\u9009\u5b9e\u9a8c',
  lab13Title: '\u53ef\u5ba1\u8ba1\u7684\u7ad6\u5411\u5207\u7247',
...
Object.assign(copy.en, {
  ...
  fileLabsTitle: 'Observable practice', fileLabsBody: '17 labs; current status: draft; run status: not_run.',
  fileSkillsTitle: 'Reusable methods', fileSkillsBody: '9 project Skills with triggers, boundaries, and evidence contracts.',
  ...
  ledgerProject: 'Project', ledgerChapters: 'Chapters · 22', ledgerLabs: 'Labs · 17', ledgerSkills: 'Skills · 9', ledgerResearch: 'Field research', ledgerResearchNote: 'user reports; not locally reproduced', ledgerSource: 'Open the current status source',
...
Object.assign(copy.zh, {
  ...
  ledgerProject: '\u9879\u76ee', ledgerChapters: '\u7ae0\u8282 \u00b7 22', ledgerLabs: '\u5b9e\u9a8c \u00b7 17', ledgerSkills: 'Skill \u00b7 9', ledgerResearch: '\u73b0\u5b9e\u95ee\u9898\u7814\u7a76', ledgerResearchNote: '\u7528\u6237\u62a5\u544a\uff1b\u672c\u5730\u672a\u590d\u73b0', ledgerSource: '\u6253\u5f00\u5f53\u524d\u72b6\u6001\u6e90',
...
Object.assign(copy.en, {
  ...
  repositoryLabs: '17 labs · 1 maintainer reference · 0 learner runs',
  repositorySkills: '9 reusable Skills · candidate',
...
Object.assign(copy.zh, {
  ...
  repositoryLabs: '17 个实验 · 1 个维护者参考运行 · 0 个学习者运行',
  repositorySkills: '9 个可复用 Skill · candidate',
