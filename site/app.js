...
const foundationClaimAuditCopy = {
  en: { foundationVisualsTitle: 'Seven foundation boards, one loop.', foundationVisualsIntro: 'Start with the route map, then use the six check boards as quick references: prompt contract, action evidence, recovery, source checks, claim audit, and evidence-to-decision stopping.', foundationClaimAuditVisualAlt: 'Claim to evidence audit teaching board', foundationClaimAuditVisualTitle: 'Claim to evidence audit', foundationClaimAuditVisualBody: 'State the claim, scope it, name the source, check the link, and keep the limit.', foundationEvidenceVisualAlt: 'Evidence to decision and stop teaching board', foundationEvidenceVisualTitle: 'Evidence to decision and stop', foundationEvidenceVisualBody: 'Follow a question to an observation, a bounded decision, or a deliberate stop.' },
  zh: { foundationVisualsTitle: '七张基础图，串起一个闭环。', foundationVisualsIntro: '先看路线图，再把另外六张图当作速查表：提示词契约、行动证据、证据恢复、来源检查、声明审计，以及从证据到决定和停止。', foundationClaimAuditVisualAlt: '声明到证据审计教学图', foundationClaimAuditVisualTitle: '声明到证据审计', foundationClaimAuditVisualBody: '写清声明，限定范围，标出来源，检查证据链，并保留限制。', foundationEvidenceVisualAlt: '从证据到决定与停止的教学图', foundationEvidenceVisualTitle: '从证据到决定与停止', foundationEvidenceVisualBody: '沿着问题走到观察结果、有边界的决定，或明确停止。' },
  es: { foundationVisualsTitle: 'Siete tablas, un solo bucle de fundamentos.', foundationVisualsIntro: 'Empieza por el mapa de la ruta y usa las otras seis tablas como referencia: contrato del prompt, evidencia de la acción, recuperación, comprobación de fuentes, auditoría de afirmaciones y parada deliberada.', foundationClaimAuditVisualAlt: 'Tabla didáctica de la auditoría de afirmación a evidencia', foundationClaimAuditVisualTitle: 'Auditar la afirmación y la evidencia', foundationClaimAuditVisualBody: 'Formula la afirmación, delimítala, nombra la fuente, comprueba el vínculo y conserva el límite.', foundationEvidenceVisualAlt: 'Tabla didáctica de evidencia, decisión y parada', foundationEvidenceVisualTitle: 'De la evidencia a la decisión y la parada', foundationEvidenceVisualBody: 'Sigue una pregunta hasta una observación, una decisión acotada o una parada deliberada.' },
  ja: { foundationVisualsTitle: '7つの基礎ボード、1つのループ。', foundationVisualsIntro: 'まずルートマップを見て、残り6つのボードを早見表として使います。プロンプト契約、操作の証拠、回復、出典確認、主張の監査、証拠に基づく判断と停止を扱います。', foundationClaimAuditVisualAlt: '主張から証拠までの監査を示す教材図', foundationClaimAuditVisualTitle: '主張と証拠を監査する', foundationClaimAuditVisualBody: '主張を書き、範囲を定め、出典の責任者を示し、つながりを確認し、限界を残します。', foundationEvidenceVisualAlt: '証拠から判断と停止までを示す教材図', foundationEvidenceVisualTitle: '証拠から判断、停止まで', foundationEvidenceVisualBody: '問いを観察結果、範囲を限定した判断、または意図した停止へつなげます。' },
  ko: { foundationVisualsTitle: '일곱 기초 보드, 하나의 루프.', foundationVisualsIntro: '먼저 경로 지도를 보고, 나머지 여섯 보드를 빠른 참고표로 사용하세요. 프롬프트 계약, 행동의 증거, 복구, 출처 점검, 주장 감사, 증거에 따른 판단과 중지까지 다룹니다.', foundationClaimAuditVisualAlt: '주장에서 증거까지 감사하는 교육 보드', foundationClaimAuditVisualTitle: '주장과 증거 감사', foundationClaimAuditVisualBody: '주장을 적고 범위를 정하고 출처를 밝힌 뒤 연결을 점검하고 한계를 남기세요.', foundationEvidenceVisualAlt: '증거에서 판단과 중지까지 보여 주는 교육 보드', foundationEvidenceVisualTitle: '증거에서 판단과 중지까지', foundationEvidenceVisualBody: '질문을 관찰 결과, 범위가 정해진 판단 또는 의도적인 중지로 이어 가세요.' },
  de: { foundationVisualsTitle: 'Sieben Grundtafeln, ein Ablauf.', foundationVisualsIntro: 'Beginne mit der Routentafel und nutze die sechs weiteren Tafeln als Kurzreferenz: Prompt-Vertrag, Handlungsbeleg, Wiederherstellung, Quellenprüfung, Prüfung von Aussage und Beleg sowie Beleg-zu-Entscheidung mit Stopp.', foundationClaimAuditVisualAlt: 'Lehrtafel zur Prüfung von Aussage und Beleg', foundationClaimAuditVisualTitle: 'Aussage und Beleg prüfen', foundationClaimAuditVisualBody: 'Formuliere die Aussage, grenze sie ein, nenne die Quelle, prüfe die Verbindung und halte die Grenze fest.', foundationEvidenceVisualAlt: 'Lehrtafel von Beleg zu Entscheidung und Stopp', foundationEvidenceVisualTitle: 'Vom Beleg zur Entscheidung und zum Stopp', foundationEvidenceVisualBody: 'Verfolge eine Frage bis zur Beobachtung, zur begrenzten Entscheidung oder zum bewussten Stopp.' },
  'zh-tw': { foundationVisualsTitle: '七張基礎圖，串起一個閉環。', foundationVisualsIntro: '先看路線圖，再把另外六張圖當作速查表：提示詞契約、行動證據、證據恢復、來源檢查、主張稽核，以及從證據到判斷與停止。', foundationClaimAuditVisualAlt: '主張到證據稽核教學圖', foundationClaimAuditVisualTitle: '稽核主張與證據', foundationClaimAuditVisualBody: '寫清楚主張，限定範圍，標出來源，檢查證據鏈，並保留限制。', foundationEvidenceVisualAlt: '從證據到判斷與停止的教學圖', foundationEvidenceVisualTitle: '從證據到判斷與停止', foundationEvidenceVisualBody: '沿著問題走到觀察結果、有界線的判斷，或明確停止。' },
  fr: { foundationVisualsTitle: 'Sept tableaux de base, une seule boucle.', foundationVisualsIntro: 'Commencez par la feuille de route, puis utilisez les six autres tableaux comme aide-mémoire : contrat de prompt, preuves d’action, récupération, contrôle des sources, audit de l’affirmation et décision fondée sur les preuves avec arrêt.', foundationClaimAuditVisualAlt: 'Tableau pédagogique de l’audit de l’affirmation par les preuves', foundationClaimAuditVisualTitle: 'Auditer l’affirmation et les preuves', foundationClaimAuditVisualBody: 'Écrivez l’affirmation, délimitez-la, nommez la source, vérifiez le lien et gardez la limite.', foundationEvidenceVisualAlt: 'Tableau pédagogique des preuves vers la décision et l’arrêt', foundationEvidenceVisualTitle: 'Des preuves à la décision et à l’arrêt', foundationEvidenceVisualBody: 'Suivez une question jusqu’à une observation, une décision délimitée ou un arrêt volontaire.' },
};
