...
Object.assign(copy.fr, {
  ...
  "heroRouteFixtureTitle": "Besoin d'un fichier sécurisé pour le chemin Codex ? Ouvrez le luminaire hors ligne.",
  ...
  "heroProofReceiptLabel": "ENREGISTREMENT DE CHÈQUE BORDÉ",
  ...
  "problemStartBody": "Commencez par le noyau de base LLM. Il enseigne les limites du modèle, une requête limitée, les pannes visibles, la réparation et le transfert avant tout itinéraire de plate-forme.",
  ...
  "problemUpdateBody": "Localisez le fichier canonique, joignez l'enregistrement source, exécutez la porte appropriée et conservez les réclamations non vérifiées en dehors de la version.",
  ...
  "problemResearchBody": "Liez la question à une décision, attribuez des propriétaires aux sources, tenez un registre des réclamations, recherchez les désaccords et arrêtez-vous volontairement.",
  ...
  "starterBoundaryLab": "Label la limite : Lab 011",
  ...
  "supportingSkills": "Prise en charge des Skill",
  ...
  "labsIntro": "Les Lab sont des tâches reproductibles à faible risque. Chacun nomme une configuration, une preuve, une variante d’échec, une frontière secrète et une réflexion.",
  "draftStatus": "brouillon",
  "startingLab": "laboratoire de démarrage",
  ...
  "skillsTitle": "Vingt-six Skill. Des métiers distincts.",
  ...
  "skillEvidence": "Divisez les réclamations d’achèvement en preuves vérifiables.",
  "skillSelector": "Choisissez un ensemble de capacités minimum viable.",
  ...
  "troubleTwoBody": "Enregistrez le même échec, modifiez une condition de diagnostic, puis réessayez une fois ou faites un escalade.",
  ...
  "statusDraft": "Toujours en cours d'écriture ou manquant le chèque minimum.",
  ...
  "skillRouteVerify": "Je dois vérifier une réclamation existante.",
  ...
  "starterCopyRecord": "Copier mon relevé de chèque local",
  "starterReceiptAria": "Enregistrement du chèque Local First Win",
  "starterRecordCopied": "Enregistrement de chèque local copié. Il contient uniquement les statuts, pas votre réponse.",
  "starterRecordCopyFailed": "Impossible de copier l'enregistrement du chèque local. Sélectionnez son texte manuellement.",
  "starterRecoveryLink": "Transfert de récupération ouvert",
  "starterReceiptLabel": "Dossier de chèque en langage simple",
  ...
  "indexTitle": "Sachez où réside chaque réclamation.",
  ...
  "ledgerSource": "Ouvrir la source d'état actuelle",
  ...
  "researchReceiptsBody": "Rapports publics, classification des réclamations et point de contrôle pour les longues tâches de recherche ; recherche de candidats.",
  "researchFirstTurnLink": "Draft un premier tour universel",
  ...
  "skillPromptText": "Aide-moi à m'entraîner à élaborer un petit plan. Ne faites pas le plan en premier.\n\nTâche pratique : planifier une visite fictive de 45 minutes dans un parc de la ville pour un adulte. Incluez une bouteille d'eau, une vérification météo et un rappel de l'heure de retour. Il ne s’agit pas d’une véritable réservation, d’une décision de voyage ou de prévisions météorologiques.\n\nAvant d'écrire, montrez cette vérification fixe : 3 à 5 étapes ; les trois contraintes apparaissent ; aucun fait local non étayé ; et une personne pouvait suivre le plan. Donnez-moi quatre minutes pour l'écrire. Ne montrez pas de plan modèle, ne l'agrandissez pas et ne le notez pas avant que je réponde.\n\nAprès ma première tentative, citez une seule omission consécutive. Posez une question ou donnez une allusion de 12 mots maximum, puis attendez ma correction. Conservez les deux tentatives. Modifiez ensuite uniquement la durée de la visite de 45 minutes à 20 minutes et demandez un nouveau plan sans aide, en utilisant le même chèque.\n\nTerminez avec exactement un statut : pratiqué, démontré_on_this_task, transféré_to_time_limit_variation ou not_run. Une seule séance n'établit pas la capacité de planification, le jugement, la sécurité ou la performance indépendante.",
  ...
  "researchCardIntro": "Transformez une question précise et le matériel que vous avez fourni en un petit registre de réclamations, de lacunes et de la question suivante.",
  ...
  "researchCardStepThree": "Traitez sa table comme une préparation. Ouvrez et faites correspondre les sources vous-même avant de vous fier à une réclamation.",
  ...
  "researchPromptText": "J'ai cinq minutes pour préparer un chèque de recherche, pas une réponse définitive.\n\nQuestion : [une question précise].\nMatériel que j'ai fourni : [URLs, titres, extraits ou \"aucun\"].\n\nTout d’abord, reformulez la question et nommez quelles preuves seraient nécessaires. Créez ensuite un tableau à trois lignes avec : la réclamation possible, la source fournie ou \"manquante\", et ce qui nécessiterait une vérification. N'inventez pas de citations, ne déclarez pas que vous avez ouvert une source à laquelle vous ne pouvez pas accéder et ne donnez pas de recommandation. Séparez les faits, les rapports et les inférences. Si le matériel est manquant, contradictoire, personnel ou à enjeux élevés, arrêtez-vous et dites-moi la prochaine étape la plus petite et sûre.\n\nTerminez par : les sources réellement fournies, les inconnues et une question à laquelle je dois répondre avant de continuer.",
  ...
  "skillRouteLanguagePartner": "Je veux pratiquer une langue en tapant.",
  "skillRouteLanguagePartnerResult": "Exécute un échange typé fictif ; vous écrivez d'abord, une correction à la fois.",
  "skillRouteInterview": "Je veux répéter une réponse à une interview.",
  "skillRouteInterviewResult": "Entraîneurs, une réponse chronométrée avec une coche visible et une question modifiée.",
  "skillLanguagePartnerName": "Partenaire linguistique",
  "skillLanguagePartner": "Exécutez un échange typé limité dans la langue cible de l’apprenant.",
  "skillInterviewName": "Répétition d'entretien",
  "skillInterview": "Répétez une réponse observable dans un délai imparti.",
  "githubBadge": "GitHub",
  ...
  "foundationLayerCheckBody": "Compare le résultat avec une règle source, diff, test, journal ou d'acceptation avant de faire une réclamation.",
  ...
  "foundationPromptVisualAlt": "Conseil d'enseignement contractuel rapide à six champs",
  ...
  "foundationRecoveryVisualBody": "Faites correspondre la force de la réclamation au prochain plus petit chèque.",
