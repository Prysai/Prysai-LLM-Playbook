...
Object.assign(copy.fr, {
  ...
  "skillSignal": "Transformez les rapports publics en preuves à demande limitée.",
...
const foundationBridgeCopy = {
  ...
  es: { foundationVisualsTitle: 'Diez tableros de base, un solo bucle.', foundationVisualsIntro: 'Empieza por la ruta de la primera visita y usa el puente de la primera tarea, el registro, la ruta y las tablas de comprobación como referencia rápida para una tarea LLM acotada.', foundationBridgeVisualAlt: 'Tablero didáctico del puente de la primera tarea a la evidencia', foundationBridgeVisualTitle: 'Haz comprobable la primera tarea', foundationBridgeVisualBody: 'Elige un resultado observable, deja visibles la entrada y el límite de parada, guarda lo ocurrido, haz una comprobación concreta y entrega el resultado con sus límites.' },
