const copy = {
  en: {
    ...
    menu: 'Menu', menuClose: 'Close', navStart: 'Start with a problem', navFirst30: 'Five-minute prompt practice', navPath: 'Learning path', navIndex: 'Project index', navRoutes: 'Reading routes', navLabs: 'Labs', navSkills: 'Skills', navUpdates: 'Update map', localeBannerFallback: 'The {requested} route is selected, but some interface strings or course units are still in migration. When a course unit is absent, Reader keeps this language and names the unit unavailable; it does not silently switch the course text to English.', localeManifestError: 'Locale routing is unavailable because the generated manifest did not load. English remains available; rebuild the manifest before relying on other routes.', localeBannerReady: 'Reading in {language}.', localeMenuAria: 'Interface languages', languageNameEnglish: 'English', languageNameChinese: 'Simplified Chinese', languageNameTraditionalChinese: 'Traditional Chinese', languageNameSpanish: 'Spanish', languageNameJapanese: 'Japanese', languageNameKorean: 'Korean', languageNameGerman: 'German', languageNameFrench: 'French', localeOptionFallback: 'English UI fallback', localePartialAnchorNotice: 'Local overview; this detailed section is not translated yet.',
    heroIndex: 'LLM / FOUNDATION SYSTEM', heroEyebrow: 'Start with the model · then make one checked attempt', heroTitle: 'Understand LLMs before you ask them to work.', heroLede: 'Learn what a language model can and cannot establish, write one bounded request, inspect the answer, and repeat the method on a new task. Codex, tools, Agents, and Skills come after this foundation.', heroPrimary: 'Start the LLM Foundation Core', heroSecondary: 'Try the optional five-minute warm-up', heroRouteAria: 'Choose the recommended first route', heroRouteKicker: 'Start with one foundation route', heroRouteGuidedTitle: 'Start with the LLM Foundation Core.', heroRouteGuidedBody: 'Learn the model, make one bounded request, inspect the result, and carry the method to a new task.', heroRouteFixtureTitle: 'Need a no-setup first step?', heroRouteFixtureBody: 'Use the optional five-minute practice to see the checking loop before continuing.', heroRouteBoundary: 'Candidate means the basic structure and checks pass; first-time reader outcomes are still unmeasured.', heroProofAria: 'First Win proof card', heroProofKicker: 'FIRST WIN / INSPECTABLE EXAMPLE', heroProofStatus: 'candidate · no participant run recorded', heroProofTitle: 'See what one checked result contains.', heroProofSourceLabel: 'SOURCE MESSAGE', heroProofSource: '“Hi, the workshop changed. It starts Friday at 10. Bring the draft. Tell me if you cannot come.”', heroProofPreserveLabel: 'PRESERVE FACTS', heroProofPreserve: 'Keep Friday at 10, the draft, and the reply request. Do not add a date, venue, reason, or contact method.', heroProofChecksLabel: 'THREE HUMAN CHECKS', heroProofCheckOne: 'Friday at 10 and the draft remain.', heroProofCheckTwo: 'People who cannot attend are asked to reply.', heroProofCheckThree: 'No unsupported detail appears.', heroProofReceiptLabel: 'BOUNDED CHECK RECORD', heroProofReceipt: 'One checked attempt can be recorded. It does not prove learning, transfer, or model performance.', heroProofLink: 'Try the five-minute prompt practice', heroFooter: 'Problem → protocol → action → evidence',
  ...
  zh: {
    ...
    skillsEyebrow: '能力层', skillsTitle: '二十六个 Skill，各有职责。', skillsIntro: 'Skill 是带触发器、输入检查、边界、停止条件、输出契约和验证方式的方法包。', skillCoach: '选择学习路径和练习边界。', skillProtocol: '把模糊请求变成可执行契约。', skillEvidence: '把完成声明拆成可检查证据。', skillSelector: '选择最小有效能力组合。', skillWorkflow: '管理阶段、检查点和交接。', skillResearch: '把问题收敛为可审查知识。', skillContext: '分开稳定原则和易变事实。', skillLearningName: '学习教练', skillLearning: '通过回忆、纠错、延迟复习和迁移进行练习。', skillSourceName: '来源调查', skillSource: '把宽泛搜索变成有边界、有来源的调查。', skillSignalName: '现场信号整理', skillSignal: '把公开报告整理成有边界的需求证据。', skillAdapterName: '平台适配审查', skillAdapter: '拒绝没有来源、运行和真实差异的平台教程。', skillTriageName: '沟通故障分诊', skillTriage: '诊断一次失败交互，并复测最小修复。', skillBriefName: '对话 Brief', skillBrief: '把一次尚未发送的低风险请求整理成可复制的首轮消息。', skillFirstTurnCheckName: '首轮请求检查', skillFirstTurnCheck: '检查尚未发送的低风险请求是否明确了边界。', skillProseName: '开源项目文案润色', skillProse: '润色公开项目文案和本地化文字，同时保留事实与地区表达。', skillRouteBrief: '我需要写一条清晰的首轮消息。', skillRouteBriefResult: '产出带检查与停止边界的低风险、可复制首轮消息。', skillRouteFirstTurnCheck: '我已经写好首轮请求，想先检查它。', skillRouteFirstTurnCheckResult: '标出关键缺口，不代写新的提示词。', skillBoundaryName: '原创方法优先。', skillBoundary: '外部 Skill 必须保留原项目链接和许可证边界。', skillIndexLink: '打开 Skill 登记表与全部 26 个方法', mobileIndexAria: '完整项目索引', mobileIndexChapters: '章', mobileIndexLabs: '实验', mobileIndexSkills: 'Skill', mobileIndexCases: '现场案例', mobileIndexLocales: '语言记录', mobileIndexVisuals: '教学图板', mobileIndexUpdates: '更新区域', mobileIndexTrust: '可信度类型', mobileIndexDetailsAria: '详细项目地图', mobileIndexDetailsSummary: '打开详细地图', mobileIndexDetailsIntro: '上面的快捷入口是精简视图。打开此面板可查看规范阅读地图、现场研究和维护规则。', mobileIndexDetailsReadme: '规范阅读地图', mobileIndexDetailsResearch: '现场研究索引', mobileIndexDetailsUpdates: '维护更新地图', skillFootnote: '26 个项目 Skill（25 个原创方法和 1 个审查过的外部编辑 Skill）均保持 candidate；新鲜任务证据仍不完整。平台事实巡检是维护记录，不是当前平台检查。请求分流目前只有一次隔离的混合请求前向测试；它不是学习者或运行时证据。对抗式项目审查不是外部评审。', lab13Status: '维护者参考运行已接受 · 学习者尚未运行',
...
Object.assign(copy.en, {
  ...
  footerTagline: 'An evidence-led LLM playbook, with platform practice after the foundation.',
});
...
Object.assign(copy.zh, {
  ...
  footerTagline: '一套循证的大模型实战手册，先打好基础，再进入平台实践。',
});
...
const legacyLearningPath = {
  L0: { title: ['Understand the model before you act.', '先理解模型，再开始行动。'], description: ['Explain what an LLM, context, prompt, product, tool, Agent, and Skill can establish before choosing a platform.', '在选择平台前，说明 LLM、上下文、提示词、产品、工具、Agent 与 Skill 各自能建立什么。'], chapters: [['LLM Foundation Core', 'LLM 基础核心课', '../book/routes/llm-foundation-core-v1-EN.md']], labs: [['Optional boundary check after the foundation', '基础课后的可选边界检查', '../book/guides/llm-fundamentals-EN.md']], skills: [['LLM Foundation Coach', 'LLM 基础教练', '../skills/prysai-codex-coach/SKILL.md']], evaluations: ['concept-gpt-codex-tools-001'], evaluationTypes: ['positive', 'boundary'], gate: { explain: ['Name at least three boundaries between a language model, a product, and a tool.', '说出语言模型、产品与工具之间至少三条边界。'], operate: ['Write one bounded request and label its input, action, state, and evidence.', '写出一条有边界的请求，并标注输入、行动、状态和证据。'], judge: ['Refuse to infer access or execution from a model, Skill, login, or tool name.', '不根据模型、Skill、登录或工具名称臆测访问权或已执行。'], review: ['Record what the request cannot prove about current facts or runtime behavior.', '记录请求无法证明的当前事实或运行时行为。'] }, graduation: ['Advance only when the learner can explain the four layers and identify an unverified claim.', '只有能解释四层关系并指出一个未验证声明时，才进入下一阶段。'], blocked: ['The learner treats a fluent answer, model name, or tool proposal as proof that an action happened.', '把流畅回答、模型名称或工具提议当成行动已发生的证据。'], status: 'candidate', next: ['Open the LLM Foundation Core', '打开 LLM 基础核心课'] },
...
// Keep the emergency fallback in the same reader vocabulary as the generated path.
// This only runs when the generated artifact is unavailable; it does not mutate source data.
const normalizeLegacyLearningPath = (value) => {
  if (Array.isArray(value)) return value.map(normalizeLegacyLearningPath);
  if (value && typeof value === 'object') {
    Object.entries(value).forEach(([key, item]) => { value[key] = normalizeLegacyLearningPath(item); });
    return value;
  }
  return typeof value === 'string' ? value.replaceAll('竖向切片', '垂直切片') : value;
};
normalizeLegacyLearningPath(legacyLearningPath);
// Keep reader-facing fallback labels aligned with the canonical terminology.
// The generated learning-path artifact remains the source of truth when loaded.
Object.values(copy).forEach((localeCopy) => normalizeLegacyLearningPath(localeCopy));
...
Object.assign(copy.en, {
  ...
  starterReceiptLabel: 'Plain-language check record',
...
Object.assign(copy.en, {
  ...
  fileSkillsTitle: 'Reusable methods', fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ...
  ledgerProject: 'Project', ledgerChapters: 'Chapters · 22', ledgerLabs: 'Labs · 18', ledgerSkills: 'Skills · 26', ledgerResearch: 'Field research', ledgerResearchNote: 'user reports; not locally reproduced', ledgerSource: 'Open the current status source',
  localeTitle: 'Eight-language route', localeIntro: 'Eight repository entry locales are registered. Each course route stays in its selected language; supplemental pages retain their own translation status and fail closed when a same-language page is unavailable.',
...
Object.assign(copy.zh, {
  ...
  fileSkillsTitle: '\u53ef\u590d\u7528\u65b9\u6cd5', fileSkillsBody: '26 \u4e2a\u9879\u76ee Skill\uff0c\u5305\u542b\u89e6\u53d1\u3001\u8fb9\u754c\u4e0e\u8bc1\u636e\u5951\u7ea6\u3002',
  fileDocsTitle: '\u6cbb\u7406\u4e0e\u7814\u7a76', fileDocsBody: '\u72b6\u6001\u3001\u6765\u6e90\u3001\u73b0\u5b9e\u95ee\u9898\u3001\u66f4\u65b0\u89c4\u5219\u4e0e\u8d28\u91cf\u8bb0\u5f55\u3002',
  ledgerTitle: '\u5185\u5bb9\u72b6\u6001', ledgerIntro: '\u5f53\u524d\u72b6\u6001\u6e90\u7684\u7b80\u8bfb\u7248\u3002\u72b6\u6001\u63cf\u8ff0\u8bc1\u636e\uff0c\u4e0d\u63cf\u8ff0\u613f\u666f\u3002',
  ledgerProject: '\u9879\u76ee', ledgerChapters: '\u7ae0\u8282 \u00b7 22', ledgerLabs: '\u5b9e\u9a8c \u00b7 18', ledgerSkills: 'Skill \u00b7 26', ledgerResearch: '\u73b0\u5b9e\u95ee\u9898\u7814\u7a76', ledgerResearchNote: '\u7528\u6237\u62a5\u544a\uff1b\u672c\u5730\u672a\u590d\u73b0', ledgerSource: '\u6253\u5f00\u5f53\u524d\u72b6\u6001\u6e90',
  localeTitle: '\u516b\u8bed\u79cd\u8def\u7ebf', localeIntro: '\u4ed3\u5e93\u5df2\u767b\u8bb0\u516b\u79cd\u5165\u53e3\u8bed\u8a00\u3002\u6bcf\u6761\u8bfe\u7a0b\u8def\u7ebf\u90fd\u4fdd\u6301\u5f53\u524d\u8bed\u8a00\uff1b\u8865\u5145\u9875\u9762\u4fdd\u7559\u81ea\u5df1\u7684\u7ffb\u8bd1\u72b6\u6001\uff0c\u7f3a\u5c11\u540c\u8bed\u8a00\u9875\u9762\u65f6\u4f1a\u660e\u786e\u5931\u8d25\u5173\u95ed\u3002',
  localeEnglish: '\u53ef\u7528 \u00b7 \u9ed8\u8ba4', localeChinese: '\u53ef\u7528 \u00b7 \u5f53\u524d\u5207\u6362', localeTraditionalChinese: '\u53ef\u7528 \u00b7 \u7e41\u9ad4\u4e2d\u6587', localeSpanish: '\u5165\u53e3\u5207\u7247 \u00b7 UI \u56de\u9000', localeGerman: '\u5165\u53e3\u5207\u7247 \u00b7 UI \u56de\u9000', localeJapanese: '\u5165\u53e3\u5207\u7247 \u00b7 UI \u56de\u9000', localeKorean: '\u5165\u53e3\u5207\u7247 \u00b7 UI \u56de\u9000', localeRule: '\u8def\u7531\u89c4\u5219\uff1a\u7ffb\u8bd1\u8bfe\u7a0b\u5355\u5143\u4f7f\u7528\u8bed\u8a00\u540e\u7f00\u5e76\u94fe\u5230\u540c\u4e00\u8bed\u8a00\u3002\u5f53\u524d\u7f51\u7ad9\u5df2\u767b\u8bb0\u516b\u8bed\u79cd\u5165\u53e3\uff0c\u4e0d\u4ee3\u8868\u6574\u672c\u4e66\u3001\u8865\u5145\u9875\u9762\u6216\u72ec\u7acb\u5ba1\u6821\u5df2\u5168\u90e8\u5b8c\u6210\u3002',
...
Object.assign(copy.en, {
  ...
  visualCaseBody: 'Attempt first, correct one issue, vary the case, then keep a bounded check record.'
});
...
Object.assign(copy.zh, {
  ...
  visualCaseBody: '\u5148\u5c1d\u8bd5\uff0c\u53ea\u4fee\u6b63\u4e00\u4e2a\u95ee\u9898\uff0c\u6539\u53d8\u60c5\u5883\u540e\u518d\u7ec3\uff0c\u6700\u540e\u4fdd\u7559\u6709\u8fb9\u754c\u7684\u68c0\u67e5\u8bb0\u5f55\u3002'
});
...
Object.assign(copy.en, {
  ...
  repositorySkills: '26 reusable Skills · candidate',
...
Object.assign(copy.en, {
  skillsTitle: 'Twenty-six Skills. Distinct jobs.',
  ...
  skillIndexLink: 'Open the Skill registry and all 26 methods',
  skillFootnote: 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Practice Target sets up one first attempt; it does not prove learning. Platform Fact Watch is a maintenance receipt, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ledgerSkills: 'Skills · 26',
  repositorySkills: '26 reusable Skills · candidate',
  skillProseName: 'Polish Open-Source Prose',
  skillProse: 'Revise public prose and locale copy without changing facts or regional meaning.',
});

Object.assign(copy.zh, {
  skillsTitle: '二十六个 Skill，各有职责。',
  ...
  skillIndexLink: '打开 Skill 登记表与全部 26 个方法',
  skillFootnote: '26 个项目 Skill 均通过结构检查并保持 candidate；新鲜任务证据仍不完整。练习目标用于准备一次首次尝试，不能证明学习结果。平台事实巡检是维护记录，不是当前平台检查。LLM 比较协议尚未运行，不是模型排行榜。对抗式项目审查不代表外部评审。',
  fileSkillsBody: '26 \u4e2a\u9879\u76ee Skill，包含触发、边界与证据契约。',
  ledgerSkills: 'Skill \u00b7 26',
  repositorySkills: '26 个可复用 Skill · candidate',
});
...
Object.assign(copy.zh, {
  ...
  ledgerSkills: 'Skill · 26',
  repositorySkills: '26 个可复用 Skill · candidate',
  skillProseName: '开源项目文案润色',
  skillProse: '润色公开项目文案和本地化文字，同时保留事实与地区表达。',
  mobileIndexUpdates: '更新区域',
  mobileIndexTrust: '可信度类型',
  mobileIndexDetailsAria: '详细项目地图',
  mobileIndexDetailsSummary: '打开详细地图',
  mobileIndexDetailsIntro: '上面的快捷入口是精简视图。打开此面板可查看规范阅读地图、现场研究和维护规则。',
  mobileIndexDetailsReadme: '规范阅读地图',
  mobileIndexDetailsResearch: '现场研究索引',
  mobileIndexDetailsUpdates: '维护更新地图',
...
const fallbackLocales = {
  ...
  fr: { suffix: 'FR', html_lang: 'fr', display_name: 'Français' },
};
...
const requiredLocaleTokens = ['en', 'zh', 'es', 'ja', 'ko', 'de', 'zh-tw', 'fr'];
...
const uiLocales = new Set(['en', 'zh', 'es', 'ja', 'ko', 'de', 'zh-tw', 'fr']);
...
Object.assign(copy.en, {
  ...
  skillIndexLink: 'Open the Skill registry and all 26 methods',
  skillFootnote: 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Interruption Checkpoint preserves a task check record; it does not retry or recover work. Practice Target sets up one first attempt; it does not prove learning. Platform Fact Watch is a maintenance check record, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ledgerSkills: 'Skills · 26',
  repositorySkills: '26 reusable Skills · candidate',
});
...
Object.assign(copy.zh, {
  ...
  skillIndexLink: '打开 Skill 登记表与全部 26 个方法',
  skillFootnote: '26 个项目 Skill 均通过结构检查并保持 candidate；真实任务证据仍不完整。中断检查点只保留任务记录，不会重试或恢复工作。练习目标用于准备一次首次尝试，不能证明学习结果。平台事实巡检是维护记录，不是当前平台检查。LLM 比较协议尚未运行，不是模型排行榜。对抗式项目审查不代表外部评审。',
  fileSkillsBody: '26 \u4e2a\u9879\u76ee Skill，包含触发、边界与证据契约。',
  ledgerSkills: 'Skill \u00b7 26',
  repositorySkills: '26 个可复用 Skill · candidate',
});
...
Object.assign(copy.en, {
  ...
  skillIndexLink: 'Open the Skill registry and all 26 methods',
  skillFootnote: 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Shift Handoff separates stable criteria from one new item; it does not execute or assume model memory. Interruption Checkpoint preserves a task check record; it does not retry or recover work. Practice Target sets up one first attempt; it does not prove learning. Platform Fact Watch is a maintenance check record, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ledgerSkills: 'Skills · 26',
  repositorySkills: '26 reusable Skills · candidate',
});
...
Object.assign(copy.zh, {
  ...
  skillIndexLink: '打开 Skill 登记表与全部 26 个方法',
  skillFootnote: '26 个项目 Skill 均通过结构检查并保持 candidate；真实任务证据仍不完整。工作交接会拆开稳定准则与当天这项内容，不会执行任务或假设模型记得上一轮。中断检查点只保留任务记录，不会重试或恢复工作。练习目标用于准备一次首次尝试，不能证明学习结果。平台事实巡检是维护记录，不是当前平台检查。LLM 比较协议尚未运行，不是模型排行榜。对抗式项目审查不代表外部评审。',
  fileSkillsBody: '26 \u4e2a\u9879\u76ee Skill，包含触发、边界与证据契约。',
  ledgerSkills: 'Skill \u00b7 26',
  repositorySkills: '26 个可复用 Skill · candidate',
});
...
const localeCoverageLabel = (language) => {
  ...
  const ui = {
    ...
    zh: { source: `课程：${units} 个英文原始单元`, reviewPending: '独立语言审校待完成', registered: '已登记本地化单元', translated: `课程路线：${units} 个本地译文文件` },
    ...
    'zh-tw': { source: `課程：${units} 個英文原始單元`, reviewPending: '獨立語言審校待完成', registered: '已登記本地化單元', translated: `課程路線：${units} 個本地譯文檔案` },
    fr: { source: `Cours : ${units} unités sources`, reviewPending: 'relecture linguistique indépendante en attente', registered: 'unités localisées enregistrées', translated: `Parcours du cours : ${units} fichiers locaux` },
...
const fragmentFromHref = (href) => href?.includes('#') ? href.slice(href.indexOf('#') + 1) : '';
const withoutFragment = (href) => href?.split('#', 1)[0] || '';
const localizedFragmentIsAvailable = (record, href) => {
...
const localizeReaderLinks = () => {
  document.querySelectorAll('a[href]').forEach((anchor) => {
    ...
    const fragmentAvailable = localizedFragmentIsAvailable(requested, sourceHref);
    const localizedHref = localizedContentHref(contentId, fragmentAvailable ? sourceHref : withoutFragment(sourceHref));
    anchor.href = pagesHref(localizedHref);
    anchor.dataset.localeFallback = 'false';
    anchor.dataset.localeAnchorUnavailable = String(!fragmentAvailable && currentLanguage !== 'en');
    anchor.querySelector('[data-locale-anchor-note]')?.remove();
    if (!fragmentAvailable && currentLanguage !== 'en') {
      anchor.title = currentCopy().localePartialAnchorNotice;
      const note = document.createElement('small');
      note.dataset.localeAnchorNote = '';
      note.textContent = currentCopy().localePartialAnchorNotice;
      // A problem card is a column flex container whose final label owns its
      // bottom position. Keep the disclosure inside that label so it remains
      // in the card's readable column instead of becoming a separate flex
      // item after the label.
      (anchor.matches('.problem-card') ? anchor.querySelector('.card-link') : null || anchor).append(note);
    } else if (!localeCanRender(requested) && currentLanguage !== 'en') {
...
const foundationMindMap = {
  understand: { title: 'mindMapNodeUnderstand', body: 'mindMapUnderstandBody', next: 'mindMapUnderstandNext', contentId: 'llm-fundamentals-guide' },
  frame: { title: 'mindMapNodeFrame', body: 'mindMapFrameBody', next: 'mindMapFrameNext', contentId: 'llm-core-first-generation' },
  act: { title: 'mindMapNodeAct', body: 'mindMapActBody', next: 'mindMapActNext', contentId: 'chapter-13-action-boundaries' },
  inspect: { title: 'mindMapNodeInspect', body: 'mindMapInspectBody', next: 'mindMapInspectNext', contentId: 'chapter-09-verification-and-recovery' },
  repair: { title: 'mindMapNodeRepair', body: 'mindMapRepairBody', next: 'mindMapRepairNext', contentId: 'llm-core-check-repair' },
  transfer: { title: 'mindMapNodeTransfer', body: 'mindMapTransferBody', next: 'mindMapTransferNext', contentId: 'llm-core-unseen-transfer' },
};

const foundationEvidenceMap = {
  question: { title: 'evidenceMapNodeQuestion', body: 'evidenceMapQuestionBody', next: 'evidenceMapQuestionNext', contentId: 'chapter-15-research-track' },
  source: { title: 'evidenceMapNodeSource', body: 'evidenceMapSourceBody', next: 'evidenceMapSourceNext', contentId: 'lab-008-research-question' },
  observe: { title: 'evidenceMapNodeObserve', body: 'evidenceMapObserveBody', next: 'evidenceMapObserveNext', contentId: 'chapter-09-verification-and-recovery' },
  decide: { title: 'evidenceMapNodeDecide', body: 'evidenceMapDecideBody', next: 'evidenceMapDecideNext', contentId: 'lab-015-evidence-delivery' },
...
const setLocalizedElement = (element, key, strings) => {
  ...
  if (strings[key] !== undefined) setText(element, strings[key]);
};

const refreshMindMap = (selected = document.querySelector('[data-mindmap-node][aria-pressed="true"]')?.dataset.mindmapNode || 'understand') => {
  const root = document.querySelector('[data-foundation-loop]');
  const config = foundationMindMap[selected] || foundationMindMap.understand;
  if (!root) return;
  const strings = currentCopy();
  root.dataset.mindmapSelection = selected;
  root.querySelectorAll('[data-mindmap-node]').forEach((button) => {
    const active = button.dataset.mindmapNode === selected;
    button.setAttribute('aria-pressed', String(active));
    button.classList.toggle('is-selected', active);
  });
  setLocalizedElement(root.querySelector('[data-mindmap-detail-title]'), config.title, strings);
  setLocalizedElement(root.querySelector('[data-mindmap-detail-body]'), config.body, strings);
  setLocalizedElement(root.querySelector('[data-mindmap-detail-next]'), config.next, strings);
  const detailLink = root.querySelector('[data-mindmap-detail-link]');
  if (detailLink) {
    detailLink.dataset.contentId = config.contentId;
    detailLink.dataset.mindmapLinkContentId = config.contentId;
  }
};

document.querySelectorAll('[data-mindmap-node]').forEach((button) => {
  button.addEventListener('click', () => {
    refreshMindMap(button.dataset.mindmapNode);
    localizeReaderLinks();
  });
});

const refreshEvidenceMap = (selected = document.querySelector('[data-evidence-node][aria-pressed="true"]')?.dataset.evidenceNode || 'question') => {
  const root = document.querySelector('[data-evidence-map]');
  const config = foundationEvidenceMap[selected] || foundationEvidenceMap.question;
  if (!root) return;
  const strings = currentCopy();
  root.dataset.evidenceSelection = selected;
  root.querySelectorAll('[data-evidence-node]').forEach((button) => {
    const active = button.dataset.evidenceNode === selected;
    button.setAttribute('aria-pressed', String(active));
    button.classList.toggle('is-selected', active);
  });
  setLocalizedElement(root.querySelector('[data-evidence-detail-title]'), config.title, strings);
  setLocalizedElement(root.querySelector('[data-evidence-detail-body]'), config.body, strings);
  setLocalizedElement(root.querySelector('[data-evidence-detail-next]'), config.next, strings);
  const detailLink = root.querySelector('[data-evidence-detail-link]');
  if (detailLink) {
    detailLink.dataset.contentId = config.contentId;
    detailLink.dataset.evidenceLinkContentId = config.contentId;
  }
};
...
Object.assign(copy.en, {
  ...
  skillIndexLink: 'Open the Skill registry and all 26 methods',
  skillFootnote: 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Platform Observation Record documents one visible surface; it is not a capability or safety claim. Practice Target sets up one first attempt; it does not prove learning. Interruption Checkpoint preserves a task check record; it does not retry or recover work. Platform Fact Watch is a maintenance check record, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ledgerSkills: 'Skills · 26',
  repositorySkills: '26 reusable Skills · candidate',
  skillProseName: 'Polish Open-Source Prose',
...
Object.assign(copy.zh, {
  ...
  skillIndexLink: '打开 Skill 登记表与全部 26 个方法',
  skillFootnote: '26 个项目 Skill 均通过结构检查并保持 candidate；新鲜任务证据仍不完整。平台观察记录只记录一个可见工作面，不是能力或安全性声明。平台事实巡检是维护记录，不是当前平台检查。LLM 比较协议尚未运行，不是模型排行榜。对抗式项目审查不代表外部评审。',
  fileSkillsBody: '26 个项目 Skill，包含触发、边界与证据契约。',
  ledgerSkills: 'Skill · 26',
  repositorySkills: '26 个可复用 Skill · candidate',
  skillProseName: '开源项目文案润色',
...
copy.es = {
  ...
  'heroProofSource': '“El taller cambió. Empieza el viernes a las 10. Trae el borrador. Avísame si no puedes venir.”',
  ...
  'protocolRuleAria': 'Cuatro preguntas para una tarea acotada',
  'protocolRuleOne': 'Definir',
  'protocolRuleOneBody': '¿Qué resultado está dentro del alcance y qué queda fuera a propósito?',
  'protocolRuleTwo': 'Actuar',
  'protocolRuleTwoBody': '¿Qué puede hacer el modelo o la herramienta y qué queda pausado?',
  'protocolRuleThree': 'Verificar',
  'protocolRuleThreeBody': '¿Qué fuente, diff, prueba o criterio de aceptación puede mostrar lo ocurrido?',
  'protocolRuleFour': 'Entregar',
  'protocolRuleFourBody': '¿Qué debe recibir la siguiente persona, incluidos los puntos desconocidos?',
  ...
  'skillsTitle': 'Veintiséis Skills. Trabajos distintos.',
  ...
  'skillIndexLink': 'Abrir el registro de Skills y los 26 métodos',
  ...
  'mobileIndexDetailsAria': 'Mapa detallado del proyecto',
  'mobileIndexDetailsSummary': 'Abrir el mapa detallado',
  'mobileIndexDetailsIntro': 'Los accesos de arriba son la vista compacta. Abre este panel para ver el mapa de lectura canónico, la investigación de campo y las reglas de mantenimiento.',
  'mobileIndexDetailsReadme': 'Mapa de lectura canónico',
  'mobileIndexDetailsResearch': 'Índice de investigación de campo',
  'mobileIndexDetailsUpdates': 'Mapa de actualizaciones de mantenimiento',
  'skillFootnote': 'Los 26 Skills del proyecto pasan las comprobaciones estructurales y siguen siendo candidate; la evidencia de tareas nuevas es parcial. El Registro de observación de plataforma documenta una superficie visible; no es una afirmación de capacidad ni de seguridad. El Objetivo de práctica prepara un primer intento; no demuestra aprendizaje. El Punto de control de interrupción conserva un registro de tarea; no reintenta ni recupera trabajo. La Vigilancia de hechos de plataforma es un registro de mantenimiento, no una comprobación de la plataforma actual. El Protocolo de comparación de LLM es un método de comparación sin ejecutar, no un ranking de modelos. La Revisión adversarial de proyectos no es una revisión externa.',
  ...
  'starterReceiptLabel': 'Registro de comprobación en lenguaje claro',
  ...
  'fileSkillsBody': '26 Skills del proyecto con disparadores, límites y contratos de evidencia.',
  ...
  'localeTitle': 'Ruta de ocho idiomas',
  'localeIntro': 'Se registran ocho idiomas de entrada. Cada ruta del curso conserva el idioma seleccionado; las páginas suplementarias mantienen su estado de traducción y fallan de forma explícita si falta una página en el mismo idioma.',
  ...
  'visualCaseBody': 'Intenta primero, corrige un problema, varía el caso y luego conserva un registro de comprobación acotado.',
  ...
  'repositorySkills': '26 Skills reutilizables · candidate',
  ...
  'promptContractStopLabel': 'Detención y registro',
...
copy.ja = {
  ...
  'heroProofSource': '「ワークショップの予定が変わりました。金曜日の10時に始まります。下書きを持参してください。参加できない場合は知らせてください。」',
  ...
  'protocolRuleAria': '境界付きタスクの4つの問い',
  'protocolRuleOne': '定義',
  'protocolRuleOneBody': '範囲に含める結果は何で、意図的に除外するものは何ですか？',
  'protocolRuleTwo': '実行',
  'protocolRuleTwoBody': 'モデルやツールに許可する操作は何で、何を保留しますか？',
  'protocolRuleThree': '検証',
  'protocolRuleThreeBody': '何が起きたかを示せる情報源、差分、テスト、受け入れ確認はどれですか？',
  'protocolRuleFour': '引き継ぎ',
  'protocolRuleFourBody': '未知の点も含め、次の担当者に何を渡しますか？',
  'pathEyebrow': '学習パス',
  ...
  'skillsTitle': '26の Skill。それぞれに明確な役割。',
  ...
  'skillIndexLink': 'Skill レジストリと全26メソッドを開く',
  ...
  'mobileIndexDetailsAria': '詳細なプロジェクトマップ',
  'mobileIndexDetailsSummary': '詳細な地図を開く',
  'mobileIndexDetailsIntro': '上のショートカットは簡易表示です。このパネルを開くと、正規の読書マップ、フィールド調査、保守ルールを確認できます。',
  'mobileIndexDetailsReadme': '正規の読書マップ',
  'mobileIndexDetailsResearch': 'フィールド調査インデックス',
  'mobileIndexDetailsUpdates': '保守更新マップ',
  'skillFootnote': '全26のプロジェクト Skill は構造チェックに合格し candidate のままです。新しいタスクのエビデンスは部分的です。Platform Observation Record は1つの目に見える作業面を記録するもので、能力や安全性の主張ではありません。Practice Target は最初の1回の試行を設定するもので、学習を証明するものではありません。Interruption Checkpoint はタスクの確認記録を保存するもので、作業の再試行や復旧は行いません。Platform Fact Watch はメンテナンスの確認記録であり、現在のプラットフォームのチェックではありません。LLM Comparison Protocol は未実行の比較メソッドであり、モデルランキングではありません。Adversarial Project Review は外部レビューではありません。',
  ...
  'starterReceiptLabel': 'やさしい言葉の確認記録',
  ...
  'fileSkillsBody': 'トリガー、境界、エビデンス契約を備えた26のプロジェクト Skill。',
  ...
  'localeTitle': '8言語ルート',
  'localeIntro': 'リポジトリの入口として8つの言語が登録されています。コースの各ルートは選択した言語を維持し、補助ページは翻訳状態を明示します。同じ言語のページがない場合、Reader は別言語へ黙って切り替えません。',
  ...
  'visualCaseBody': 'まず試行し、1つの問題を訂正し、ケースを変えて練習し、範囲を明示した確認記録を残します。',
  ...
  'repositorySkills': '再利用可能な Skill 26件 · candidate',
  ...
  'promptContractStopLabel': '停止と確認記録',
...
copy.ko = {
  ...
  'heroProofSource': '“워크숍 일정이 바뀌었습니다. 금요일 10시에 시작합니다. 초안을 가져오세요. 참석할 수 없으면 알려 주세요.”',
  ...
  'protocolRuleAria': '범위가 정해진 작업을 위한 네 가지 질문',
  'protocolRuleOne': '정의',
  'protocolRuleOneBody': '범위에 포함할 결과는 무엇이며, 의도적으로 제외할 것은 무엇인가요?',
  'protocolRuleTwo': '실행',
  'protocolRuleTwoBody': '모델이나 도구가 할 수 있는 일은 무엇이고, 무엇을 보류하나요?',
  'protocolRuleThree': '검증',
  'protocolRuleThreeBody': '무슨 일이 일어났는지 보여 줄 출처, diff, 테스트 또는 수용 기준은 무엇인가요?',
  'protocolRuleFour': '인계',
  'protocolRuleFourBody': '알 수 없는 점을 포함해 다음 담당자에게 무엇을 전달하나요?',
  'pathEyebrow': '학습 경로',
  ...
  'skillsEyebrow': '역량 계층',
  'skillsTitle': '26개 Skill. 서로 다른 역할.',
  ...
  'skillIndexLink': 'Skill 레지스트리와 전체 26개 메서드 열기',
  ...
  'starterReceiptLabel': '쉬운 말로 된 점검 기록',
  ...
  'fileSkillsBody': '트리거, 경계, 증거 계약을 갖춘 프로젝트 Skill 26개.',
  ...
  'localeTitle': '8개 언어 경로',
  'localeIntro': '리포지토리 진입 언어 8개가 등록되어 있습니다. 각 과정 경로는 선택한 언어를 유지하고, 보조 페이지는 번역 상태를 명시합니다. 같은 언어의 페이지가 없으면 Reader는 다른 언어로 조용히 바꾸지 않습니다.',
  ...
  'repositorySkills': '재사용 가능한 Skill 26개 · candidate',
...
copy.de = {
  ...
  'heroProofSource': '„Der Workshop wurde verschoben. Er beginnt am Freitag um 10 Uhr. Bring den Entwurf mit. Gib Bescheid, wenn du nicht kommen kannst.“',
  ...
  'protocolRuleAria': 'Vier Fragen für eine begrenzte Aufgabe',
  'protocolRuleOne': 'Definieren',
  'protocolRuleOneBody': 'Welches Ergebnis gehört zum Umfang, und was bleibt bewusst außen vor?',
  'protocolRuleTwo': 'Handeln',
  'protocolRuleTwoBody': 'Was darf das Modell oder Tool tun, und was bleibt pausiert?',
  'protocolRuleThree': 'Verifizieren',
  'protocolRuleThreeBody': 'Welche Quelle, welcher Diff, Test oder Abnahmeschritt kann zeigen, was passiert ist?',
  'protocolRuleFour': 'Übergeben',
  'protocolRuleFourBody': 'Was soll die nächste Person erhalten, einschließlich der offenen Punkte?',
  ...
  'skillsTitle': 'Sechsundzwanzig Skills. Klare Aufgaben.',
  ...
  'skillIndexLink': 'Das Skill-Register und alle 26 Methoden öffnen',
  ...
  'starterReceiptLabel': 'Prüfprotokoll in einfacher Sprache',
  ...
  'fileSkillsBody': '26 Projekt-Skills mit Triggern, Grenzen und Belegverträgen.',
  ...
  'localeTitle': 'Acht-Sprachen-Route',
  'localeIntro': 'Acht Einstiegssprachen sind registriert. Jede Kursroute bleibt in der gewählten Sprache; Zusatzseiten behalten ihren Übersetzungsstatus und schließen ausdrücklich, wenn eine gleichsprachige Seite fehlt.',
  ...
  'visualCaseBody': 'Zuerst versuchen, einen Punkt korrigieren, den Fall variieren und dann ein begrenztes Prüfprotokoll aufbewahren.',
  ...
  'repositorySkills': '26 wiederverwendbare Skills · candidate',
  ...
  'promptContractStopLabel': 'Stopp und Prüfprotokoll',
...
Object.assign(copy.en, {
  'localeTitle': 'Eight-language route',
  'localeIntro': 'Eight repository entry locales are registered. Each course route covers 22 chapters and 18 Labs in its selected language; supplemental pages retain their own translation status and fail closed when a same-language page is unavailable.',
...
Object.assign(copy.zh, {
  'localeTitle': '八语种路线',
  'localeIntro': '仓库已登记八种入口语言。每条课程路线都覆盖 22 章和 18 个实验，并保持当前选择的语言；补充页面保留自己的翻译状态，缺少同语言页面时会明确失败关闭。',
  'localeEnglish': '可用 · 默认',
...
Object.assign(copy.es, {
  ...
  'localeTitle': 'Ruta de ocho idiomas',
  'localeIntro': 'Se registran ocho idiomas de entrada. Cada ruta del curso cubre 22 capítulos y 18 Labs en el idioma seleccionado; las páginas suplementarias mantienen su estado de traducción y fallan de forma explícita si falta una página en el mismo idioma.',
...
Object.assign(copy.ja, {
  ...
  'localeTitle': '8言語ルート',
  'localeIntro': '8つの入り口言語が登録されています。コースの各ルートは22章と18件のLabを選択した言語でカバーし、補助ページは翻訳状態を明示します。同じ言語のページがない場合、Reader は別言語へ黙って切り替えません。',
  'localeEnglish': '利用可能 · デフォルト',
...
Object.assign(copy.ko, {
  ...
  'localeTitle': '8개 언어 루트',
  'localeIntro': '8개의 진입 언어가 등록되어 있습니다. 각 과정 경로는 22개 장과 18개 Lab을 선택한 언어로 제공하며, 보조 페이지는 번역 상태를 명시합니다. 같은 언어의 페이지가 없으면 Reader는 다른 언어로 조용히 바꾸지 않습니다.',
  'localeEnglish': '사용 가능 · 기본값',
...
Object.assign(copy.de, {
  ...
  'localeTitle': 'Acht-Sprachen-Route',
  'localeIntro': 'Acht Einstiegssprachen sind registriert. Jede Kursroute umfasst 22 Kapitel und 18 Labs in der gewählten Sprache; Zusatzseiten behalten ihren Übersetzungsstatus und schließen ausdrücklich, wenn eine gleichsprachige Seite fehlt.',
  'localeEnglish': 'verfügbar · Standard',
...
Object.assign(copy.en, {
  'skillsTitle': 'Twenty-six Skills. Distinct jobs.',
  'skillIndexLink': 'Open the Skill registry and all 26 methods',
  'skillFootnote': 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Language Partner runs one typed exchange; it does not teach a language or promise fluency. Interview Rehearsal coaches one answer; it does not predict interview questions or promise an outcome. Interruption Checkpoint preserves a task check record; it does not retry or recover work. Platform Fact Watch is a maintenance check record, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  'fileSkillsBody': '26 project Skills with triggers, boundaries, and evidence contracts.',
  'ledgerSkills': 'Skills · 26',
  'repositorySkills': '26 reusable Skills · candidate',
...
Object.assign(copy.zh, {
  'skillsTitle': '二十六个 Skill，各有职责。',
  'skillIndexLink': '打开 Skill 登记表与全部 26 个方法',
  'skillFootnote': '26 个项目 Skill 均通过结构检查并保持 candidate；新鲜任务证据仍不完整。语言伙伴只运行一次打字对话，不教语言、不承诺流利。面试演练只教练一个回答，不预测面试问题、不承诺结果。中断检查点只保留任务检查记录，不会重试或恢复工作。练习目标用于准备一次首次尝试，不能证明学习结果。平台事实巡检是维护记录，不是当前平台检查。LLM 比较协议尚未运行，不是模型排行榜。对抗式项目审查不代表外部评审。',
  'fileSkillsBody': '26 个项目 Skill，包含触发、边界与证据契约。',
  'ledgerSkills': 'Skill · 26',
  'repositorySkills': '26 个可复用 Skill · candidate',
...
Object.assign(copy.ja, {
  'skillsTitle': '26のSkill。それぞれ役割が違います。',
  'skillIndexLink': 'Skill レジストリと全26メソッドを開く',
  'skillFootnote': 'プロジェクトの26のSkill はすべて構造チェックに合格し candidate のままです。新しいタスクのエビデンスは部分的です。Language Partner は文字会話を1回実行するだけで、言語を教えたり流暢さを約束したりしません。Interview Rehearsal は回答を1つ練習するだけで、面接問題を予測したり結果を約束したりしません。Interruption Checkpoint はタスクの確認記録を保存するもので、作業の再試行や復旧は行いません。Practice Target は最初の試行を設定するもので、学習を証明するものではありません。Platform Fact Watch はメンテナンスの確認記録であり、現在のプラットフォームのチェックではありません。LLM Comparison Protocol は未実行の比較メソッドであり、モデルランキングではありません。Adversarial Project Review は外部レビューではありません。',
  'fileSkillsBody': 'プロジェクトの26のSkill（トリガー、境界、エビデンス契約付き）。',
  'ledgerSkills': 'Skills · 26',
  'repositorySkills': '再利用可能な26のSkill · candidate',
...
Object.assign(copy.ko, {
  'skillsTitle': '스물여섯 개의 Skill. 역할이 각각 다릅니다.',
  'skillIndexLink': 'Skill 레지스트리와 26개 메서드 열기',
...
Object.assign(copy.de, {
  'skillsTitle': 'Sechsundzwanzig Skills. Klar getrennte Aufgaben.',
  'skillIndexLink': 'Skill-Register und alle 26 Methoden öffnen',
  ...
  'fileSkillsBody': '26 Projekt-Skills mit Triggern, Grenzen und Beleg-Verträgen.',
  'ledgerSkills': 'Skills · 26',
  'repositorySkills': '26 wiederverwendbare Skills · candidate',
...
Object.assign(copy.en, {
  skillsTitle: 'Twenty-six Skills. Distinct jobs.',
  skillIndexLink: 'Open the Skill registry and all 26 methods',
  skillFootnote: 'All 26 project Skills pass structural checks and remain candidate; fresh-task evidence is partial. Language Partner runs one typed exchange; it does not teach a language or promise fluency. Interview Rehearsal coaches one answer; it does not predict interview questions or promise an outcome. Interruption Checkpoint preserves a task check record; it does not retry or recover work. Practice Target sets up one first attempt; it does not prove learning. Platform Fact Watch is a maintenance check record, not a current-platform check. LLM Comparison Protocol is an unrun comparison method, not a model ranking. Adversarial Project Review is not an external review.',
  fileSkillsBody: '26 project Skills with triggers, boundaries, and evidence contracts.',
  ledgerSkills: 'Skills · 26',
  repositorySkills: '26 reusable Skills · candidate',
  skillRouteLanguagePartner: 'I want to practise a language by typing.',
...
Object.assign(copy.en, {
  ...
  heroRouteKicker: 'One required foundation route · preview 1 → 2 → 3, then finish 4 → 5',
  heroRouteContinuationAria: 'Continue the five-unit foundation route',
  heroRouteContinuationLabel: 'Continue inside the core route',
  ...
  heroRouteUnitThree: '4 · Unit 3: visible failures',
  heroRouteUnitThreeBody: 'Mark omissions, unsupported additions, forced ambiguity, and overconfidence.',
  heroRouteUnitFourFive: '5 · Units 4–5: check, repair, and transfer',
  heroRouteUnitFourFiveBody: 'Use evidence, make a minimum correction, state limits, and repeat on an unseen task.',
  heroRouteBoundary: 'The first three cards are a preview, not a competing set of starting points. Finish all five units before entering Codex, tools, Agents, or Skills; the warm-up is optional.',
});
Object.assign(copy.zh, {
  heroRouteAria: '必修 LLM 基础路线',
  heroRouteKicker: '一条必修基础路线 · 先看 1 → 2 → 3，再完成 4 → 5',
  heroRouteContinuationAria: '继续五单元基础路线',
  heroRouteContinuationLabel: '在核心路线中继续',
  ...
  heroRouteUnitThree: '4 · 单元 3：看见常见失败',
  heroRouteUnitThreeBody: '标出遗漏、无依据添加、强行补全和过度自信。',
  heroRouteUnitFourFive: '5 · 单元 4–5：检查、修正并迁移',
  heroRouteUnitFourFiveBody: '使用证据做最小修正，说明限制，再在未见任务上重复方法。',
  heroRouteBoundary: '前三张卡是路线预览，不是三个竞争性的起点。进入 Codex、工具、Agent 或 Skill 前，请完成全部五个单元；5 分钟热身是可选项。',
});
Object.assign(copy.es, {
  heroRouteAria: 'Ruta obligatoria de fundamentos de LLM',
  heroRouteKicker: 'Una ruta obligatoria · mira 1 → 2 → 3 y termina 4 → 5',
  heroRouteContinuationAria: 'Continuar la ruta de fundamentos de cinco unidades',
  heroRouteContinuationLabel: 'Continúa dentro de la ruta principal',
  ...
  heroRouteUnitThree: '4 · Unidad 3: fallos visibles',
  heroRouteUnitThreeBody: 'Marca omisiones, adiciones sin apoyo, ambigüedad forzada y exceso de confianza.',
  heroRouteUnitFourFive: '5 · Unidades 4–5: comprobar, reparar y transferir',
  heroRouteUnitFourFiveBody: 'Usa evidencia, haz una corrección mínima, declara límites y repite en una tarea nueva.',
  heroRouteBoundary: 'Las tres primeras tarjetas son una vista previa, no tres puntos de partida. Completa las cinco unidades antes de entrar en Codex, herramientas, agentes o Skills; el calentamiento de cinco minutos es opcional.',
});
Object.assign(copy.ja, {
  heroRouteAria: '必修 LLM 基礎ルート',
  heroRouteKicker: '必修基礎ルート · 1 → 2 → 3 を見て、4 → 5 まで完了',
  heroRouteContinuationAria: '5つのユニットからなる基礎ルートを続ける',
  heroRouteContinuationLabel: '基礎コアルートの中で続ける',
  ...
  heroRouteUnitThree: '4 · ユニット3：見える失敗',
  heroRouteUnitThreeBody: '抜け、根拠のない追加、無理な曖昧さの補完、過信を印付けします。',
  heroRouteUnitFourFive: '5 · ユニット4〜5：確認、修正、転移',
  heroRouteUnitFourFiveBody: '根拠で最小限に修正し、限界を示し、未知の課題で方法を繰り返します。',
  heroRouteBoundary: '最初の3枚はプレビューであり、競合する入口ではありません。Codex、ツール、Agent、Skillに進む前に5ユニットを完了してください。5分間のウォームアップは任意です。',
});
Object.assign(copy.ko, {
  heroRouteAria: '필수 LLM 기초 경로',
  heroRouteKicker: '필수 기초 경로 · 1 → 2 → 3을 보고 4 → 5까지 완료',
  heroRouteContinuationAria: '다섯 단위 기초 경로 계속하기',
  heroRouteContinuationLabel: '기초 코어 경로에서 계속하기',
  ...
  heroRouteUnitFourFive: '5 · 단원 4–5: 점검, 수정, 전이',
  heroRouteUnitFourFiveBody: '근거로 최소 수정하고 한계를 밝힌 뒤 새 과제에서 방법을 반복합니다.',
  heroRouteBoundary: '앞의 세 카드는 미리보기이며 경쟁하는 시작점이 아닙니다. Codex, 도구, Agent, Skill로 가기 전에 다섯 단위를 모두 끝내세요. 5분 워밍업은 선택 사항입니다.',
});
Object.assign(copy.de, {
  heroRouteAria: 'Verbindlicher LLM-Grundlagenpfad',
  heroRouteKicker: 'Verbindlicher Grundlagenpfad · 1 → 2 → 3 ansehen und 4 → 5 abschließen',
  heroRouteContinuationAria: 'Den fünfteiligen Grundlagenpfad fortsetzen',
  heroRouteContinuationLabel: 'Im Kernpfad fortfahren',
  ...
  heroRouteUnitThree: '4 · Einheit 3: sichtbare Fehler',
  heroRouteUnitThreeBody: 'Auslassungen, unbelegte Zusätze, erzwungene Mehrdeutigkeit und Überkonfidenz markieren.',
  heroRouteUnitFourFive: '5 · Einheiten 4–5: prüfen, reparieren und übertragen',
  heroRouteUnitFourFiveBody: 'Belege nutzen, minimal korrigieren, Grenzen nennen und die Methode an einer neuen Aufgabe wiederholen.',
  heroRouteBoundary: 'Die ersten drei Karten sind eine Vorschau, keine konkurrierenden Einstiege. Schließe alle fünf Einheiten ab, bevor du Codex, Werkzeuge, Agents oder Skills öffnest; die Fünf-Minuten-Aufwärmübung ist optional.',
});

// Keep the Simplified Chinese route free from accidental cross-locale leakage.
Object.assign(copy.zh, {
  heroRouteUnitThreeBody: '标记遗漏、无依据的新增内容、被迫的歧义和过度自信。',
  heroRouteUnitFourFive: '5 · 第 4–5 单元：检查、修正并迁移',
  heroRouteUnitFourFiveBody: '使用证据，做最小修正，说明边界，并在新任务上重复这套方法。',
  heroRouteBoundary: '前 3 张卡是路线预览，不是互相竞争的起点。完成 5 个单元后，再打开 Codex、工具、Agent 或 Skill；5 分钟热身是可选的。',
});
...
Object.assign(copy.en, {
  ...
  repositorySkills: '26 reusable methods for recurring work',
...
Object.assign(copy.zh, {
  ...
  repositoryChapters: '22 个章节，从基础走向可靠工作', repositoryLabs: '18 个安全练习，带你一步一步做', repositorySkills: '26 个可复用的方法，应对重复工作', repositoryDocs: '来源、贡献指南与项目说明',
...
Object.assign(copy.es, {
  ...
  repositoryChapters: '22 capítulos, de los fundamentos al trabajo fiable', repositoryLabs: '18 ejercicios guiados para practicar con seguridad', repositorySkills: '26 métodos reutilizables para tareas recurrentes', repositoryDocs: 'Fuentes, guías de contribución y notas del proyecto',
...
Object.assign(copy.ja, {
  ...
  repositoryChapters: '基礎から信頼できる仕事まで、全22章', repositoryLabs: '安全に練習するためのガイド付き演習18本', repositorySkills: '繰り返しの仕事に使える方法26個', repositoryDocs: '出典、貢献ガイド、プロジェクトノート',
...
Object.assign(copy.ko, {
  ...
  repositoryChapters: '기초부터 신뢰할 수 있는 작업까지, 22개 장', repositoryLabs: '안전한 연습을 위한 안내형 실습 18개', repositorySkills: '반복 작업에 쓰는 재사용 가능한 방법 26개', repositoryDocs: '출처, 기여 가이드, 프로젝트 노트',
...
Object.assign(copy.de, {
  ...
  repositoryChapters: '22 Kapitel – von den Grundlagen zu zuverlässiger Arbeit', repositoryLabs: '18 angeleitete Übungen für sichere Praxis', repositorySkills: '26 wiederverwendbare Methoden für wiederkehrende Aufgaben', repositoryDocs: 'Quellen, Beitragsleitfäden und Projektnotizen',
...
// The external editorial Skill is part of the shared catalogue, so every
// interface locale gets a native-shaped label and description. These strings
// describe the method's boundary; they do not claim automatic translation or
// native-speaker certification.
Object.assign(copy.es, {
  skillProseName: 'Edición de prosa para proyectos open source',
  skillProse: 'Mejora la documentación pública y los textos localizados sin cambiar los hechos ni el sentido regional.',
});
Object.assign(copy.ja, {
  skillProseName: 'オープンソース文書の推敲',
  skillProse: '事実や地域ごとの意味を変えずに、公開プロジェクトの文章とローカライズ文を整えます。',
});
Object.assign(copy.ko, {
  skillProseName: '오픈 소스 문안 다듬기',
  skillProse: '사실과 지역적 의미를 바꾸지 않고 공개 프로젝트 문서와 현지화 문구를 다듬습니다.',
});
Object.assign(copy.de, {
  skillProseName: 'Open-Source-Texte redigieren',
  skillProse: 'Öffentliche Projekttexte und lokalisierte Fassungen redigieren, ohne Fakten oder regionale Bedeutung zu verändern.',
});
...
Object.assign(copy.zh, {
  ...
  visualCaseAlt: '先尝试、修正、改变条件并保留记录的入门练习闭环',
...
Object.assign(copy.es, {
  ...
  visualCaseAlt: 'Bucle de práctica para principiantes: intentar, corregir, variar y conservar un registro de comprobación',
...
Object.assign(copy.en, {
  ...
  optionalRoutesSummary: 'Optional application routes · open after the foundation',
  optionalRoutesIntro: 'These routes are useful when you already know what you want to practise. They do not replace the LLM Foundation Core.',
...
Object.assign(copy.zh, {
  ...
  optionalRoutesSummary: '可选应用路线 · 完成基础后再打开',
  optionalRoutesIntro: '当你已经知道要练习什么时，再使用这些路线。它们不会替代 LLM 基础核心课。',
...
Object.assign(copy.es, {
  ...
  optionalRoutesSummary: 'Rutas de aplicación opcionales · abrir después de los fundamentos',
  optionalRoutesIntro: 'Usa estas rutas cuando ya sepas qué quieres practicar. No sustituyen el núcleo de fundamentos de LLM.',
...
Object.assign(copy.ja, {
  ...
  optionalRoutesSummary: '任意の応用ルート · 基礎の後に開く',
  optionalRoutesIntro: '練習したい内容が決まっている場合に使います。LLM 基礎コアの代わりにはなりません。',
...
Object.assign(copy.ko, {
  ...
  optionalRoutesSummary: '선택 응용 경로 · 기초 다음에 열기',
  optionalRoutesIntro: '무엇을 연습할지 이미 알고 있을 때 사용하세요. LLM 기초 코어를 대신하지 않습니다.',
...
Object.assign(copy.de, {
  ...
  optionalRoutesSummary: 'Optionale Anwendungsrouten · nach den Grundlagen öffnen',
  optionalRoutesIntro: 'Nutze diese Routen, wenn du bereits weißt, was du üben möchtest. Sie ersetzen nicht den LLM-Grundlagenkern.',
...
Object.assign(copy.es, {
  localePartialAnchorNotice: 'Resumen local; esta sección detallada aún no está traducida.'
});
Object.assign(copy.ja, {
  localePartialAnchorNotice: 'ローカル概要です。この詳細セクションはまだ翻訳されていません。'
});
Object.assign(copy.ko, {
  localePartialAnchorNotice: '현지 언어 개요입니다. 이 상세 섹션은 아직 번역되지 않았습니다.'
});
Object.assign(copy.de, {
  localePartialAnchorNotice: 'Lokale Übersicht; dieser Detailabschnitt ist noch nicht übersetzt.'
});

// Final foundation-first copy guard. These values keep an offline preview
// aligned with the same public entry contract as the generated site.
Object.assign(copy.en, {
...
Object.assign(copy.zh, {
  ...
  foundationVisualsIntro: '把这两张原创图当作速查表。它们回答初学者的两个问题：怎样写出能检查的提示词，以及什么记录能证明行动真的发生。',
  ...
  foundationActionVisualBody: '提议、授权、执行和人工核对。',
...
// key in the Traditional Chinese locale.
copy['zh-tw'] = typeof window.PRYSAI_TRADITIONALIZE === 'function'
  ? window.PRYSAI_TRADITIONALIZE(copy.zh)
  : Object.assign({}, copy.zh);
Object.assign(copy['zh-tw'], {
  ...
  mobileIndexDetailsAria: '詳細專案地圖',
  mobileIndexDetailsSummary: '開啟詳細地圖',
  mobileIndexDetailsIntro: '上方快捷入口是精簡檢視。開啟此面板可查看規範閱讀地圖、現場研究與維護規則。',
  mobileIndexDetailsReadme: '規範閱讀地圖',
  mobileIndexDetailsResearch: '現場研究索引',
  mobileIndexDetailsUpdates: '維護更新地圖',
  menuCloseAria: '關閉導覽',
  ...
  heroTitle: '先理解 LLM，再讓它開始工作。',
  heroProofSource: '「嗨，工作坊改期了。週五 10 點開始。請帶上草稿。如果你不能參加，請告訴我。」',
  heroProofPreserve: '保留週五 10 點、草稿和回覆要求；不要新增日期、地點、原因或聯絡方式。',
  heroProofCheckOne: '週五 10 點和草稿仍然保留。',
...
Object.assign(copy.fr, {
  ...
  "wordmarkAria": "Prysai LLM Accueil du livre de jeu",
  "languageToggleAria": "Choisir la langue de l'interface",
  ...
  "menuClose": "Fermer",
  "navStart": "Commencez ici",
  "navFirst30": "Pratique rapide de cinq minutes",
  "navIndex": "Index des projets",
  "navPath": "Parcours d'apprentissage",
  "navRoutes": "Itinéraires de lecture",
  "navLabs": "Labs",
  "navSkills": "Skill",
  "localeBannerFallback": "Cet itinéraire linguistique est sélectionné. Si une page demandée n'est pas disponible, Reader conserve cette langue et explique l'étape suivante ; il ne remplace jamais une page de cours d'anglais sans le dire.",
  "navUpdates": "Mettre à jour la carte",
  "localeManifestError": "Le routage local n'est pas disponible car le manifeste généré n'a pas été chargé. L'anglais reste disponible; reconstruisez le manifeste avant de vous fier à d’autres routes.",
  "localeBannerReady": "Lecture en {language}.",
  "localeMenuAria": "Langues d'interface",
  "languageNameEnglish": "Anglais",
  "languageNameChinese": "Chinois simplifié",
  "languageNameSpanish": "Espagnol",
  "languageNameTraditionalChinese": "Chinois traditionnel",
  "languageNameJapanese": "japonais",
  "languageNameKorean": "coréen",
  "languageNameGerman": "Allemand",
  "languageNameFrench": "Français",
  "localePartialAnchorNotice": "Aperçu local ; cette section détaillée n'est pas encore traduite.",
  "heroEyebrow": "Commencez par le modèle · puis faites une tentative vérifiée",
  "heroIndex": "LLM / SYSTÈME DE FONDATION",
  "heroTitle": "Comprenez les LLM avant de leur demander de travailler.",
  "heroLede": "Découvrez ce qu'un modèle de langage peut et ne peut pas établir, rédigez une requête limitée, inspectez la réponse et répétez la méthode sur une nouvelle tâche. Codex, les outils, les Agent et les Skill viennent après cette fondation.",
  "heroPrimary": "Démarrez le noyau de base LLM",
  "heroSecondary": "Voir l'exemple facultatif de cinq minutes",
  "heroRouteAria": "Le tracé de fondation LLM requis",
  "heroRouteGuidedTitle": "Vous avez un projet jetable et souhaitez Codex ? Suivez le sentier guidé.",
  "heroRouteKicker": "Un itinéraire de fondation requis · aperçu 1 → 2 → 3, puis terminer 4 → 5",
  "heroRouteGuidedBody": "Commencez par le chapitre 1. La première modification locale intervient une fois que sa portée et les limites des preuves sont visibles.",
  "heroRouteFixtureTitle": "Besoin d'un fichier sûr pour le parcours Codex ? Ouvrez le support hors ligne.",
  "heroRouteFixtureBody": "Il fournit une cible et un test après le chapitre 2. Il s'agit d'une solution de repli et non d'un substitut au chemin guidé.",
  "heroRouteBoundary": "Les trois premières cartes sont un aperçu et non un ensemble de points de départ concurrents. Terminez les cinq unités avant d'entrer dans Codex, les outils, les Agent ou les Skill ; l'échauffement est facultatif.",
  "heroProofAria": "Exemple d'invite de cinq minutes",
  "heroProofKicker": "EXEMPLE DE CINQ MINUTES",
  "heroProofStatus": "Exemple facultatif · pas la leçon de base",
  "heroProofTitle": "Voir une petite invite fait la différence.",
  "heroProofSource": "\"Bonjour, l'atelier a changé. Il commence vendredi à 10 heures. Apportez le brouillon. Dis-moi si tu ne peux pas venir.\"",
  "heroProofSourceLabel": "MESSAGE SOURCE",
  "heroProofPreserveLabel": "PRÉSERVER LES FAITS",
  "heroProofPreserve": "Gardez vendredi à 10 heures, le brouillon et la demande de réponse. N'ajoutez pas de date, de lieu, de raison ou de méthode de contact.",
  ...
  "heroFooter": "Problème → protocole → action → preuve",
  "startEyebrow": "Après la fondation · choisissez un objectif",
  "startTitle": "Que voulez-vous que le modèle vous aide à faire ensuite ?",
  "problemStartTitle": "Je ne sais pas par où commencer.",
  ...
  "problemStartBody": "Commencez par les fondamentaux des LLM : leurs limites, les demandes délimitées, les erreurs observables, la correction et le transfert, avant de choisir une plateforme.",
  "problemStartLink": "Démarrer le noyau de base LLM → première requête limitée ↗",
  "problemWrongFileTitle": "Le dossier ou le résultat est incertain.",
  "problemWrongFileLink": "Apprenez le contrôle de récupération ↗",
  "problemWrongFileBody": "Gelez la prochaine modification. Comparez la portée demandée, git diff, la vérification ciblée et les inconnues restantes.",
  "problemSkillTitle": "Je dois choisir ou concevoir un Skill.",
  "problemSkillBody": "Commencez par le déclencheur, les entrées, les limites et le contrat de preuves ; alors seulement, décidez si un Skill mérite une place.",
  "problemSkillLink": "Apprenez à choisir un Skill ↗",
  ...
  "problemUpdateTitle": "Je dois publier ou mettre à jour en toute sécurité.",
  "problemUpdateLink": "Apprenez le chemin de mise à jour sécurisé ↗",
  "problemIntakeTitle": "J'ai un objectif large et je ne sais pas quoi pratiquer en premier.",
  "problemIntakeBody": "Demandez une décision à la fois. Choisissez un itinéraire existant, une tentative vérifiable, une aide autorisée et une solution de repli plus petite.",
  "problemLanguageTitle": "Je veux pratiquer une compétence linguistique.",
  "problemIntakeLink": "Choisissez une première pratique ↗",
  "problemLanguageLink": "Commencer une pratique linguistique ↗",
  "problemGeneralSkillTitle": "Je veux pratiquer une autre vraie compétence.",
  "problemLanguageBody": "Définissez une performance observable, essayez-la avant l'instruction, corrigez une erreur bloquant le sens, puis testez un cas modifié.",
  "problemGeneralSkillBody": "Transformez une réponse, une explication ou une présentation d'un entretien en une performance chronométrée, puis testez-la à nouveau dans des conditions modifiées.",
  "problemGeneralSkillLink": "Choisissez une pratique de compétence ↗",
  ...
  "problemResearchTitle": "J'ai besoin de rechercher une question limitée.",
  "problemResearchLink": "Commencer le parcours de recherche ↗",
  "first30Eyebrow": "Une pratique rapide de cinq minutes sur LLM",
  "first30Title": "Découvrez pourquoi une invite claire nécessite une vérification humaine.",
  "first30Intro": "Utilisez n’importe quel modèle de chat. Vous lui confierez une petite tâche de réécriture, puis vérifierez s'il a préservé les faits au lieu d'inventer des détails qui semblent utiles.",
  "stepOneTitle": "Choisissez un changement réversible.",
  "stepOneBody": "Utilisez un fichier sandbox ou une petite modification de la documentation. Ne commencez pas par des informations d'identification, une production ou une commande destructrice.",
  "stepTwoTitle": "Rédigez le contrat de tâche.",
  "stepTwoBody": "Énoncez l'objectif, le contexte, les actions autorisées, les critères d'acceptation, les preuves et la condition d'arrêt.",
  "stepThreeTitle": "Laissez le modèle inspecter en premier.",
  "stepFourTitle": "Vérifiez ce qui a changé.",
  "stepThreeBody": "Demandez le matériel pertinent et l'état actuel avant d'autoriser une modification ou une action externe. Gardez la portée visible.",
  "stepFourBody": "Examinez la différence, effectuez la plus petite vérification pertinente et enregistrez ce qui n'a pas été testé.",
  "checkCardLabel": "Un contrat de mission utile",
  "fieldGoal": "Effectuez un changement de nom.",
  "fieldGoalLabel": "But",
  "fieldContextLabel": "Contexte",
  "fieldContext": "Uniquement les fichiers nécessaires à cette tâche.",
  "fieldInputs": "Chemins, comportement actuel, contraintes.",
  "fieldInputsLabel": "Entrées",
  "fieldAllowedLabel": "Actions autorisées",
  "fieldAllowed": "Lire et modifier ; pause avant les effets externes.",
  "fieldAcceptanceLabel": "Acceptation",
  "fieldAcceptance": "Un résultat de comparaison et de vérification spécifique.",
  "fieldEvidenceLabel": "Preuve",
  "fieldEvidence": "Diff, commande, sortie et limites.",
  "fieldStopLabel": "Arrêtez-vous quand",
  "fieldStop": "La portée, l'autorité ou les preuves sont manquantes.",
  "openChapterTwo": "Ouvrir le chapitre 2",
  "contractHighlight": "La première tâche la plus sûre est petite, réversible et facile à inspecter.",
  "starterTitle": "Demandez au modèle d’améliorer un message sans inventer de faits.",
  "starterEyebrow": "Votre premier entraînement rapide",
  "starterCopy": "Copier l'invite",
  "starterCopied": "Invite copiée. Collez-le dans un modèle de discussion, puis lisez la réponse aux trois questions.",
  "starterIntro": "Cela montre pourquoi les invites sont importantes. Un modèle peut améliorer la sonorité d'un message, mais il peut également ajouter des détails que vous n'avez jamais fournis. Donnez une instruction claire, puis vérifiez si elle l’a suivie.",
  "starterCopyFailed": "La copie a échoué. Sélectionnez le texte d'invite manuellement.",
  "starterBoundary": "Prêt. La réalisation de cet exercice enregistre une tentative vérifiée ; cela ne prouve pas l’apprentissage ou la capacité générale.",
  "starterProgressionAria": "Continuer à partir du noyau de la Fondation LLM",
  "starterDeepen": "Choisissez une autre pratique pour débutants",
  "starterCodexPath": "Continuer le noyau de la fondation LLM",
  "starterBoundaryLab": "Repérez la limite : Lab 011",
  "starterBoundedTask": "Choisissez une tâche locale délimitée : chapitre 2",
  "starterPractice": "Exécutez Lab 001 : travaillez avec des fichiers et Git",
  "starterEvidence": "Apprenez à vous remettre d'une mauvaise réponse",
  "protocolEyebrow": "Le cadre de travail",
  "protocolTitle": "Toute tâche sérieuse a besoin d’une limite.",
  "protocolIntro": "Ce cadre est le langage commun entre une personne, un modèle, un outil et un Agent. Utilisez-le avant d'ajouter des autorisations ou des Skill.",
  "protocolLink": "Lire le protocole de la tâche",
  "protocolRuleAria": "Quatre questions pour une tâche délimitée",
  "protocolNote": "Si une entrée manquante modifie la portée, le risque ou le test d'acceptation, faites une pause et demandez. Si cela n’affecte qu’une lecture à faible risque, inspectez d’abord et signalez l’hypothèse.",
  "protocolRuleOne": "Définir",
  "protocolRuleOneBody": "Quel résultat est visé et qu’est-ce qui est délibérément exclu ?",
  "protocolRuleTwo": "Acte",
  "protocolRuleTwoBody": "Que peut faire le modèle ou l’outil, et qu’est-ce qui reste en pause ?",
  "protocolRuleThree": "Vérifier",
  "protocolRuleThreeBody": "Quelle source, différence, test ou contrôle d'acceptation peut montrer ce qui s'est passé ?",
  "protocolRuleFour": "Remettre",
  "protocolRuleFourBody": "Que devrait recevoir la prochaine personne, y compris les inconnus ?",
  "pathEyebrow": "Parcours d'apprentissage",
  "pathIntro": "Choisissez un niveau et voyez exactement quoi lire, faire, utiliser, soumettre et refuser de réclamer. Un niveau n'est pas un décompte de lectures.",
  "pathTitle": "Sept niveaux. Un contrat exécutable.",
  "currentLevel": "Niveau actuel",
  "nextStep": "Étape suivante",
  "requiredChapters": "Chapitres obligatoires",
  "requiredLabs": "Laboratoire requis",
  "supportingSkills": "Skills associés",
  "evaluationFixtures": "Dispositifs d'évaluation",
  "evidenceGate": "Porte des preuves",
  "graduationGate": "Avancez quand",
  "blockedWhen": "Arrêtez-vous quand",
  "fourEvidence": "Quatre types de preuves",
  "evidenceExplain": "Expliquer",
  "evidenceOperate": "Fonctionner",
  "evidenceJudge": "Juge",
  "evidenceReview": "Revoir",
  "boundary": "limite",
  "positive": "positif",
  "transfer": "transfert",
  "failure": "échec",
  "statusCandidate": "La structure et les contrôles de base sont réussis ; de nouvelles preuves sont encore nécessaires.",
  "labFirstSeen": "Introduit",
  "labReused": "Réutilisé à partir de",
  "labCapability": "Capacité",
  "labArtifact": "Artefact",
  "labAcceptance": "Acceptation",
  "levelL0Name": "Observateur",
  "levelL0Short": "Remarquez ce qui s'est passé",
  "levelL1Name": "Utilisateur sécurisé",
  "levelL1Short": "Effectuer une tâche à faible risque",
  "levelL2Name": "Concepteur de tâches",
  "levelL2Short": "Écrire un protocole de tâche",
  "levelL3Name": "Concepteur de flux de travail",
  "levelL3Short": "Passer de la définition à la livraison",
  "levelL4Name": "Constructeur de capacités",
  "levelL4Short": "Choisissez le plus petit ensemble utile",
  "levelL5Name": "Examinateur de preuves",
  "levelL5Short": "Déclarations d'achèvement des tests",
  "levelL6Name": "Entraîneur d'équipe",
  "levelL6Short": "Transformez la méthode en système",
  "chaptersEyebrow": "Les parcours de lecture",
  "chaptersTitle": "22 chapitres. Quatre façons d'entrer.",
  "chaptersIntro": "Lire afin de construire le modèle. Sautez par itinéraire lorsqu'une tâche réelle vous bloque. Chaque itinéraire renvoie à la pratique et aux preuves.",
  "filterAll": "Tous les chapitres",
  "filterA": "A · Premier contact",
  "filterB": "B · Un vrai travail",
  "filterC": "C · Capacité",
  "routeATitle": "Premier contact avec Codex",
  "filterD": "D · Pratique en équipe",
  "routeADesc": "01—06 · terminer une première tâche en toute sécurité",
  "routeBTitle": "Codex pour le vrai travail",
  "routeBDesc": "07—13 · concevoir un flux de travail vérifiable",
  "routeCTitle": "Capacité et collaboration Agent",
  "routeCDesc": "14—18 · choisissez la plus petite combinaison utile",
  "routeDTitle": "De la maîtrise à la pratique en équipe",
  "routeDDesc": "19—22 · transformer votre méthode personnelle en capacité d'équipe",
  "candidateStatus": "candidat",
  "chapter02": "Effectuer une tâche sûre et vérifiable",
  "chapter01": "Comprendre GPT avant Codex",
  "chapter03": "Transformez un souhait en protocole de tâche",
  "chapter04": "Contexte, autorisations et limites Agent",
  "chapter05": "Choisissez la bonne surface Codex",
  "chapter06": "Le choix d’un modèle n’est pas un culte du modèle",
  "chapter08": "Le cycle de vie complet, de la définition à la livraison",
  "chapter07": "Comment les Skill, les plugins, les MCP et les outils répartissent le travail",
  "chapter09": "Vérification, doute et récupération",
  "chapter10": "Planification et tranches verticales",
  "chapter11": "Concevoir un Skill qui mérite sa place",
  "chapter12": "Conditions de boucle, d'état et d'arrêt Agent",
  "chapter13": "Limites d'action entre les fichiers, les terminaux, les navigateurs et GitHub",
  "chapter14": "Découvrez, installez et auditez un Skill externe",
  "chapter16": "Ingénierie : de l'idée au logiciel fiable",
  "chapter15": "Recherche : de la question à la connaissance auditable",
  "chapter18": "Contenu, conception, données et automatisation",
  "chapter17": "Marketing : du contexte produit aux expérimentations",
  "chapter19": "Évaluer les modèles et les flux de travail",
  "chapter20": "Construire un système de travail personnel Codex",
  "chapter21": "Construire un système de capacité d’équipe",
  "chapter22": "Gardez le système à jour et récupérable",
  "labsEyebrow": "Le laboratoire",
  "labsTitle": "Rendre le principe observable.",
  "labsIntro": "Les labs sont des tâches reproductibles à faible risque. Chacun précise la configuration, les preuves, une variante d’échec, les données à ne pas partager et une réflexion.",
  "draftStatus": "brouillon",
  "startingLab": "premier laboratoire",
  "lab01Title": "Première tâche sécuritaire",
  "lab01Body": "Dans un projet sandbox, demandez à Codex d'inspecter avant de modifier. Transformez « terminé » en une différence vérifiable.",
  "lab02Title": "Protocole de tâche",
  "lab02Body": "Divisez une demande vague en objectif, entrées, contraintes, acceptation et gestion des échecs.",
  "lab03Title": "Examen des preuves",
  "lab03Body": "Trouvez un résultat qui semble complet mais qui ne contient aucune preuve de son affirmation.",
  "lab04Title": "Sélection Skill",
  "lab04Body": "Expliquez le choix et refusez d'utiliser la taille du répertoire comme proxy d'ajustement.",
  "lab05Title": "Concevoir un Skill",
  "lab05Body": "Transformez une méthode stable en une capacité avec des limites, des preuves et des cas d'échec.",
  "lab06Title": "Conditions d'arrêt Agent",
  "lab07Title": "Limites des actions",
  "lab06Body": "Définissez des points d'arrêt en cas de réussite, d'entrée manquante, d'échec récupérable et de conflit d'autorisation.",
  "lab07Body": "Comparez les preuves nécessaires pour lire, éditer, exécuter, valider, pousser et publier.",
  "lab08Title": "Question de recherche",
  "lab08Body": "Transformez un vaste sujet en une question, un plan source et un tableau de preuves minimales.",
  "lab09Title": "Cycle de vie de l'ingénierie",
  "lab09Body": "Comparez la mise en œuvre directe avec un cycle de vie complet et enregistrez les preuves de retouche.",
  "lab10Title": "Contexte du produit partagé",
  "lab10Body": "Versionnez une compréhension partagée du produit et séparez les faits des hypothèses.",
  "lab11Title": "Limites GPT et Codex",
  "lab12Title": "Migration des capacités de l'équipe",
  "lab11Body": "Utilisez des fiches de tâches statiques pour séparer la génération, l’exécution, la vérification et les effets externes.",
  "lab12Body": "Créez un contrat pour la version, le propriétaire, les autorisations, la reproduction indépendante et la restauration.",
  "labsIndexLink": "Ouvrez les règles du laboratoire et les 18 entrées",
  "skillsEyebrow": "Couche de capacités",
  "skillsTitle": "Vingt-six Skills. Des rôles distincts.",
  "skillsIntro": "Un Skill est une méthode avec un déclencheur, une vérification d'entrée, des limites, des conditions d'arrêt, un contrat de sortie et un moyen de le vérifier.",
  "skillCoach": "Choisissez un parcours d’apprentissage et des limites de pratique.",
  "skillProtocol": "Transformez une vague demande en un contrat exécutable.",
  "skillEvidence": "Décomposez les affirmations d’achèvement en preuves vérifiables.",
  "skillSelector": "Choisissez le plus petit ensemble de capacités utiles.",
  "skillWorkflow": "Gérez les étapes, les points de contrôle et le transfert.",
  "skillResearch": "Converger une question en connaissances auditables.",
  "skillContext": "Séparez les principes stables des faits changeants.",
  "skillLearningName": "Coach d'apprentissage",
  "skillLearning": "Entraînez-vous avec le rappel, la correction, la révision différée et le transfert.",
  "skillSourceName": "Enquêteur source",
  "skillSource": "Transformez des recherches étendues en enquêtes limitées et étayées par des sources.",
  "skillSignalName": "Conservateur des signaux de terrain",
  "skillSignal": "Transformez des rapports publics en éléments de preuve documentés sur la demande, dans un périmètre défini.",
  "skillAdapterName": "Examen de l'adaptateur de plate-forme",
  "skillAdapter": "Rejetez les leçons de la plateforme sans un delta sourcé et exécutable.",
  "skillTriageName": "Triage des échecs de communication",
  "skillTriage": "Diagnostiquez une interaction ayant échoué et testez à nouveau la plus petite réparation.",
  "skillBriefName": "Résumé du dialogue",
  "skillBrief": "Transformez une demande non essayée à faible risque en un premier message prêt à être copié.",
  "skillFirstTurnCheckName": "Vérification au premier tour",
  "skillFirstTurnCheck": "Inspectez une demande à faible risque non envoyée pour vérifier les limites visibles.",
  "skillProseName": "Prose polonaise open source",
  "skillProse": "Révisez la prose publique et la copie locale sans changer les faits ni la signification régionale.",
  "skillRouteBrief": "Je dois écrire un premier message clair.",
  "skillRouteBriefResult": "Renvoie un premier tour à faible risque, prêt à être copié, avec une vérification et une limite d'arrêt.",
  "skillRouteFirstTurnCheck": "J'ai déjà rédigé une première demande et je souhaite l'inspecter.",
  "skillRouteFirstTurnCheckResult": "Labels écarts de matériaux sans rédiger une invite de remplacement.",
  "skillBoundaryName": "Des méthodes originales d’abord.",
  "skillBoundary": "Les Skill externes doivent conserver le projet source URL et la limite de licence.",
  "skillIndexLink": "Ouvrez le registre Skill et les 26 méthodes",
  "mobileIndexAria": "Index complets des projets",
  "mobileIndexChapters": "chapitres",
  "mobileIndexLabs": "laboratoires",
  "mobileIndexSkills": "Skill",
  "mobileIndexCases": "cas de terrain",
  "mobileIndexLocales": "enregistrements de paramètres régionaux",
  "mobileIndexVisuals": "tableaux pédagogiques",
  "mobileIndexUpdates": "Mettre à jour les zones",
  "mobileIndexTrust": "Faire confiance aux familles",
  "mobileIndexDetailsAria": "Carte détaillée du projet",
  "mobileIndexDetailsSummary": "Ouvrir la carte détaillée",
  "mobileIndexDetailsIntro": "Les raccourcis ci-dessus correspondent à la vue compacte. Ouvrez ce panneau pour la carte de lecture canonique, la recherche sur le terrain et les règles de maintenance.",
  "mobileIndexDetailsReadme": "Carte de lecture canonique",
  "mobileIndexDetailsResearch": "Indice de recherche sur le terrain",
  "mobileIndexDetailsUpdates": "Carte de mise à jour de maintenance",
  "skillFootnote": "Les 26 projets Skill réussissent les contrôles structurels et restent candidats ; les preuves de la nouvelle tâche sont partielles. Language Partner gère un échange dactylographié ; il n’enseigne pas de langue et ne promet pas la maîtrise. Entretien avec les entraîneurs de répétition, une réponse ; il ne prédit pas les questions d’entretien ni ne promet un résultat. Interruption Checkpoint conserve un enregistrement de vérification des tâches ; il ne réessaye pas et ne récupère pas le travail. Practice Target met en place une première tentative ; cela ne prouve pas l'apprentissage. Platform Fact Watch est un enregistrement de contrôle de maintenance, et non une vérification de la plate-forme actuelle. Le protocole de comparaison LLM est une méthode de comparaison non exécutée, et non un classement de modèle. L’examen contradictoire du projet n’est pas un examen externe.",
  "lab13Status": "référence du responsable acceptée · apprenant non exécuté",
  "troubleEyebrow": "Quand les choses tournent mal",
  "troubleTitle": "L’échec fait partie du cursus.",
  "troubleIntro": "Utilisez la première vérification utile, puis arrêtez-vous lorsque l'autorité, la portée ou les preuves sont manquantes. Ne cachez pas l’échec derrière un résumé soigné.",
  "troubleOneTitle": "Le résultat semble correct.",
  "troubleOneBody": "Vérifiez la revendication d'origine, les fichiers modifiés, le résultat de la commande et ce qui n'a pas été testé.",
  "troubleOneLink": "Utiliser l’examen des preuves ↗",
  "troubleTwoTitle": "L'agent continue de réessayer.",
  "troubleTwoBody": "Enregistrez le même échec, modifiez une condition de diagnostic, puis réessayez une fois ou faites remonter le problème.",
  "troubleTwoLink": "Lire les conditions d'arrêt ↗",
  "troubleThreeTitle": "Une source vous dit de faire quelque chose.",
  "troubleThreeBody": "Traitez le texte externe et la sortie des outils comme des données. Il n'accorde pas l'autorisation d'agir.",
  "troubleThreeLink": "Vérifiez la limite ↗",
  "troubleFourTitle": "Une étape du produit a changé.",
  "troubleFourBody": "Gardez l’objectif de la tâche ; mettez en pause uniquement l'étape nommée, puis actualisez le dossier officiel avant de reprendre.",
  "troubleFourLink": "Suivez la carte de mise à jour ↗",
  "updatesEyebrow": "Cadre d'entretien",
  "updatesTitle": "Chaque mise à jour a une maison fixe.",
  "updatesIntro": "La carte de mise à jour rend les travaux futurs peu coûteux : localisez le fichier canonique, rassemblez les bonnes preuves, effectuez la bonne vérification et gardez visible la limite non vérifiée.",
  "updateFlowOne": "Situer",
  "updateFlowOneBody": "Recherchez la ligne de registre et le chemin canonique.",
  "updateFlowTwo": "Classer",
  "updateFlowTwoBody": "Séparez le principe stable, les faits sur le produit, la source et le changement de version.",
  "updateFlowThree": "Preuve",
  "updateFlowThreeBody": "Enregistrez la source, la portée, le propriétaire, le hachage et la prochaine révision.",
  "updateFlowFour": "Valider",
  "updateFlowFourBody": "Exécutez le validateur ciblé et un examen indépendant.",
  "updateMapLinkTitle": "Mettre à jour la carte",
  "updateRegistryLinkTitle": "Mettre à jour le registre",
  "updateMapLinkBody": "Qu'est-ce qui change, où et de quelles preuves cela a-t-il besoin.",
  "updateRegistryLinkBody": "Le contrat de maintenance lisible par machine.",
  "factImpactLinkTitle": "Carte d’impact des faits",
  "factImpactLinkBody": "Quels chapitres, laboratoires, Skill, évaluations et pages un fait changeant peut affecter.",
  "updateTemplateLinkTitle": "Mettre à jour l'enregistrement",
  "updateTemplateLinkBody": "Un enregistrement reproductible pour les modifications non triviales.",
  "lifecycleLinkTitle": "Cycle de vie du contenu",
  "lifecycleLinkBody": "Les portes des preuves et de la libération.",
  "statusEyebrow": "Limite des preuves",
  "statusTitle": "Un statut est une affirmation concernant des preuves.",
  "statusIntro": "Ce projet ne transforme pas le nombre de documents, le nombre de Skill ou une sortie réussie en « maîtrise ». Utilisez le statut soutenu par les preuves.",
  "statusDraft": "Encore en cours de rédaction ou sans contrôle minimal.",
  "statusVerified": "La portée déclarée comporte des preuves positives, de délimitation, d'échec et de transfert.",
  "statusProduction": "Les portes de sécurité, de maintenance, de version, de licence et de libération sont également acceptées.",
  "statusSourceBefore": "Les preuves actuelles sont enregistrées dans",
  "statusSourceLink": "la source de l’état actuel",
  "statusReviewBefore": " et expliqué par ",
  "statusSourceAfter": "; la page reste candidate car cette revue ne couvre que le périmètre local enregistré.",
  "statusReviewLink": "l'examen du navigateur",
  "nextEyebrow": "Action suivante",
  "nextTitle": "Apportez un petit problème.",
  "nextBody": "Ouvrez le contrat de tâche, choisissez une première étape réversible et conservez le diff. C’est le chemin le plus court et utile pour commencer.",
  "nextPrimary": "Ouvrir le chapitre 2",
  "nextSecondary": "Ensuite, exécutez l'atelier 001",
  "footerTagline": "Un système d'apprentissage et de pratique pratique pour les modèles de langage.",
  "mobileRouteFixture": "Faites votre première requête limitée",
  "visualCaseIntro": "Quatre tableaux originaux montrent la méthode, les limites des preuves et la boucle de pratique.",
  "visualCaseBoundary": "Utilisez ces diagrammes pour comprendre la méthode, puis testez-la sur une petite tâche de votre choix.",
  "footerMeta": "Commencez petit. Vérifiez ce qui compte. Apprenez-en davantage avec chaque tâche.",
  "skillStarterEyebrow": "Choisissez par situation",
  "skillStarterTitle": "Commencez ici si les noms ne veulent encore rien dire.",
  "skillStarterIntro": "Ce sont des itinéraires de départ, pas des diagnostics automatiques. Ouvrez une méthode, vérifiez ses entrées requises et arrêtez-vous si la limite ne correspond pas.",
  "skillRouteUnclear": "Ma tâche n'est toujours pas claire.",
  "skillRouteUnclearResult": "Renvoie un objectif limité, des entrées, des actions, une acceptation et une condition d'arrêt.",
  "skillRouteLearnCodex": "Je dois apprendre Codex.",
  "skillRouteLearnCodexResult": "Renvoie un niveau d'apprentissage, une expérience, une vérification des preuves et une réflexion Codex.",
  "skillRouteLearnOther": "Je dois pratiquer une autre capacité.",
  "skillRouteLearnOtherResult": "Renvoie une ligne de base, une correction, une tentative de transfert de cas modifié et un signal de révision.",
  "skillRouteFailed": "Une demande et une réponse conservées ont déjà échoué.",
  "skillRouteFailedResult": "Renvoie un diagnostic fondé sur des preuves et une plus petite réparation comparable.",
  "skillRouteVerify": "Je dois vérifier une affirmation existante.",
  "skillRouteVerifyResult": "Renvoie ce que les preuves prouvent, manquent et exigent ensuite.",
  "mobileRoutesAria": "Choisissez votre prochain déménagement",
  "mobileRouteTask": "Apprenez les concepts LLM",
  "mobileRoutePractice": "Pratiquer la langue, la recherche ou une autre compétence",
  "mobileRouteIndexes": "Parcourez les index complets des projets",
  "mobileAllRoutes": "Ouvrez chaque route problématique",
  "starterPreview": "Prévisualiser l'invite complète",
  "starterSequenceAria": "Séquence avant, invite, vérification humaine et réparation",
  "starterCheckOne": "Est-ce qu'il est toujours écrit vendredi à 10 heures ?",
  "starterCheckTwo": "Demande-t-il toujours aux gens d'apporter le brouillon et de répondre s'ils ne peuvent pas venir ?",
  "starterCheckThree": "A-t-il évité d'ajouter une date, un lieu, une raison ou des coordonnées ?",
  "starterCheckPass": "PASSER",
  "starterCheckFail": "ÉCHOUER",
  "starterCheckUnsure": "PAS SÛR",
  "starterCheckGate": "Enregistrez les trois jugements avant de comparer avec un exemple.",
  "starterCheckReady": "Les trois jugements sont enregistrés. Vous pouvez maintenant comparer avec la réponse illustrative.",
  "starterCheckRecovery": "Un contrôle échoué ou incertain est enregistré. Utilisez l'invite de sauvetage, puis conservez cet enregistrement comme observation locale.",
  "starterCheckOneAria": "Enregistrez si les faits ont été conservés",
  "starterCheckTwoAria": "Enregistrez si l’action demandée a été conservée",
  "starterCheckThreeAria": "Enregistrez si des détails non pris en charge ont été ajoutés",
  "starterCompare": "Comparez avec une forme acceptable",
  "starterComparisonBoundary": "Cette réponse illustrative reste cachée jusqu'à ce que les trois jugements soient enregistrés. Cela ne marque pas votre réponse et ne prouve pas votre apprentissage.",
  "starterExample": "\"L'atelier commence vendredi à 10 heures. Veuillez apporter votre brouillon. Si vous ne pouvez pas y assister, veuillez répondre.\"",
  "starterRescueCopy": "Copier l'invite de secours",
  "starterRescueCopied": "Invite de secours copiée. Réparez uniquement la première vérification échouée.",
  "starterHelpLabel": "Aide utilisée",
  "starterHelpAria": "Aide à l'enregistrement utilisée",
  "starterHelpPrompt": "Première invite",
  "starterHelpRescue": "Invite de sauvetage",
  "starterHelpBoth": "Les deux invites",
  "starterCorrectionLabel": "Correction après vérification",
  "starterCorrectionAria": "Enregistrer l'état de correction",
  "starterCorrectionNotNeeded": "Pas nécessaire",
  "starterCorrectionCorrected": "Corrigé",
  "starterCorrectionNotYet": "Pas encore",
  "starterRecordNotRecorded": "Non enregistré",
  "starterCopyRecord": "Copier mon relevé de vérification local",
  "starterReceiptAria": "Relevé de vérification du premier essai local",
  "starterRecordCopied": "Relevé de vérification copié. Il contient uniquement les statuts, pas votre réponse.",
  "starterRecordCopyFailed": "Impossible de copier le relevé de vérification local. Sélectionnez son texte manuellement.",
  "starterRecoveryLink": "Transfert de récupération ouvert",
  "starterReceiptLabel": "Fiche de vérification en langage clair",
  "routeStatusAll": "Affichage des 22 chapitres.",
  "starterReceipt": "Tentative · vérifiée ici · aide utilisée · corrigée · non prouvée : apprentissage, transfert, capacité générale d'écriture ou supériorité du modèle.",
  "routeStatusA": "Affichage de 6 chapitres dans A · Premier contact.",
  "routeStatusB": "Affichage de 7 chapitres en B · Travail réel.",
  "routeStatusC": "Affichage de 5 chapitres en C · Capacité.",
  "routeStatusD": "Affichage de 4 chapitres dans D · Pratique d'équipe.",
  "featuredLab": "laboratoire en vedette",
  "lab13Title": "Tranche verticale vérifiable",
  "lab13Body": "Exécutez une modification locale Markdown du protocole et de la ligne de base au point de contrôle, à la comparaison, à la vérification ciblée, à l'échec et au transfert.",
  "lab14Title": "Reprendre le rapprochement",
  "lab14Body": "Réconciliez le pointeur de tâche, la cible, la branche, les autorisations et l'état des effets secondaires avant de continuer.",
  "lab15Title": "Remise des preuves",
  "lab15Body": "Divisez une phrase de fin en revendications, portées, résultats et la plus petite vérification suivante.",
  "lab16Title": "Limite des effets secondaires",
  "lab16Body": "Séparez le diagnostic de l’installation, de la publication, du redémarrage et des autres actions persistantes.",
  "lab17Title": "Audit de découverte Skill",
  "lab17Body": "Vérifiez l'existence, la découverte, le chargement, le comportement, la licence et l'adoption en tant que revendications distinctes.",
  "lab18Title": "Transfert de langue",
  "lab18Body": "Conservez une base de référence sans aide, corrigez une erreur bloquant le sens, puis testez un cas modifié sans réutiliser les phrases de cours.",
  "learningPathWarning": "Les données du parcours d'apprentissage n'ont pas été chargées. Afficher la solution de repli locale ; vérifiez les données générées avant de vous fier à cette route.",
  "skillCoachName": "Coach Codex",
  "skillProtocolName": "Protocole de tâche",
  "skillEvidenceName": "Examen des preuves",
  "skillWorkflowName": "Orchestrateur de flux de travail",
  "skillSelectorName": "Sélecteur Skill",
  "skillResearchName": "Routeur de recherche",
  "skillContextName": "Contexte du produit",
  "indexEyebrow": "Index des projets",
  "indexTitle": "Sachez où vérifier chaque affirmation.",
  "indexIntro": "Il s'agit d'une carte lisible du référentiel : ce que chaque couche stocke, par où commencer et quelle source contrôle son statut.",
  "fileMapTitle": "Carte du référentiel",
  "fileMapIntro": "Lisez la couche qui correspond à l'œuvre. La page publique est un guide ; les fichiers ci-dessous sont la source de la vérité.",
  "fileSiteTitle": "Vitrine publique",
  "fileSiteBody": "index.html, styles.css, app.js et données de parcours d'apprentissage générées.",
  "fileChaptersTitle": "Texte d'apprentissage de base",
  "fileChaptersBody": "22 chapitres qui construisent la méthode étape par étape.",
  "fileLabsTitle": "Pratique guidée",
  "fileLabsBody": "18 exercices à faible risque avec des contrôles et une réflexion clairs.",
  "fileSkillsTitle": "Méthodes réutilisables",
  "fileSkillsBody": "26 projets Skill avec déclencheurs, limites et contrats de preuves.",
  "fileDocsTitle": "Gouvernance et recherche",
  "fileDocsBody": "Statut, sources, rapports de terrain, règles de mise à jour et enregistrements qualité.",
  "ledgerTitle": "État du contenu",
  "ledgerIntro": "Une lecture compacte de la source d’état actuelle. Le statut décrit des preuves, pas une ambition.",
  "ledgerProject": "Projet",
  "ledgerChapters": "Chapitres · 22",
  "ledgerLabs": "Lab · 18",
  "ledgerSkills": "Skill · 26",
  "ledgerResearch": "Recherche sur le terrain",
  "ledgerResearchNote": "rapports d'utilisateurs ; non reproduit localement",
  "ledgerSource": "Ouvrir la source de l’état actuel",
  "localeTitle": "Lisez dans votre langue",
  "localeIntro": "Choisissez la langue que vous lisez le plus naturellement. L'interface et le parcours du cours restent dans cette langue au fur et à mesure que vous avancez dans le livre.",
  "localeEnglish": "Anglais",
  "localeChinese": "Chinois simplifié",
  "localeTraditionalChinese": "disponible · 繁體中文",
  "localeSpanish": "Espagnol",
  "localeGerman": "Allemand",
  "localeJapanese": "japonais",
  "localeKorean": "coréen",
  "localeRule": "Changez de langue dans le menu en haut chaque fois que vous en avez besoin.",
  "researchTitle": "De vrais problèmes, avec la frontière attachée.",
  "researchIntro": "L'index de recherche transforme les problèmes publics Codex, les conseils de sécurité de première partie et les rapports de forum en symptômes, limites de source, contrôles de sécurité et liens pédagogiques. Il ne prétend pas à une cause officielle ou à une reproduction locale.",
  "researchBoundary": "Lisez les sources à côté des notes pédagogiques et considérez-les comme des points de départ pour votre propre enquête.",
  "researchIndexLink": "Ouvrir l'index des problèmes de terrain",
  "researchIndexBody": "Codex, surfaces, transferts, authentification, arbres de travail et symptômes de vérification.",
  "researchForumsLink": "Lire les notes de cas du forum",
  "researchForumsBody": "Listes autorisées du réseau Sandbox, échecs de génération Windows, approbations, encodage et chemins privés.",
  "researchLiveLink": "Examinez trois cas de terrain actuels",
  "researchLiveBody": "Cible de l'arbre de travail, preuves cachées et portée de la vérification ; tous restent non vérifiés localement.",
  "researchSafetyLink": "Lire les limites de sécurité de la collaboration IA",
  "researchSafetyBody": "Injection rapide, contribution minimale nécessaire, autorité d'action et vérification ; recherche de candidats fondée sur la source.",
  "researchReceiptsLink": "Lire les signaux du champ de sécurité de l'IA",
  "researchReceiptsBody": "Rapports publics, classement des affirmations et point de contrôle pour les recherches longues ; dossier encore au stade de candidat.",
  "researchFirstTurnLink": "Rédiger un premier tour universel",
  "researchFirstTurnBody": "Une carte d'espagnol ou de recherche à six champs contenant uniquement du texte ; recherche de candidats, et non équivalence de plateforme ou revendication de résultat.",
  "researchPublicInterestLink": "Mener l’enquête de sécurité d’intérêt public",
  "researchPublicInterestBody": "Un cas fictif fixe : personnes, limites des données, contrôle humain, preuves et arrêt ; candidat / not_run.",
  "problemPublicInterestSafetyTitle": "J'ai besoin d'évaluer une idée d'IA qui pourrait affecter les gens.",
  "problemPublicInterestSafetyBody": "Nommez une décision, les personnes qu’elle pourrait imposer, les données nécessaires, les recours humains, les preuves et le moment où le travail doit s’arrêter.",
  "problemPublicInterestSafetyLink": "Lancer l'enquête de sécurité ↗",
  "visualCaseTitle": "Voir la méthode en contexte.",
  "visualModelLink": "Demande de preuve",
  "visualModelBody": "Portée, action, vérification et transfert limité.",
  "visualSkillLink": "Quatre lentilles de preuve",
  "visualSkillBody": "Existence, exactitude, préparation et apprentissage.",
  "visualFieldLink": "Signal de champ → dégradation sûre",
  "visualFieldBody": "Trois rapports ouverts ; aucune reproduction locale ni confirmation officielle de la cause profonde.",
  "visualCaseLink": "Boucle d'entraînement pour débutants",
  "visualCaseBody": "Essayez d'abord de corriger un problème, de modifier le cas, puis de conserver un enregistrement de contrôle limité.",
  "searchLabel": "Rechercher dans le Playbook",
  "searchSubmit": "Recherche",
  "searchPlaceholder": "Rechercher des chapitres, des laboratoires, des Skill ou des cas de terrain",
  "searchClear": "Clair",
  "searchTitle": "Trouvez une réponse limitée.",
  "searchNoQuery": "Tapez un mot ou une phrase pour rechercher dans le Playbook.",
  "searchLoading": "Chargement de l'index de recherche locale…",
  "searchNoResults": "Aucun résultat pour « {query} ». Essayez un titre de chapitre, un nom Skill ou une phrase plus précise.",
  "searchResultsCount": "{count} résultats pour « {query} ».",
  "searchIndexUnavailable": "L'index de recherche locale n'a pas pu être chargé. Vérifiez la connexion, puis soumettez-la à nouveau pour réessayer.",
  "searchFallback": "Source en anglais affichée · La traduction demandée n'est pas prête",
  "searchOpen": "Lecteur ouvert",
  "searchKindChapter": "Chapitre",
  "searchKindLab": "Lab",
  "searchKindSkill": "Méthode Skill",
  "searchKindFieldNote": "Note de terrain",
  "searchKindBook": "Inscription au livre",
  "searchKindProject": "Entrée du projet",
  "searchKindDocument": "Document",
  "problemRecoveryTitle": "Le modèle a répondu à la mauvaise tâche.",
  "problemRecoveryBody": "Conservez la demande, le contexte visible, la réponse réelle et le résultat attendu. Modifiez une condition de communication, puis exécutez une comparaison sécurisée.",
  "problemRecoveryLink": "Réparer un échange échoué ↗",
  "repositoryStripAria": "Répertoires sources canoniques et limites actuelles",
  "repositoryStripTitle": "Ce que contient ce référentiel",
  "repositoryStripIntro": "Commencez par la leçon, puis utilisez les exercices et les méthodes réutilisables lorsque vous êtes prêt à pratiquer.",
  "repositoryChapters": "22 chapitres, des fondations au travail fiable",
  "repositoryLabs": "18 exercices guidés pour une pratique sécuritaire",
  "repositorySkills": "26 méthodes réutilisables pour un travail récurrent",
  "repositoryDocs": "Sources, guides de contribution et notes de projet",
  "skillCardIndex": "03 / PRATIQUE DES COMPÉTENCES",
  "skillCardScope": "plan fictif · pas d'outil d'autorité",
  "skillCardTitle": "Pratiquez une petite compétence de planification avant de demander de l’aide.",
  "skillCardIntro": "Élaborez vous-même un court plan fictif de visite du parc. Le modèle doit attendre, donner un petit indice, puis tester la même compétence sous une limite modifiée.",
  "skillCardStepOne": "Copiez la carte dans n'importe quelle discussion textuelle. Il contient une situation fictive et ne nécessite aucun compte, fichier, outil ou détail personnel.",
  "skillCardStepTwo": "Rédigez vous-même le premier plan dans les quatre minutes. Ne demandez pas d’abord un plan modèle ou un remplacement soigné.",
  "skillCardStepThree": "Acceptez un bref indice, corrigez votre propre plan, puis essayez le délai modifié sans aide.",
  "skillCardLink": "Lire la limite compétence-pratique",
  "skillCardBoundary": "Pratique du candidat uniquement : un court plan fictif ne peut pas prouver la capacité de planification, le jugement, le transfert, la rétention, la sécurité ou la performance indépendante.",
  "skillPromptText": "Aidez-moi à m'entraîner à élaborer un petit plan. Ne rédigez pas le plan à ma place.\n\nTâche pratique : planifier une visite fictive de 45 minutes dans un parc de la ville pour un adulte. Incluez une bouteille d'eau, une vérification de la météo et un rappel de l'heure de retour. Il ne s’agit ni d’une réservation réelle, ni d’une décision de voyage, ni d’une prévision météo.\n\nAvant d’écrire, affichez cette grille fixe : 3 à 5 étapes ; les trois contraintes sont présentes ; aucun fait local n’est ajouté sans source ; une autre personne pourrait suivre le plan. Donnez-moi quatre minutes pour l’écrire. Ne montrez pas de modèle, ne développez pas le plan et ne le notez pas avant ma réponse.\n\nAprès mon premier essai, signalez une seule omission à la fois. Posez une question ou donnez un indice de 12 mots maximum, puis attendez ma correction. Conservez les deux essais. Changez ensuite uniquement la durée, de 45 à 20 minutes, et demandez-moi un nouveau plan sans aide, avec la même grille.\n\nTerminez par exactement un statut : pratiqué, démontré_sur_cette_tâche, transféré_à_la_variation_de_durée ou not_run. Une seule séance ne prouve ni une capacité générale de planification, ni le jugement, ni la sécurité, ni la performance autonome.",
  "promptCardShow": "Afficher l'invite",
  "skillPromptCardName": "Éditeur de cartes d'invite",
  "skillPromptCard": "Transformez une idée d'invite autorisée en une carte pédagogique sensible à la source.",
  "skillAdversarialName": "Examen contradictoire du projet",
  "skillAdversarial": "Classez les faiblesses matérielles avant une décision de publication ou de diffusion.",
  "skillEscalationName": "Demande d'escalade",
  "skillEscalation": "Choisissez la plus petite voie sûre avant de rédiger, de rechercher ou d’agir.",
  "skillComparisonName": "Protocole de comparaison LLM",
  "skillPracticeTargetName": "Cible d'entraînement",
  "skillComparison": "Planifiez une comparaison équitable entre deux candidats sans inventer de classement.",
  "skillFactWatchName": "Veille factuelle sur la plateforme",
  "skillPracticeTarget": "Transformez un vaste souhait d’apprentissage en une première tentative observable.",
  "skillRouteEscalation": "Je ne sais pas encore de quel type d’aide j’ai besoin.",
  "skillFactWatch": "Cartographiez une revendication de produit changeante avant qu'une étape nommée n'induise les lecteurs en erreur.",
  "skillRouteEscalationResult": "Choisit la plus petite voie sûre avant de rédiger, de rechercher ou d’agir.",
  "promptDeckEyebrow": "Cartes d'invite facultatives · cinq minutes",
  "promptDeckTitle": "Commencez par une petite conversation.",
  "promptDeckIntro": "Choisissez une carte originale contenant uniquement du texte. Les fiches de langue et de planification ne nécessitent aucune modification ; la carte de recherche comporte deux parenthèses. Inspectez vous-même la réponse et limitez vos affirmations : une seule tentative n'est pas une maîtrise, une recherche ou une réponse terminée.",
  "promptContractTitle": "Rendez six parties visibles.",
  "promptContractKicker": "Avant d'envoyer",
  "promptContractGridAria": "Six champs à inspecter dans une première requête LLM",
  "promptContractLink": "Lire la justification",
  "promptContractOutcomeBody": "Un petit résultat observable.",
  "promptContractOutcomeLabel": "Résultat",
  "promptContractContextLabel": "Contexte de départ",
  "promptContractContextBody": "Ce que vous savez ou fournissez.",
  "promptContractResponseLabel": "Réponse demandée",
  "promptContractResponseBody": "La forme, la longueur ou la séquence.",
  "promptContractLimitsLabel": "Limites",
  "promptContractLimitsBody": "Des données et des actions qui restent à l'écart.",
  "promptContractCheckLabel": "Vérifier",
  "promptContractCheckBody": "Ce que vous inspecterez vous-même.",
  "promptContractStopLabel": "Arrêt et réception",
  "promptContractStopBody": "Quand s’arrêter et quoi garder.",
  "promptCardScope": "texte uniquement · aucune autorité d'outil",
  "promptCardCopy": "Copier l'invite",
  "promptCardCopied": "Invite copiée. Suivez les trois étapes, puis inspectez vous-même la réponse.",
  "promptCardCopyFailed": "Impossible de copier l'invite. Sélectionnez le texte manuellement.",
  "spanishCardIndex": "01 / PRATIQUE DES LANGUES",
  "spanishCardTitle": "Effectuez une courte vérification du temps dactylographié pour un groupe d'étude en espagnol.",
  "spanishCardIntro": "Cette carte contenant uniquement du texte utilise des détails d'étude fictifs, attend votre tentative de saisie et limite l'aide à une erreur bloquant le sens.",
  "spanishCardStepOne": "Copiez la carte exactement telle qu'elle est écrite. Il définit déjà un contrôle horaire fictif dactylographié pour un groupe d’étude en espagnol.",
  "spanishCardStepTwo": "Collez-le dans n'importe quelle discussion textuelle. N'ajoutez pas de vrai nom, d'école, d'agenda, de compte ou de détails de paiement.",
  "spanishCardStepThree": "Tapez vous-même la première réponse. Il s’agit d’une tentative grossière ; ne demandez pas la réponse en premier.",
  "spanishCardLink": "Lire les limites de pratique",
  "spanishCardBoundary": "Pratique textuelle du candidat uniquement : une session dactylographiée ne peut pas montrer une conversation orale, une prononciation, une écoute, une fluidité, une précision, une rétention ou une performance indépendante.",
  "spanishPromptText": "Effectuez une vérification de l'heure dactylographiée d'un groupe d'étude en espagnol de quatre minutes avec exactement quatre tours d'apprenant. Vous êtes un camarade de classe fictif et écrivez en premier. Utilisez uniquement des questions courtes au présent. Je taperai une réponse après chaque question.\n\nCarte d'étude fictive : Ana ; un groupe d'étude; mardi ou jeudi; 6h00 ou 6h30 ; bibliothèque ou en ligne; apportez une question. Je peux utiliser la carte et rechercher au maximum trois mots simples. Ne demandez ni n’acceptez pas de vrai nom, école, calendrier, compte, adresse, contact ou détails de paiement.\n\nAvant le premier tour, montrez cette rubrique fixe : quatre tours d’apprenant ; objectif et groupe d’étude communiqués ; jour et heure clarifiés ; lieu ou option en ligne communiqué ; Espagnol suffisamment compréhensible pour continuer. N'enseignez pas, ne traduisez pas et ne montrez pas de modèle de réponse avant que je réponde. Conservez ma première tentative et enregistrez les recherches. Corrigez uniquement la première erreur bloquant le sens : nommez le type d'erreur, puis donnez un indice partiel, puis un fragment travaillé uniquement si je ne peux toujours pas continuer. Demandez-moi de le corriger. Conservez les deux tentatives et n'appelez pas une seule preuve réussie de maîtrise de l'échange, de conversation orale ou d'écoute/prononciation.",
  "researchCardIndex": "02 / PRÉPARATION À LA RECHERCHE",
  "researchCardTitle": "Préparez une vérification à la source, pas un verdict.",
  ...
  "researchCardStepOne": "Copiez la carte, puis replacez uniquement ses deux supports.",
  "researchCardStepTwo": "Fournissez uniquement le matériel que vous pouvez partager. Oubliez les documents personnels, privés ou à enjeux élevés.",
  "researchCardLink": "Lire le périmètre de recherche",
  ...
  "skillInterruptionName": "Point de contrôle d'interruption",
  "skillInterruption": "Conservez ce qui est connu avant une nouvelle tentative, un changement de modèle ou une nouvelle tâche.",
  "skillHandoffName": "Transfert de quart de travail",
  "skillHandoff": "Séparez les règles réutilisables de l’élément de travail fourni aujourd’hui.",
  "skillCatalogSummary": "Parcourez le registre complet Skill",
  "skillCatalogIntro": "Ces méthodes sont facultatives. Commencez par la situation ci-dessus ; ouvrez le registre complet lorsque vous savez quel type de travail vous devez soutenir.",
  "skillPlatformObservationName": "Enregistrement d'observation de la plate-forme",
  "skillPlatformObservation": "Enregistrez une surface visible de la plate-forme sans en faire une revendication de capacité.",
  "menuCloseAria": "Fermer la navigation",
  "skillRouteLanguagePartner": "Je veux pratiquer une langue à l’écrit.",
  "skillRouteLanguagePartnerResult": "Lance un échange fictif à l’écrit : vous répondez d’abord, avec une correction à la fois.",
  "skillRouteInterview": "Je veux m’entraîner à répondre à une question d’entretien.",
  "skillRouteInterviewResult": "Accompagne une réponse chronométrée avec un contrôle visible et une question reformulée.",
  "skillLanguagePartnerName": "Partenaire de langue",
  "skillLanguagePartner": "Réalisez un échange écrit et délimité dans la langue cible.",
  "skillInterviewName": "Entraînement à l’entretien",
  "skillInterview": "Entraînez-vous à formuler une réponse observable dans un temps limité.",
  "githubBadge": "GitHub",
  "githubBadgeAria": "Voir le projet sur GitHub",
  "wizardEyebrow": "Pratique d'application après le noyau",
  "wizardTitle": "Choisissez une chose pour laquelle vous avez besoin d'aide ensuite.",
  "wizardIntro": "Après la fondation, choisissez un objectif, ajoutez uniquement les détails importants, puis copiez une invite que vous pouvez inspecter dans n'importe quel modèle de discussion. Aucun compte, fichier ou configuration requis.",
  "wizardStepOne": "1 · Choisissez un objectif",
  "wizardStepTwo": "2 · Ajouter des détails",
  "wizardStepThree": "3 · Copiez votre invite",
  "wizardGoalLanguage": "Pratiquer une langue",
  "wizardGoalWork": "Rédiger une mise à jour du travail",
  "wizardGoalResearch": "Vérifier une affirmation de recherche",
  "wizardGoalTask": "Transformez une tâche en une demande claire",
  "wizardGoalInterview": "Répéter une réponse à un entretien",
  "wizardBack": "Dos",
  "wizardGoalCodex": "Commencez à apprendre Codex",
  "wizardNext": "Créer mon invite",
  "wizardCopy": "Copier l'invite",
  "wizardCopied": "Copié. Collez-le dans n'importe quel modèle de discussion.",
  "wizardReset": "Recommencer",
  "wizardPathLabel": "Allez plus loin",
  "wizardPromptLabel": "Votre invite prête à l'emploi",
  "wizardBoundary": "Une invite copiée est une tentative de pratique et non une preuve d'apprentissage, de maîtrise, de qualité de recherche ou de comportement modèle.",
  "wizardGoalLanguageOutcome": "Vous obtenez une invite d'entraînement à quatre tours qui attend votre réponse.",
  "wizardGoalWorkOutcome": "Vous recevez une invite de mise à jour limitée qui protège les informations que vous fournissez.",
  "wizardGoalResearchOutcome": "Vous recevez une invite de vérification de la source qui sépare les preuves des suppositions.",
  "wizardGoalInterviewOutcome": "Vous recevez une invite de répétition chronométrée avec une auto-vérification visible.",
  "wizardGoalTaskOutcome": "Vous obtenez un contrat de tâche compact avant qu’une IA ou un outil ne commence à agir.",
  "wizardGoalCodexOutcome": "Vous obtenez un premier exercice sécurisé contenant uniquement du texte et un itinéraire vers la piste de codage.",
  "heroRouteContinuationAria": "Poursuivre le parcours des fondations de cinq logements",
  "heroRouteContinuationLabel": "Continuez à l'intérieur de l'itinéraire principal",
  "heroRouteLessonZero": "1 · Noyau de fondation LLM",
  "heroRouteLessonZeroBody": "Environ 90 à 120 minutes. Comprendre, tenter, inspecter, réparer et transférer.",
  "heroRouteChapterOne": "2 · Unité 1 : qu'est-ce qu'un LLM",
  "heroRouteChapterOneBody": "Jetons, contexte, invites, outils, MCP, Agent et Skill dans leurs voies.",
  "heroRouteChapterTwo": "3 · Unité 2 : votre première requête bornée",
  "heroRouteChapterTwoBody": "Rendre visibles l’objectif, le contexte, les contraintes et la forme de la réponse.",
  "heroRouteUnitThree": "4 · Unité 3 : échecs visibles",
  "heroRouteUnitThreeBody": "Marquez les omissions, les ajouts non pris en charge, l’ambiguïté forcée et l’excès de confiance.",
  "heroRouteUnitFourFive": "5 · Unités 4 à 5 : vérification, réparation et transfert",
  "heroRouteUnitFourFiveBody": "Utilisez des preuves, effectuez une correction minimale, indiquez des limites et répétez une tâche invisible.",
  "openExercise": "Exercice ouvert",
  "visualStatusSourceLink": "Ouvrir la source d'état actuelle",
  "visualLearningSourceLink": "Ouvrir la route des fondations",
  "visualModelAlt": "Demande de preuve au conseil d'enseignement",
  "visualCaseAlt": "Tentative, correction, variation et réception d'une boucle d'entraînement pour débutants",
  "visualEvidenceLink": "Aperçu des preuves du projet",
  "visualEvidenceBody": "Les décomptes, les statuts et les lacunes qu'une demande de libération ne doit pas cacher.",
  "visualEvidenceAlt": "Conseil d'enseignement sur l'instantané des données probantes du projet",
  "visualLoopLink": "De la compréhension au transfert",
  "visualLoopBody": "Comprendre, tenter, inspecter, réparer, modifier et répéter une tâche invisible.",
  "visualLoopAlt": "De la compréhension au transfert du tableau pédagogique de la boucle d'apprentissage",
  "foundationLensEyebrow": "La carte de base",
  "foundationLensTitle": "Placez chaque concept LLM dans sa propre voie.",
  "foundationLensIntro": "Avant de choisir un produit ou de copier une invite, séparez la génération, le cadrage, l'action, la coordination et la vérification. La même carte fonctionne sur les modèles de chat et les outils d'agent.",
  "foundationLensPanelTitle": "Cinq niveaux, cinq questions différentes.",
  "foundationLensPanelIntro": "Une réponse fluide appartient à la couche génération. Cela ne prouve pas en soi qu’une source a été ouverte, qu’un fichier a été modifié ou qu’une tâche a été terminée.",
  "foundationLensLink": "Lisez le guide complet des principes fondamentaux du LLM",
  "foundationLensAria": "Les cinq couches d'un flux de travail LLM",
  "foundationLayerGenerate": "Générer",
  "foundationLayerGenerateTerm": "LLM",
  "foundationLayerGenerateBody": "Prédit une suite utile à partir du contexte qu'il reçoit. La maîtrise n'est pas une vérification.",
  "foundationLayerFrame": "Cadre",
  "foundationLayerFrameTerm": "Contexte + invite",
  "foundationLayerFrameBody": "Indique l'objectif, le matériel pertinent, les limites et la forme de la réponse dont vous avez besoin.",
  "foundationLayerExtend": "Étendre",
  "foundationLayerExtendTerm": "Produit + outils + Skill",
  "foundationLayerCoordinate": "Coordonner",
  "foundationLayerExtendBody": "Peut ajouter des fichiers, une navigation, des commandes ou des méthodes réutilisables. L'accès et les effets secondaires sont des faits d'exécution.",
  "foundationLayerCoordinateBody": "Organise plusieurs observations et actions avec des points de contrôle, des tentatives et des conditions d'arrêt.",
  "foundationLayerCoordinateTerm": "Agent + flux de travail",
  "foundationLayerCheck": "Vérifier",
  ...
  "foundationLayerCheckTerm": "Preuve + jugement humain",
  "optionalRoutesSummary": "Voies d'application facultatives · ouvert après la fondation",
  "foundationLensBoundary": "Ne déduisez pas une couche inférieure d'une couche supérieure : une proposition de modèle n'est pas une action d'outil, une action d'outil n'est pas un résultat vérifié et un résultat vérifié n'est pas une maîtrise.",
  "optionalRoutesIntro": "Ces itinéraires sont utiles lorsque vous savez déjà ce que vous souhaitez pratiquer. Ils ne remplacent pas le Foundation Core LLM.",
  "starterStepOne": "01 · LIRE L'ORIGINAL",
  "starterStepTwo": "02 · COPIER CETTE INVITE DANS N'IMPORTE QUEL MODÈLE DE CHAT",
  "starterSource": "L'atelier a changé. Cela commence vendredi à 10 heures. Apportez le brouillon. Dis-moi si tu ne peux pas venir.",
  "starterPrompt": "Veuillez réécrire le message ci-dessous pour qu'il soit clair et convivial.\n\nGardez tous les faits exactement les mêmes. N'ajoutez pas de date, de lieu, de raison, de coordonnées ou toute autre information qui ne figure pas dans l'original.\n\nMessage d'origine :\n\"L'atelier a changé. Il commence vendredi à 10 heures. Apportez le brouillon. Dites-moi si vous ne pouvez pas venir.\"\n\nRenvoie uniquement le message réécrit.",
  "starterCopiedHint": "Si les trois réponses sont oui, le modèle a suivi cette petite instruction. Sinon, dites-lui exactement quel fait il a changé ou inventé, puis réessayez.",
  "starterExampleLabel": "UN RÉSULTAT ACCEPTABLE",
  "starterStepThree": "03 · LIRE LA RÉPONSE ET POSER TROIS QUESTIONS",
  "starterWhyLabel": "POURQUOI C'EST IMPORTANT",
  "starterExampleNote": "La formulation peut différer. Ce qui compte, c'est que les faits et l'action demandée restent les mêmes.",
  "foundationConceptMapTitle": "Six termes, un résultat vérifié.",
  "starterWhy": "Un LLM prédit un texte qui semble utile ; il ne sait pas automatiquement quels détails manquants doivent rester inconnus. Une invite claire et une vérification rapide vous aident à détecter cette différence.",
  "foundationConceptMapIntro": "Ces termes décrivent différentes parties d'une demande. Gardez-les séparés avant de décider de ce que le modèle a réellement établi.",
  "foundationConceptMapVisualLink": "Ouvrir le visuel complet en anglais",
  "foundationConceptMapAria": "Six termes LLM",
  "foundationConceptTokenTitle": "Jeton",
  "foundationConceptContextTitle": "Contexte",
  "foundationConceptTokenBody": "Unité de texte traitée par le modèle. Le nombre de jetons varie selon le tokeniseur ; un jeton n'est pas un fait ou une autorisation.",
  "foundationConceptContextBody": "Le matériel disponible à ce tour, tel que votre invite, le texte fourni ou les données d'outil renvoyées. Le matériel manquant reste inconnu.",
  "foundationConceptWindowBody": "La quantité de matière qu'une figurine peut contenir en un tour. La limite exacte dépend du modèle et du produit.",
  "foundationConceptWindowTitle": "Fenêtre contextuelle",
  "foundationConceptPromptTitle": "Rapide",
  "foundationConceptResponseTitle": "Réponse",
  "foundationConceptResponseBody": "Texte proposé par le modèle à inspecter. La maîtrise peut donner l’impression qu’une erreur est certaine.",
  "foundationConceptPromptBody": "L'objectif, le contexte, les contraintes et la forme de réponse demandée. Un travail d'encadrement rapide ; il n'accorde pas l'accès.",
  "foundationConceptToolTitle": "Outil / Agent",
  "foundationConceptToolBody": "Un produit peut ajouter de la lecture, de l'action ou de la coordination. L'autorisation d'exécution et les preuves décident toujours de ce qui s'est passé.",
  "foundationConceptBoundary": "Réponse ≠ action ≠ résultat vérifié. Comparez le résultat avec une règle source, diff, test, journal ou d'acceptation avant de revendiquer l'achèvement.",
  "foundationVisualsIntro": "Commencez par la feuille de route, puis utilisez les quatre tableaux de contrôle comme référence rapide : contrat rapide, preuves d'action, récupération lorsque les preuves sont manquantes et vérifications à la source avant d'y croire.",
  "foundationVisualsTitle": "Cinq planches de fondation, une boucle.",
  "foundationPromptVisualAlt": "Tableau pédagogique du contrat de prompt à six champs",
  "foundationPromptVisualBody": "Résultat, contexte, aide autorisée, limites, vérification et arrêt.",
  "foundationPromptVisualTitle": "Contrat rapide : six champs",
  "foundationActionVisualAlt": "Tableau d’enseignement des limites d’action observable",
  "foundationActionVisualTitle": "Limite d'action observable",
  "foundationActionVisualBody": "Proposition, autorité, exécution et relecture humaine.",
  "foundationVisualsBoundary": "Tableaux anglais créés par le projet · l'explication environnante et le texte alternatif restent localisés.",
  "foundationRouteVisualAlt": "Le plus petit tableau d'enseignement en boucle sécurisé LLM",
  "foundationRouteVisualBody": "Définir, fournir le contexte, demander, vérifier, puis réparer, transférer ou arrêter.",
  "foundationRouteVisualTitle": "La plus petite boucle sécurisée LLM",
  "foundationRecoveryVisualAlt": "Conseil d'enseignement de l'échelle de récupération des preuves",
  "foundationRecoveryVisualBody": "Adaptez la force de l’affirmation au plus petit contrôle suivant.",
  "foundationRecoveryVisualTitle": "Échelle de récupération des preuves",
  "foundationSourceVisualTitle": "Vérification de la source avant de croire",
  "foundationSourceVisualAlt": "Vérification de la source avant le conseil d'enseignement des croyances",
  "foundationSourceVisualBody": "Faites correspondre la revendication, la source, la portée et la fraîcheur avant de vous y fier."
});

// Compatibility labels used by the existing locale dictionaries. They remain
// explicit so adding French does not make the other interfaces lose the new
// language name.
Object.assign(copy.en, { localeFrench: 'available · Français' });
Object.assign(copy.zh, { localeFrench: '可用 · Français' });
Object.assign(copy.es, { localeFrench: 'disponible · Français' });
Object.assign(copy.ja, { localeFrench: '利用可能 · Français' });
Object.assign(copy.ko, { localeFrench: '사용 가능 · Français' });
Object.assign(copy.de, { localeFrench: 'verfügbar · Français' });
...
Object.assign(copy.fr, {
  ...
  heroRouteAria: 'Le parcours fondamental LLM requis',
  heroRouteContinuationAria: 'Poursuivre le parcours fondamental en cinq unités',
  heroRouteContinuationLabel: 'Continuez à l’intérieur du parcours fondamental',
  heroRouteFixtureTitle: 'Besoin d’un fichier sûr pour le parcours Codex ? Ouvrez le support hors ligne.',
  heroProofSource: '« Bonjour, l’atelier a changé. Il commence vendredi à 10 h. Apportez le brouillon. Dites-moi si vous ne pouvez pas venir. »',
  heroProofCheckOne: 'Vendredi à 10 h et le brouillon sont toujours là.',
  heroProofCheckTwo: 'Les personnes qui ne peuvent pas venir sont invitées à répondre.',
  heroProofReceiptLabel: 'FICHE DE VÉRIFICATION DÉLIMITÉE',
  protocolRuleFour: 'Transmettre',
  protocolRuleFourBody: 'Que faut-il transmettre à la prochaine personne, y compris les points encore inconnus ?',
  evidenceOperate: 'Exécuter',
  evidenceJudge: 'Évaluer',
  evidenceReview: 'Relire',
  routeCTitle: 'Capacités et collaboration avec un Agent',
  foundationLayerFrame: 'Cadrer',
  foundationConceptWindowTitle: 'Fenêtre de contexte',
  foundationVisualsTitle: 'Cinq tableaux de base, une seule boucle.',
  foundationRouteVisualTitle: 'La plus petite boucle LLM sûre',
  foundationPromptVisualTitle: 'Contrat de prompt : six champs',
  foundationActionVisualTitle: 'Frontière d’action observable',
  foundationRecoveryVisualTitle: 'Échelle de récupération des preuves',
  foundationSourceVisualTitle: 'Vérifier la source avant de croire',
  foundationRouteVisualBody: 'Définir, fournir le contexte, demander, vérifier, puis corriger, transférer ou s’arrêter.',
  foundationRecoveryVisualBody: 'Adapter la force de l’affirmation au prochain contrôle le plus petit.',
  foundationSourceVisualBody: 'Comparer affirmation, source, portée et actualité avant de s’y fier.',
  foundationRouteVisualAlt: 'Tableau pédagogique de la plus petite boucle LLM sûre',
  foundationPromptVisualAlt: 'Tableau pédagogique du contrat de prompt à six champs',
  foundationActionVisualAlt: 'Tableau pédagogique de la frontière d’action observable',
  foundationRecoveryVisualAlt: 'Tableau pédagogique de l’échelle de récupération des preuves',
  foundationSourceVisualAlt: 'Tableau pédagogique de la vérification de la source avant de croire',
  foundationConceptWindowBody: 'La quantité de contenu qu’un modèle peut traiter en un tour. La limite exacte dépend du modèle et du produit.',
  foundationConceptPromptTitle: 'Prompt',
  foundationConceptPromptBody: 'L’objectif, le contexte, les contraintes et le format de réponse demandé. Un prompt cadre le travail ; il n’accorde aucun accès.',
  foundationLayerGenerateBody: 'Le modèle prédit une suite plausible à partir du contexte reçu. Une réponse fluide ne constitue pas une vérification.',
  skillProseName: 'Révision de prose open source',
  skillRouteFirstTurnCheckResult: 'Signale les écarts de contenu sans rédiger de prompt de remplacement.',
  statusDraft: 'Encore en cours de rédaction ou sans contrôle minimal.',
  starterCopyRecord: 'Copier mon relevé de vérification local',
  starterReceiptAria: 'Relevé de vérification du premier essai local',
  starterRecordCopied: 'Relevé de vérification copié. Il contient uniquement les statuts, pas votre réponse.',
  ...
  visualModelLink: 'De la demande à la preuve',
  visualEvidenceAlt: 'Tableau pédagogique : instantané des preuves du projet',
  visualEvidenceLink: 'Instantané des preuves du projet',
  visualLoopAlt: 'Tableau pédagogique : de la compréhension au transfert',
  visualLoopLink: 'De la compréhension au transfert',
  visualCaseLink: 'Boucle de pratique pour débuter',
  startTitle: 'Que voulez-vous faire avec le modèle maintenant ?',
  first30Title: 'Évaluez une réponse. Sans installation.',
  localeTitle: 'Parcours en huit langues',
  localeIntro: 'Huit langues d’entrée sont enregistrées. Chaque parcours de cours couvre 22 chapitres et 18 Labs dans la langue choisie ; les pages complémentaires gardent leur propre statut de traduction et signalent clairement l’absence d’une page dans la même langue.',
  localeFrench: 'disponible · Français',
  statusCandidate: 'candidate',
  footerTagline: 'Un guide pratique des LLM fondé sur les preuves, avec une mise en pratique par plateforme après les bases.',

  // High-exposure French copy is kept explicit here rather than inheriting a
  // literal machine translation from the generated dictionary above. This is
  // an editorial improvement pass, not a claim of independent native review.
  wordmarkAria: 'Accueil du Prysai LLM Playbook',
  navIndex: 'Index du projet',
  navUpdates: 'Carte des mises à jour',
  localeBannerFallback: 'La langue {requested} est sélectionnée, mais certaines chaînes de l’interface ou unités du cours sont encore en cours de traduction. Lorsqu’une unité manque, le Reader conserve cette langue et l’indique clairement ; il ne bascule jamais silencieusement vers l’anglais.',
  localeManifestError: 'Le routage des langues est indisponible car le manifeste généré n’a pas été chargé. L’anglais reste disponible ; reconstruisez le manifeste avant de vous fier aux autres parcours.',
  localePartialAnchorNotice: 'Aperçu local ; cette section détaillée n’est pas encore traduite.',
  heroPrimary: 'Commencer par les bases des LLM',
  heroSecondary: 'Voir l’exemple facultatif de cinq minutes',
  heroRouteGuidedTitle: 'Vous avez un projet jetable et souhaitez utiliser Codex ? Suivez le parcours guidé.',
  heroRouteFixtureTitle: 'Besoin d’un fichier sûr pour le parcours Codex ? Ouvrez le support hors ligne.',
  heroRouteLessonZero: '1 · Les fondamentaux des LLM',
  heroRouteChapterOne: '2 · Unité 1 : qu’est-ce qu’un LLM ?',
  heroRouteChapterOneBody: 'Jetons, contexte, prompts, outils, MCP, Agents et Skills : qui fait quoi.',
  heroRouteChapterTwo: '3 · Unité 2 : votre première requête délimitée',
  heroRouteChapterTwoBody: 'Rendez visibles l’objectif, le contexte, les contraintes et le format attendu.',
  heroRouteUnitThree: '4 · Unité 3 : les échecs visibles',
  ...
  first30Intro: 'Le texte, la tâche et les contrôles sont déjà préparés. Utilisez n’importe quel modèle de chat ; aucun fichier, terminal, dépôt Git ni vocabulaire spécial n’est nécessaire.',
  heroRouteContinuationAria: 'Poursuivre le parcours fondamental en cinq unités',
  heroRouteLessonZero: '1 · Les fondamentaux des LLM',
  heroRouteLessonZeroBody: 'Environ 90 à 120 minutes pour comprendre, essayer, inspecter, corriger et transférer.',
  heroRouteChapterOne: '2 · Unité 1 : qu’est-ce qu’un LLM ?',
  heroRouteChapterOneBody: 'Jetons, contexte, prompts, outils, MCP, Agents et Skills : qui fait quoi.',
  heroRouteChapterTwo: '3 · Unité 2 : votre première requête délimitée',
  heroRouteChapterTwoBody: 'Rendez visibles l’objectif, le contexte, les contraintes et le format attendu.',
  heroRouteUnitFourFive: '5 · Unités 4 et 5 : vérifier, corriger et transférer',
  mobileRouteNoSetup: 'Commencer par les bases des LLM',
  pathIntro: 'Choisissez un niveau et voyez exactement quoi lire, faire, utiliser, remettre et ne pas prétendre. Un niveau n’est pas un simple compteur de pages.',
  evaluationFixtures: 'Supports d’évaluation',
  evidenceOperate: 'Mettre en œuvre',
  evidenceJudge: 'Évaluer',
  lab01Title: 'Première tâche sûre',
  lab08Body: 'Transformez un sujet vaste en question précise, plan de sources et tableau minimal de preuves.',
  skillProseName: 'Révision de prose open source',
  skillProse: 'Révisez une prose publique et une traduction sans modifier les faits ni le sens local.',
  skillRouteFirstTurnCheckResult: 'Signale les écarts de contenu sans rédiger un prompt de remplacement.',
  starterCopied: 'Prompt copié. Collez-le dans un modèle de chat, puis vérifiez la réponse avec les trois questions.',
  starterProgressionAria: 'Continuer depuis les fondamentaux des LLM',
  starterCodexPath: 'Continuer les fondamentaux des LLM',
  optionalRoutesSummary: 'Parcours d’application facultatifs · à ouvrir après les fondamentaux',
  foundationConceptPromptTitle: 'Prompt',
  foundationConceptPromptBody: 'Objectif, contexte, contraintes et format de réponse demandés. Un prompt cadre le travail ; il n’accorde aucun accès.',
  foundationVisualsTitle: 'Cinq tableaux de base, une seule boucle.',
  foundationVisualsIntro: 'Commencez par la feuille de route, puis utilisez les quatre autres tableaux comme aide-mémoire : contrat de prompt, preuves d’action, récupération lorsque les preuves manquent et vérification des sources avant de s’y fier.',
  foundationRouteVisualAlt: 'Tableau pédagogique de la plus petite boucle LLM sûre',
  foundationPromptVisualAlt: 'Tableau pédagogique du contrat de prompt à six champs',
  foundationActionVisualAlt: 'Tableau pédagogique de la frontière d’action observable',
  foundationRecoveryVisualAlt: 'Tableau pédagogique de l’échelle de récupération des preuves',
  foundationSourceVisualAlt: 'Tableau pédagogique de la vérification de la source avant de croire',
  foundationRecoveryVisualBody: 'Adaptez la force de l’affirmation au plus petit contrôle suivant.',
  foundationSourceVisualBody: 'Comparez affirmation, source, portée et actualité avant de vous y fier.',
  visualModelAlt: 'Tableau pédagogique : de la demande à la preuve',
  visualEvidenceAlt: 'Tableau pédagogique : instantané des preuves du projet',
  visualLoopAlt: 'Tableau pédagogique : de la compréhension au transfert',
  ...
  mobileIndexUpdates: 'sections de maintenance',
  mobileIndexTrust: 'catégories de fiabilité',
...
// Final naming guard for the public no-setup exercise. The exercise is five
...
Object.assign(copy.en, {
  ...
  starterIntro: 'Read the original once, copy the filled prompt, then check the answer yourself. This five-minute practice is a small demonstration; actual beginner completion time has not been measured.',
  mobileRouteTask: 'Try the five-minute prompt practice',
});
Object.assign(copy.zh, {
  navFirst30: '5 分钟提示词练习',
  heroProofLink: '试试 5 分钟提示词练习',
  first30Eyebrow: '5 分钟 LLM 提示词练习',
  starterIntro: '先读一遍原文，复制已填好的提示词，再亲自检查答案。这是一项五分钟的小练习；目前尚未测量零基础用户的实际完成时间。',
  mobileRouteTask: '用 5 分钟完成一次可检查的提示词练习',
});
Object.assign(copy.es, {
  navFirst30: 'Práctica de prompt de cinco minutos',
  heroProofLink: 'Probar la práctica de prompt de cinco minutos',
  first30Eyebrow: 'Práctica de prompt opcional de cinco minutos',
  starterIntro: 'Lee el original una vez, copia el prompt ya completado y luego comprueba la respuesta tú mismo. Es una práctica breve de cinco minutos; el tiempo real de finalización de principiantes no se ha medido.',
});
Object.assign(copy.ja, {
  navFirst30: '5分間のプロンプト練習',
  heroProofLink: '5分間のプロンプト練習を試す',
  first30Eyebrow: '任意の5分間プロンプト練習',
  starterIntro: '原文を1回読み、記入済みのプロンプトをコピーし、答えを自分で確認してください。5分間の短い練習です。初心者の実際の完了時間はまだ測定されていません。',
});
Object.assign(copy.ko, {
  navFirst30: '5분 프롬프트 연습',
  heroProofLink: '5분 프롬프트 연습 해보기',
  first30Eyebrow: '선택 사항인 5분 프롬프트 연습',
  starterIntro: '원본을 한 번 읽고, 채워진 프롬프트를 복사한 다음, 답변을 직접 점검하세요. 5분짜리 짧은 연습입니다. 실제 초보자 완료 시간은 측정되지 않았습니다.',
});
Object.assign(copy.de, {
  navFirst30: 'Fünf-Minuten-Prompt-Übung',
  heroProofLink: 'Die Fünf-Minuten-Prompt-Übung ausprobieren',
  first30Eyebrow: 'Optionale Fünf-Minuten-Prompt-Übung',
  starterIntro: 'Lies das Original einmal, kopiere den ausgefüllten Prompt und prüfe die Antwort dann selbst. Das ist eine kurze Fünf-Minuten-Übung; die tatsächliche Bearbeitungszeit von Anfängern wurde nicht gemessen.',
});
Object.assign(copy['zh-tw'], {
  navFirst30: '5 分鐘提示詞練習',
  heroProofLink: '試試 5 分鐘提示詞練習',
  first30Eyebrow: '5 分鐘 LLM 提示詞練習',
  starterIntro: '先讀一遍原文，複製填好的提示詞，再親自檢查答案。這是一項五分鐘的小練習；目前尚未測量零基礎讀者的實際完成時間。',
});
Object.assign(copy.fr, {
  navFirst30: 'Pratique de prompt en cinq minutes',
  heroProofLink: 'Essayer la pratique de prompt en cinq minutes',
  first30Eyebrow: 'Une pratique de prompt de cinq minutes',
  starterIntro: 'Lisez le message original, copiez le prompt préparé, puis vérifiez vous-même la réponse. C’est un court exercice de cinq minutes ; le temps réel de réalisation par des débutants n’a pas été mesuré.',
});

const foundationMindMapCopy = {
  en: {
    mindMapTitle: 'Follow the reliable LLM work loop.', mindMapIntro: 'Choose a step to see the next question. The text sequence stays available if the interactive map cannot run.', mindMapAria: 'Six steps in the reliable LLM work loop', mindMapCenter: 'Reliable LLM work', mindMapCenterSub: 'make the claim checkable', mindMapNodeUnderstand: 'Understand', mindMapNodeFrame: 'Frame', mindMapNodeAct: 'Act', mindMapNodeInspect: 'Inspect', mindMapNodeRepair: 'Repair', mindMapNodeTransfer: 'Transfer', mindMapDetailLabel: 'SELECTED STEP', mindMapNextLabel: 'Next question', mindMapUnderstandBody: 'Separate a model proposal from what the available evidence can establish.', mindMapUnderstandNext: 'What result can I check?', mindMapFrameBody: 'State the goal, relevant context, allowed help, limits, check, and stop condition.', mindMapFrameNext: 'What is allowed, and what is not?', mindMapActBody: 'Allow the smallest reversible action and pause before an external effect.', mindMapActNext: 'What is the smallest safe action?', mindMapInspectBody: 'Compare the output or diff with a source, test, log, or acceptance rule.', mindMapInspectNext: 'What evidence would change my claim?', mindMapRepairBody: 'Name one mismatch, keep the failed receipt, and change one condition before retrying.', mindMapRepairNext: 'Which mismatch will I change first?', mindMapTransferBody: 'Repeat the method on an unseen task; one successful attempt is not mastery.', mindMapTransferNext: 'Can I repeat the method on a new task?', mindMapOpenRoute: 'Open this part of the route', mindMapFallbackSummary: 'Read the six steps as a text sequence', mindMapFallbackIntro: 'Use this list without the interactive map. Each step names an action and the evidence boundary that follows it.', mindMapFigureAlt: 'Six-step reliable LLM work loop: understand, frame, act, inspect, repair, and transfer', mindMapFigureCaption: 'Open the full project-authored board for a printable view. The list and explanation above carry the same meaning in text.', mindMapBoundary: 'A map is a route, not proof of learning. Keep the attempt, the check, the failure, and the remaining unknowns.',
  },
  zh: {
    mindMapTitle: '跟随可靠的 LLM 工作闭环。', mindMapIntro: '选择一个步骤，查看下一道问题。即使交互地图无法运行，下面的文字顺序仍然可用。', mindMapAria: '可靠 LLM 工作闭环的六个步骤', mindMapCenter: '可靠的 LLM 工作', mindMapCenterSub: '让结论可以被检查', mindMapNodeUnderstand: '先理解', mindMapNodeFrame: '框定任务', mindMapNodeAct: '采取行动', mindMapNodeInspect: '检查结果', mindMapNodeRepair: '修正问题', mindMapNodeTransfer: '迁移方法', mindMapDetailLabel: '当前步骤', mindMapNextLabel: '下一道问题', mindMapUnderstandBody: '把模型提出的文字，与现有证据能够证明的内容分开。', mindMapUnderstandNext: '我能检查哪个结果？', mindMapFrameBody: '写清目标、相关上下文、允许的帮助、限制、检查方式和停止条件。', mindMapFrameNext: '哪些事情允许做，哪些不允许？', mindMapActBody: '只允许最小且可回退的行动；在产生外部影响前先暂停。', mindMapActNext: '最小的安全行动是什么？', mindMapInspectBody: '把输出或差异与来源、测试、日志或验收规则对照。', mindMapInspectNext: '什么证据会改变我的结论？', mindMapRepairBody: '指出一个不匹配，保留失败记录，只改变一个条件后再试。', mindMapRepairNext: '我先修正哪一个不匹配？', mindMapTransferBody: '在没有见过的新任务上重复这套方法；一次成功不等于掌握。', mindMapTransferNext: '我能在新任务上重复这套方法吗？', mindMapOpenRoute: '打开这部分学习路线', mindMapFallbackSummary: '用文字顺序阅读六个步骤', mindMapFallbackIntro: '不使用交互地图也可以阅读这份列表。每一步都说明要做什么，以及接下来受什么证据边界约束。', mindMapFigureAlt: '可靠 LLM 工作闭环图：理解、框定、行动、检查、修正和迁移六个步骤', mindMapFigureCaption: '打开项目原创图板查看适合打印的版本。上面的列表和说明已经用文字表达了相同内容。', mindMapBoundary: '地图只是路线，不是学习证明。保留尝试、检查、失败记录和仍然未知的部分。',
  },
  es: {
    mindMapTitle: 'Sigue el ciclo de trabajo fiable con LLM.', mindMapIntro: 'Elige un paso para ver la siguiente pregunta. La secuencia de texto sigue disponible si el mapa interactivo no funciona.', mindMapAria: 'Seis pasos del ciclo de trabajo fiable con LLM', mindMapCenter: 'Trabajo fiable con LLM', mindMapCenterSub: 'haz que la afirmación se pueda comprobar', mindMapNodeUnderstand: 'Entender', mindMapNodeFrame: 'Delimitar', mindMapNodeAct: 'Actuar', mindMapNodeInspect: 'Inspeccionar', mindMapNodeRepair: 'Corregir', mindMapNodeTransfer: 'Transferir', mindMapDetailLabel: 'PASO SELECCIONADO', mindMapNextLabel: 'Siguiente pregunta', mindMapUnderstandBody: 'Separa la propuesta del modelo de lo que pueden demostrar las pruebas disponibles.', mindMapUnderstandNext: '¿Qué resultado puedo comprobar?', mindMapFrameBody: 'Define el objetivo, el contexto relevante, la ayuda permitida, los límites, la comprobación y la condición de parada.', mindMapFrameNext: '¿Qué está permitido y qué queda fuera?', mindMapActBody: 'Permite la acción reversible más pequeña y detente antes de cualquier efecto externo.', mindMapActNext: '¿Cuál es la acción segura más pequeña?', mindMapInspectBody: 'Compara la respuesta o el diff con una fuente, una prueba, un registro o un criterio de aceptación.', mindMapInspectNext: '¿Qué evidencia cambiaría mi conclusión?', mindMapRepairBody: 'Nombra un desajuste, conserva el registro del fallo y cambia una sola condición antes de reintentar.', mindMapRepairNext: '¿Qué desajuste corregiré primero?', mindMapTransferBody: 'Repite el método en una tarea nueva; un intento acertado no demuestra dominio.', mindMapTransferNext: '¿Puedo repetir el método en una tarea nueva?', mindMapOpenRoute: 'Abrir esta parte del recorrido', mindMapFallbackSummary: 'Leer los seis pasos como una secuencia de texto', mindMapFallbackIntro: 'Usa esta lista sin el mapa interactivo. Cada paso nombra una acción y el límite de evidencia que le sigue.', mindMapFigureAlt: 'Ciclo de trabajo fiable con LLM en seis pasos: entender, delimitar, actuar, inspeccionar, corregir y transferir', mindMapFigureCaption: 'Abre el tablero original del proyecto para verlo o imprimirlo. La lista y la explicación anterior expresan el mismo contenido en texto.', mindMapBoundary: 'Un mapa es un recorrido, no una prueba de aprendizaje. Conserva el intento, la comprobación, el fallo y lo que aún se desconoce.',
  },
  ja: {
    mindMapTitle: '信頼できるLLM作業ループをたどる。', mindMapIntro: 'ステップを選ぶと、次に確認する問いが表示されます。インタラクティブ表示が使えない場合も、下のテキスト順序は利用できます。', mindMapAria: '信頼できるLLM作業ループの6ステップ', mindMapCenter: '信頼できるLLM作業', mindMapCenterSub: '主張を確認できる形にする', mindMapNodeUnderstand: '理解する', mindMapNodeFrame: '枠を決める', mindMapNodeAct: '実行する', mindMapNodeInspect: '確認する', mindMapNodeRepair: '修正する', mindMapNodeTransfer: '転用する', mindMapDetailLabel: '選択中のステップ', mindMapNextLabel: '次に確認する問い', mindMapUnderstandBody: 'モデルが提案した文章と、手元の証拠で確かめられることを分けます。', mindMapUnderstandNext: 'どの結果なら確認できるか？', mindMapFrameBody: '目的、必要な文脈、許可する支援、制約、確認方法、停止条件を明記します。', mindMapFrameNext: '何が許可され、何が対象外か？', mindMapActBody: '最小限で元に戻せる操作だけを許可し、外部に影響する前に止まります。', mindMapActNext: '最小の安全な操作は何か？', mindMapInspectBody: '出力や差分を、出典、テスト、ログ、受け入れ条件と照合します。', mindMapInspectNext: 'どの証拠が主張を変えるか？', mindMapRepairBody: '不一致を1つ特定し、失敗の記録を残して、条件を1つだけ変えて再試行します。', mindMapRepairNext: '最初にどの不一致を直すか？', mindMapTransferBody: '初めて扱う課題でも方法を繰り返します。1回の成功は習得の証拠ではありません。', mindMapTransferNext: '新しい課題でも方法を繰り返せるか？', mindMapOpenRoute: 'この部分の学習ルートを開く', mindMapFallbackSummary: '6ステップをテキストで読む', mindMapFallbackIntro: 'インタラクティブ表示を使わずに、このリストで確認できます。各ステップには行動と、それに続く証拠の境界があります。', mindMapFigureAlt: '信頼できるLLM作業ループの6ステップ図：理解、枠決め、実行、確認、修正、転用', mindMapFigureCaption: 'プロジェクト作成のボードを開くと、印刷しやすい全体版を見られます。上のリストと説明が同じ内容をテキストで示します。', mindMapBoundary: 'マップは手順であり、学習の証明ではありません。試行、確認、失敗の記録、まだ不明な点を残してください。',
  },
  ko: {
    mindMapTitle: '신뢰할 수 있는 LLM 작업 루프를 따라가세요.', mindMapIntro: '단계를 선택하면 다음 질문이 표시됩니다. 대화형 지도를 사용할 수 없어도 아래 텍스트 순서는 그대로 읽을 수 있습니다.', mindMapAria: '신뢰할 수 있는 LLM 작업 루프의 여섯 단계', mindMapCenter: '신뢰할 수 있는 LLM 작업', mindMapCenterSub: '주장을 확인할 수 있게 만들기', mindMapNodeUnderstand: '이해하기', mindMapNodeFrame: '범위 정하기', mindMapNodeAct: '행동하기', mindMapNodeInspect: '점검하기', mindMapNodeRepair: '수정하기', mindMapNodeTransfer: '전이하기', mindMapDetailLabel: '선택한 단계', mindMapNextLabel: '다음 질문', mindMapUnderstandBody: '모델이 제안한 문장과 현재 증거로 확인할 수 있는 내용을 분리합니다.', mindMapUnderstandNext: '어떤 결과를 확인할 수 있는가?', mindMapFrameBody: '목표, 관련 맥락, 허용된 도움, 제한, 점검 방법과 중지 조건을 적습니다.', mindMapFrameNext: '무엇을 허용하고 무엇을 제외할 것인가?', mindMapActBody: '가장 작고 되돌릴 수 있는 행동만 허용하고 외부 효과가 생기기 전에 멈춥니다.', mindMapActNext: '가장 작은 안전한 행동은 무엇인가?', mindMapInspectBody: '출력이나 diff를 출처, 테스트, 로그 또는 수용 기준과 대조합니다.', mindMapInspectNext: '어떤 증거가 내 판단을 바꿀 수 있는가?', mindMapRepairBody: '불일치 하나를 적고 실패 기록을 보존한 뒤 조건 하나만 바꾸어 다시 시도합니다.', mindMapRepairNext: '어떤 불일치부터 고칠 것인가?', mindMapTransferBody: '처음 보는 작업에서도 방법을 반복합니다. 한 번의 성공은 숙련의 증거가 아닙니다.', mindMapTransferNext: '새 작업에서도 이 방법을 반복할 수 있는가?', mindMapOpenRoute: '이 단계의 학습 경로 열기', mindMapFallbackSummary: '여섯 단계를 텍스트 순서로 읽기', mindMapFallbackIntro: '대화형 지도 없이도 이 목록을 사용할 수 있습니다. 각 단계는 행동과 다음 증거의 경계를 함께 설명합니다.', mindMapFigureAlt: '신뢰할 수 있는 LLM 작업 루프 여섯 단계 그림: 이해, 범위 설정, 행동, 점검, 수정, 전이', mindMapFigureCaption: '프로젝트가 만든 전체 보드를 열어 인쇄용 화면으로 볼 수 있습니다. 위 목록과 설명이 같은 내용을 텍스트로 제공합니다.', mindMapBoundary: '지도는 경로일 뿐 학습의 증거가 아닙니다. 시도, 점검, 실패 기록과 아직 모르는 내용을 남기세요.',
  },
  de: {
    mindMapTitle: 'Folge dem verlässlichen LLM-Arbeitsablauf.', mindMapIntro: 'Wähle einen Schritt, um die nächste Frage zu sehen. Die Textfolge bleibt verfügbar, wenn die interaktive Karte nicht läuft.', mindMapAria: 'Sechs Schritte des verlässlichen LLM-Arbeitsablaufs', mindMapCenter: 'Verlässliche LLM-Arbeit', mindMapCenterSub: 'die Aussage prüfbar machen', mindMapNodeUnderstand: 'Verstehen', mindMapNodeFrame: 'Abgrenzen', mindMapNodeAct: 'Handeln', mindMapNodeInspect: 'Prüfen', mindMapNodeRepair: 'Korrigieren', mindMapNodeTransfer: 'Übertragen', mindMapDetailLabel: 'AUSGEWÄHLTER SCHRITT', mindMapNextLabel: 'Nächste Frage', mindMapUnderstandBody: 'Trenne den Vorschlag des Modells von dem, was die vorhandenen Belege tatsächlich zeigen können.', mindMapUnderstandNext: 'Welches Ergebnis kann ich prüfen?', mindMapFrameBody: 'Benenne Ziel, relevanten Kontext, erlaubte Hilfe, Grenzen, Prüfung und Abbruchbedingung.', mindMapFrameNext: 'Was ist erlaubt, und was bleibt ausgeschlossen?', mindMapActBody: 'Erlaube nur die kleinste reversible Handlung und halte vor einer Außenwirkung an.', mindMapActNext: 'Was ist die kleinste sichere Handlung?', mindMapInspectBody: 'Vergleiche Ausgabe oder Diff mit Quelle, Test, Protokoll oder Abnahmeregel.', mindMapInspectNext: 'Welcher Beleg würde meine Aussage ändern?', mindMapRepairBody: 'Benenne eine Abweichung, bewahre den Fehlerversuch auf und ändere vor dem neuen Versuch genau eine Bedingung.', mindMapRepairNext: 'Welche Abweichung korrigiere ich zuerst?', mindMapTransferBody: 'Wiederhole die Methode an einer unbekannten Aufgabe; ein gelungener Versuch ist noch keine Beherrschung.', mindMapTransferNext: 'Kann ich die Methode an einer neuen Aufgabe wiederholen?', mindMapOpenRoute: 'Diesen Teil des Lernwegs öffnen', mindMapFallbackSummary: 'Die sechs Schritte als Textfolge lesen', mindMapFallbackIntro: 'Verwende diese Liste ohne die interaktive Karte. Jeder Schritt nennt eine Handlung und die anschließende Beleggrenze.', mindMapFigureAlt: 'Sechsstufiger verlässlicher LLM-Arbeitsablauf: verstehen, abgrenzen, handeln, prüfen, korrigieren und übertragen', mindMapFigureCaption: 'Öffne die vollständige, projektbezogene Tafel für eine druckfreundliche Ansicht. Liste und Erklärung oben vermitteln denselben Inhalt als Text.', mindMapBoundary: 'Eine Karte ist ein Weg, kein Lernnachweis. Bewahre Versuch, Prüfung, Fehler und die verbleibenden Unbekannten auf.',
  },
  'zh-tw': {
    mindMapTitle: '沿著可靠的 LLM 工作迴圈前進。', mindMapIntro: '選取一個步驟，查看下一個問題。即使互動地圖無法執行，下方的文字順序仍可使用。', mindMapAria: '可靠 LLM 工作迴圈的六個步驟', mindMapCenter: '可靠的 LLM 工作', mindMapCenterSub: '讓主張可以被檢查', mindMapNodeUnderstand: '先理解', mindMapNodeFrame: '框定任務', mindMapNodeAct: '採取行動', mindMapNodeInspect: '檢查結果', mindMapNodeRepair: '修正問題', mindMapNodeTransfer: '遷移方法', mindMapDetailLabel: '目前步驟', mindMapNextLabel: '下一個問題', mindMapUnderstandBody: '把模型提出的文字，和現有證據能夠證明的內容分開。', mindMapUnderstandNext: '我能檢查哪個結果？', mindMapFrameBody: '寫清楚目標、相關脈絡、允許的協助、限制、檢查方式與停止條件。', mindMapFrameNext: '哪些事情可以做，哪些不在範圍內？', mindMapActBody: '只允許最小且可復原的行動；在產生外部影響前先暫停。', mindMapActNext: '最小的安全行動是什麼？', mindMapInspectBody: '將輸出或差異與來源、測試、紀錄或驗收規則逐一比對。', mindMapInspectNext: '什麼證據會改變我的判斷？', mindMapRepairBody: '指出一個不一致之處，保留失敗紀錄，只改變一個條件後再試一次。', mindMapRepairNext: '我先修正哪一個不一致之處？', mindMapTransferBody: '在沒看過的新任務上重複這套方法；一次成功不等於已經學會。', mindMapTransferNext: '我能在新任務上重複這套方法嗎？', mindMapOpenRoute: '開啟這段學習路線', mindMapFallbackSummary: '用文字順序閱讀六個步驟', mindMapFallbackIntro: '不使用互動地圖也能閱讀這份清單。每一步都說明要做什麼，以及接下來的證據界線。', mindMapFigureAlt: '可靠 LLM 工作迴圈圖：理解、框定、行動、檢查、修正與遷移六個步驟', mindMapFigureCaption: '開啟專案原創圖板，查看適合列印的完整版本。上方的清單與說明已用文字表達相同內容。', mindMapBoundary: '地圖只是路線，不是學習證明。請保留嘗試、檢查、失敗紀錄，以及仍然未知的部分。',
  },
  fr: {
    mindMapTitle: 'Suivez la boucle de travail LLM vérifiable.', mindMapIntro: 'Choisissez une étape pour voir la question suivante. La séquence textuelle reste disponible si la carte interactive ne se charge pas.', mindMapAria: 'Les six étapes de la boucle de travail LLM vérifiable', mindMapCenter: 'Travail LLM vérifiable', mindMapCenterSub: 'rendre l’affirmation contrôlable', mindMapNodeUnderstand: 'Comprendre', mindMapNodeFrame: 'Cadrer', mindMapNodeAct: 'Agir', mindMapNodeInspect: 'Vérifier', mindMapNodeRepair: 'Corriger', mindMapNodeTransfer: 'Transférer', mindMapDetailLabel: 'ÉTAPE SÉLECTIONNÉE', mindMapNextLabel: 'Question suivante', mindMapUnderstandBody: 'Séparez la proposition du modèle de ce que les éléments disponibles permettent réellement d’établir.', mindMapUnderstandNext: 'Quel résultat puis-je vérifier ?', mindMapFrameBody: 'Précisez l’objectif, le contexte utile, l’aide autorisée, les limites, le contrôle et la condition d’arrêt.', mindMapFrameNext: 'Qu’est-ce qui est autorisé et qu’est-ce qui reste exclu ?', mindMapActBody: 'N’autorisez que l’action réversible la plus petite et arrêtez-vous avant tout effet externe.', mindMapActNext: 'Quelle est la plus petite action sûre ?', mindMapInspectBody: 'Comparez la sortie ou le diff avec une source, un test, un journal ou un critère d’acceptation.', mindMapInspectNext: 'Quel élément de preuve changerait mon affirmation ?', mindMapRepairBody: 'Nommez un écart, conservez la trace de l’échec et ne changez qu’une condition avant de réessayer.', mindMapRepairNext: 'Quel écart vais-je corriger en premier ?', mindMapTransferBody: 'Reprenez la méthode sur une tâche inconnue ; une réussite isolée ne prouve pas la maîtrise.', mindMapTransferNext: 'Puis-je reprendre la méthode sur une nouvelle tâche ?', mindMapOpenRoute: 'Ouvrir cette partie du parcours', mindMapFallbackSummary: 'Lire les six étapes sous forme de texte', mindMapFallbackIntro: 'Utilisez cette liste sans la carte interactive. Chaque étape nomme une action et la limite de preuve qui suit.', mindMapFigureAlt: 'Boucle de travail LLM vérifiable en six étapes : comprendre, cadrer, agir, vérifier, corriger et transférer', mindMapFigureCaption: 'Ouvrez le tableau original du projet pour une vue imprimable. La liste et l’explication ci-dessus portent le même sens sous forme de texte.', mindMapBoundary: 'Une carte indique un parcours, pas une preuve d’apprentissage. Conservez l’essai, le contrôle, l’échec et les points encore inconnus.',
  },
};
...
const foundationClaimAuditCopy = {
  en: { foundationVisualsTitle: 'Nine foundation boards, one loop.', foundationVisualsIntro: 'Start with the first-visit route, then use the receipt, route, and check boards as quick references for a bounded LLM task.', foundationFirstVisitVisualAlt: 'First visit route to one checked LLM task teaching board', foundationFirstVisitVisualTitle: 'First visit route', foundationFirstVisitVisualBody: 'Choose one goal, open the Foundation Core, make one safe attempt, check the record, then continue or stop with the unknown visible.', foundationReceiptVisualAlt: 'First attempt to evidence receipt teaching board', foundationReceiptVisualTitle: 'First attempt to evidence receipt', foundationReceiptVisualBody: 'Name one result, keep safe input, save what happened, check one detail, and record the limit.', foundationClaimAuditVisualAlt: 'Claim to evidence audit teaching board', foundationClaimAuditVisualTitle: 'Claim to evidence audit', foundationClaimAuditVisualBody: 'State the claim, scope it, name the source, check the link, and keep the limit.', foundationEvidenceVisualAlt: 'Evidence to decision and stop teaching board', foundationEvidenceVisualTitle: 'Evidence to decision and stop', foundationEvidenceVisualBody: 'Follow a question to an observation, a bounded decision, or a deliberate stop.' },
  zh: { foundationVisualsTitle: '九张基础图，串起一个闭环。', foundationVisualsIntro: '先看第一次访问路线，再把回执图、路线图和检查图当作有边界 LLM 任务的速查表。', foundationFirstVisitVisualAlt: '从第一次访问到完成一次可检查 LLM 任务的教学图', foundationFirstVisitVisualTitle: '第一次访问路线', foundationFirstVisitVisualBody: '先选一个目标，进入基础核心，做一次安全尝试，检查记录，然后继续，或在保留未知项的情况下停止。', foundationReceiptVisualAlt: '从第一次尝试到证据回执的教学图', foundationReceiptVisualTitle: '从第一次尝试到证据回执', foundationReceiptVisualBody: '写清一个结果，保留安全输入，保存实际发生的内容，检查一个细节，并记录限制。', foundationClaimAuditVisualAlt: '声明到证据审计教学图', foundationClaimAuditVisualTitle: '声明到证据审计', foundationClaimAuditVisualBody: '写清声明，限定范围，标出来源，检查证据链，并保留限制。', foundationEvidenceVisualAlt: '从证据到决定与停止的教学图', foundationEvidenceVisualTitle: '从证据到决定与停止', foundationEvidenceVisualBody: '沿着问题走到观察结果、有边界的决定，或明确停止。' },
  es: { foundationVisualsTitle: 'Ocho tablas, un solo bucle.', foundationVisualsIntro: 'Empieza por la ruta para tu primera visita y usa las demás tablas como referencia rápida para una tarea LLM con límites claros.', foundationFirstVisitVisualAlt: 'Tabla didáctica de la primera visita a una tarea LLM comprobable', foundationFirstVisitVisualTitle: 'Ruta para la primera visita', foundationFirstVisitVisualBody: 'Elige un objetivo, abre el núcleo de fundamentos, haz una prueba segura, revisa el registro y decide si continúas o paras dejando visible lo que aún no sabes.', foundationClaimAuditVisualAlt: 'Tabla didáctica de la auditoría de afirmación a evidencia', foundationClaimAuditVisualTitle: 'Auditar la afirmación y la evidencia', foundationClaimAuditVisualBody: 'Formula la afirmación, delimítala, nombra la fuente, comprueba el vínculo y conserva el límite.', foundationEvidenceVisualAlt: 'Tabla didáctica de evidencia, decisión y parada', foundationEvidenceVisualTitle: 'De la evidencia a la decisión y la parada', foundationEvidenceVisualBody: 'Sigue una pregunta hasta una observación, una decisión acotada o una parada deliberada.' },
  ja: { foundationVisualsTitle: '8つの基礎ボード、1つのループ。', foundationVisualsIntro: 'まず初回訪問ルートを見て、その後に各ボードを、範囲を区切ったLLMタスクの早見表として使います。', foundationFirstVisitVisualAlt: '初回訪問から確認可能なLLMタスクまでの学習図', foundationFirstVisitVisualTitle: '初回訪問の学習ルート', foundationFirstVisitVisualBody: '目的を1つ選び、LLM Foundation Coreを開き、安全な試行を1回行い、記録を確認します。そのうえで、未知の点を残したまま続けるか止めます。', foundationClaimAuditVisualAlt: '主張から証拠までの監査を示す教材図', foundationClaimAuditVisualTitle: '主張と証拠を監査する', foundationClaimAuditVisualBody: '主張を書き、範囲を定め、出典の責任者を示し、つながりを確認し、限界を残します。', foundationEvidenceVisualAlt: '証拠から判断と停止までを示す教材図', foundationEvidenceVisualTitle: '証拠から判断、停止まで', foundationEvidenceVisualBody: '問いを観察結果、範囲を限定した判断、または意図した停止へつなげます。' },
  ko: { foundationVisualsTitle: '여덟 기초 보드, 하나의 루프.', foundationVisualsIntro: '먼저 첫 방문 경로를 보고, 나머지 보드를 범위가 정해진 LLM 작업의 빠른 참고표로 사용하세요.', foundationFirstVisitVisualAlt: '첫 방문부터 확인 가능한 LLM 작업까지 보여 주는 교육 보드', foundationFirstVisitVisualTitle: '첫 방문 학습 경로', foundationFirstVisitVisualBody: '목표 하나를 고르고 Foundation Core를 연 뒤 안전하게 한 번 시도합니다. 기록을 확인하고, 모르는 점을 남긴 채 계속할지 멈출지 결정하세요.', foundationClaimAuditVisualAlt: '주장에서 증거까지 감사하는 교육 보드', foundationClaimAuditVisualTitle: '주장과 증거 감사', foundationClaimAuditVisualBody: '주장을 적고 범위를 정하고 출처를 밝힌 뒤 연결을 점검하고 한계를 남기세요.', foundationEvidenceVisualAlt: '증거에서 판단과 중지까지 보여 주는 교육 보드', foundationEvidenceVisualTitle: '증거에서 판단과 중지까지', foundationEvidenceVisualBody: '질문을 관찰 결과, 범위가 정해진 판단 또는 의도적인 중지로 이어 가세요.' },
  de: { foundationVisualsTitle: 'Acht Grundtafeln, ein Ablauf.', foundationVisualsIntro: 'Beginne mit der Route für den ersten Besuch und nutze die übrigen Tafeln als Kurzreferenz für eine klar begrenzte LLM-Aufgabe.', foundationFirstVisitVisualAlt: 'Lehrtafel vom ersten Besuch bis zu einer prüfbaren LLM-Aufgabe', foundationFirstVisitVisualTitle: 'Route für den ersten Besuch', foundationFirstVisitVisualBody: 'Wähle ein Ziel, öffne den Foundation Core, mache einen sicheren Versuch, prüfe das Protokoll und entscheide dann, ob du mit sichtbaren Unklarheiten weitermachst oder stoppst.', foundationClaimAuditVisualAlt: 'Lehrtafel zur Prüfung von Aussage und Beleg', foundationClaimAuditVisualTitle: 'Aussage und Beleg prüfen', foundationClaimAuditVisualBody: 'Formuliere die Aussage, grenze sie ein, nenne die Quelle, prüfe die Verbindung und halte die Grenze fest.', foundationEvidenceVisualAlt: 'Lehrtafel von Beleg zu Entscheidung und Stopp', foundationEvidenceVisualTitle: 'Vom Beleg zur Entscheidung und zum Stopp', foundationEvidenceVisualBody: 'Verfolge eine Frage bis zur Beobachtung, zur begrenzten Entscheidung oder zum bewussten Stopp.' },
  'zh-tw': { foundationVisualsTitle: '八張基礎圖，串起一個閉環。', foundationVisualsIntro: '先看第一次造訪路線，再把路線圖與檢查圖當作有界線 LLM 任務的速查表。', foundationFirstVisitVisualAlt: '從第一次造訪到完成一次可檢查 LLM 任務的教學圖', foundationFirstVisitVisualTitle: '第一次造訪路線', foundationFirstVisitVisualBody: '先選一個目標，進入基礎核心，做一次安全嘗試，檢查紀錄，然後繼續，或在保留未知項目的情況下停止。', foundationClaimAuditVisualAlt: '主張到證據稽核教學圖', foundationClaimAuditVisualTitle: '稽核主張與證據', foundationClaimAuditVisualBody: '寫清楚主張，限定範圍，標出來源，檢查證據鏈，並保留限制。', foundationEvidenceVisualAlt: '從證據到判斷與停止的教學圖', foundationEvidenceVisualTitle: '從證據到判斷與停止', foundationEvidenceVisualBody: '沿著問題走到觀察結果、有界線的判斷，或明確停止。' },
  fr: { foundationVisualsTitle: 'Huit tableaux de base, une seule boucle.', foundationVisualsIntro: 'Commencez par le parcours de première visite, puis utilisez les autres tableaux comme aide-mémoire pour une tâche LLM bien délimitée.', foundationFirstVisitVisualAlt: 'Tableau pédagogique du premier parcours jusqu’à une tâche LLM vérifiable', foundationFirstVisitVisualTitle: 'Parcours de première visite', foundationFirstVisitVisualBody: 'Choisissez un objectif, ouvrez le Foundation Core, faites un essai sûr, vérifiez le relevé, puis continuez ou arrêtez-vous en laissant visibles les inconnues.', foundationClaimAuditVisualAlt: 'Tableau pédagogique de l’audit de l’affirmation par les preuves', foundationClaimAuditVisualTitle: 'Auditer l’affirmation et les preuves', foundationClaimAuditVisualBody: 'Écrivez l’affirmation, délimitez-la, nommez la source, vérifiez le lien et gardez la limite.', foundationEvidenceVisualAlt: 'Tableau pédagogique des preuves vers la décision et l’arrêt', foundationEvidenceVisualTitle: 'Des preuves à la décision et à l’arrêt', foundationEvidenceVisualBody: 'Suivez une question jusqu’à une observation, une décision délimitée ou un arrêt volontaire.' },
};
Object.entries(foundationClaimAuditCopy).forEach(([language, strings]) => Object.assign(copy[language], strings));

// Keep the first-attempt receipt board visible in every supported locale. The
// SVG stays project-authored English; this surrounding copy and its alt text
// are the reader-facing explanation and therefore remain localized.
const foundationReceiptCopy = {
  en: { foundationVisualsTitle: 'Nine foundation boards, one loop.', foundationVisualsIntro: 'Start with the first-visit route, then use the receipt, route, and check boards as quick references for a bounded LLM task.', foundationReceiptVisualAlt: 'First attempt to evidence receipt teaching board', foundationReceiptVisualTitle: 'First attempt to evidence receipt', foundationReceiptVisualBody: 'Name one result, keep safe input, save what happened, check one detail, and record the limit.' },
  zh: { foundationVisualsTitle: '九张基础图，串起一个闭环。', foundationVisualsIntro: '先看第一次访问路线，再把回执图、路线图和检查图当作有边界 LLM 任务的速查表。', foundationReceiptVisualAlt: '从第一次尝试到证据回执的教学图', foundationReceiptVisualTitle: '从第一次尝试到证据回执', foundationReceiptVisualBody: '写清一个结果，保留安全输入，保存实际发生的内容，检查一个细节，并记录限制。' },
  es: { foundationVisualsTitle: 'Nueve tablas, un solo bucle.', foundationVisualsIntro: 'Empieza por la ruta de la primera visita y usa el registro, la ruta y las tablas de comprobación como referencia rápida para una tarea LLM acotada.', foundationReceiptVisualAlt: 'Tabla didáctica del primer intento al registro de evidencia', foundationReceiptVisualTitle: 'Del primer intento al registro de evidencia', foundationReceiptVisualBody: 'Nombra un resultado, conserva datos seguros, guarda lo ocurrido, comprueba un detalle y anota el límite.' },
  ja: { foundationVisualsTitle: '9つの基礎ボード、1つのループ。', foundationVisualsIntro: 'まず初回訪問ルートを見て、記録・ルート・確認ボードを範囲を区切ったLLMタスクの早見表として使います。', foundationReceiptVisualAlt: '最初の試行から確認できる記録までを示す教材図', foundationReceiptVisualTitle: '最初の試行から確認できる記録へ', foundationReceiptVisualBody: '結果を1つ決め、安全な入力を使い、実際に起きたことを保存し、1点を確認して限界を記録します。' },
  ko: { foundationVisualsTitle: '아홉 기초 보드, 하나의 루프.', foundationVisualsIntro: '먼저 첫 방문 경로를 보고, 기록·경로·점검 보드를 범위가 정해진 LLM 작업의 빠른 참고표로 사용하세요.', foundationReceiptVisualAlt: '첫 시도에서 확인 가능한 기록으로 이어지는 교육 보드', foundationReceiptVisualTitle: '첫 시도에서 확인 가능한 기록까지', foundationReceiptVisualBody: '결과 하나를 정하고 안전한 입력을 남기며 실제로 일어난 일을 저장하고 한 항목을 점검한 뒤 한계를 기록하세요.' },
  de: { foundationVisualsTitle: 'Neun Grundtafeln, ein Ablauf.', foundationVisualsIntro: 'Beginne mit der Route für den ersten Besuch und nutze Beleg-, Routen- und Prüftafeln als Kurzreferenz für eine klar begrenzte LLM-Aufgabe.', foundationReceiptVisualAlt: 'Lehrtafel vom ersten Versuch zum prüfbaren Beleg', foundationReceiptVisualTitle: 'Vom ersten Versuch zum prüfbaren Beleg', foundationReceiptVisualBody: 'Benenne ein Ergebnis, sichere die Eingaben, bewahre den tatsächlichen Ablauf, prüfe ein Detail und notiere die Grenze.' },
  'zh-tw': { foundationVisualsTitle: '九張基礎圖，串起一個閉環。', foundationVisualsIntro: '先看第一次造訪路線，再把紀錄圖、路線圖與檢查圖當作有界線 LLM 任務的速查表。', foundationReceiptVisualAlt: '從第一次嘗試到可檢查紀錄的教學圖', foundationReceiptVisualTitle: '從第一次嘗試到可檢查紀錄', foundationReceiptVisualBody: '寫清楚一個結果，保留安全輸入，保存實際發生的內容，檢查一個細節，並記下界線。' },
  fr: { foundationVisualsTitle: 'Neuf tableaux de base, une seule boucle.', foundationVisualsIntro: 'Commencez par le parcours de première visite, puis utilisez les relevés, les parcours et les tableaux de contrôle comme aide-mémoire pour une tâche LLM bien délimitée.', foundationReceiptVisualAlt: 'Tableau pédagogique du premier essai au relevé vérifiable', foundationReceiptVisualTitle: 'Du premier essai au relevé vérifiable', foundationReceiptVisualBody: 'Nommez un résultat, gardez des entrées sûres, conservez ce qui s’est passé, vérifiez un point et notez la limite.' },
};
Object.entries(foundationReceiptCopy).forEach(([language, strings]) => Object.assign(copy[language], strings));

// The first-task bridge belongs on the foundation route, not only in the
// Reader and visual gallery. Keep its surrounding explanation localized even
// though the project-authored SVG remains English.
const foundationBridgeCopy = {
  en: { foundationVisualsTitle: 'Ten foundation boards, one loop.', foundationVisualsIntro: 'Start with the first-visit route, then use the first-task bridge, receipt, route, and check boards as quick references for a bounded LLM task.', foundationBridgeVisualAlt: 'First task to evidence bridge teaching board', foundationBridgeVisualTitle: 'Make the first task checkable', foundationBridgeVisualBody: 'Choose one observable result, keep the input and stop boundary visible, save what happened, make one focused check, and hand off the result with its limits.' },
  zh: { foundationVisualsTitle: '十张基础图，串起一个闭环。', foundationVisualsIntro: '先看第一次访问路线，再把首任务证据桥、回执图、路线图和检查图当作有边界 LLM 任务的速查表。', foundationBridgeVisualAlt: '让首任务通向证据的教学图', foundationBridgeVisualTitle: '让第一次任务可以检查', foundationBridgeVisualBody: '选择一个可观察结果，保留输入和停止边界，保存实际发生的内容，做一次聚焦检查，再交接结果和限制。' },
  es: { foundationVisualsTitle: 'Diez tableros de base, un solo bucle.', foundationVisualsIntro: 'Empieza por la ruta de la primera visita y usa el puente de la primera tarea, el registro, la ruta y las tablas de comprobación como referencia rápida para una tarea LLM acotada.', foundationBridgeVisualAlt: 'Tabla didáctica del puente de la primera tarea a la evidencia', foundationBridgeVisualTitle: 'Haz comprobable la primera tarea', foundationBridgeVisualBody: 'Elige un resultado observable, deja visibles la entrada y el límite de parada, guarda lo ocurrido, haz una comprobación concreta y entrega el resultado con sus límites.' },
  ja: { foundationVisualsTitle: '10個の基礎ボード、1つのループ。', foundationVisualsIntro: 'まず初回訪問ルートを見て、最初のタスクを証拠につなぐ橋、記録、ルート、確認ボードを、範囲を区切ったLLMタスクの早見表として使います。', foundationBridgeVisualAlt: '最初のタスクから証拠へつなぐ教材図', foundationBridgeVisualTitle: '最初のタスクを確認できる形にする', foundationBridgeVisualBody: '観察できる結果を1つ選び、入力と停止の境界を見えるようにし、実際に起きたことを保存します。重要な点を1つ確認し、限界と一緒に結果を引き継ぎます。' },
  ko: { foundationVisualsTitle: '열 개의 기초 보드, 하나의 루프.', foundationVisualsIntro: '먼저 첫 방문 경로를 보고, 첫 작업에서 증거로 이어지는 다리와 기록·경로·점검 보드를 범위가 정해진 LLM 작업의 빠른 참고표로 사용하세요.', foundationBridgeVisualAlt: '첫 작업에서 증거로 이어지는 다리를 보여 주는 교육 보드', foundationBridgeVisualTitle: '첫 작업을 확인 가능한 형태로 만들기', foundationBridgeVisualBody: '관찰 가능한 결과 하나를 정하고 입력과 중지 경계를 분명히 남깁니다. 실제로 일어난 일을 저장하고 중요한 항목 하나를 점검한 뒤 결과와 한계를 인계하세요.' },
  de: { foundationVisualsTitle: 'Zehn Grundtafeln, ein Ablauf.', foundationVisualsIntro: 'Beginne mit der Route für den ersten Besuch und nutze die Brücke von der ersten Aufgabe zum Beleg sowie Beleg-, Routen- und Prüftafeln als Kurzreferenz für eine klar begrenzte LLM-Aufgabe.', foundationBridgeVisualAlt: 'Lehrtafel von der ersten Aufgabe zur Belegbrücke', foundationBridgeVisualTitle: 'Die erste Aufgabe prüfbar machen', foundationBridgeVisualBody: 'Wähle ein beobachtbares Ergebnis, halte Eingabe und Stoppgrenze sichtbar, sichere den tatsächlichen Ablauf, prüfe ein wichtiges Detail und übergib Ergebnis und Grenzen.' },
  'zh-tw': { foundationVisualsTitle: '十張基礎圖，串起一個閉環。', foundationVisualsIntro: '先看第一次造訪路線，再把首項任務通往證據的橋、紀錄圖、路線圖與檢查圖當作有界線 LLM 任務的速查表。', foundationBridgeVisualAlt: '讓首項任務通往證據的教學圖', foundationBridgeVisualTitle: '讓第一次任務變得可檢查', foundationBridgeVisualBody: '選擇一個可觀察的結果，保留輸入與停止界線，保存實際發生的內容，做一次聚焦檢查，再連同限制交接結果。' },
  fr: { foundationVisualsTitle: 'Dix tableaux de base, une seule boucle.', foundationVisualsIntro: 'Commencez par le parcours de première visite, puis utilisez le pont de la première tâche vers les preuves, les relevés, les parcours et les tableaux de contrôle comme aide-mémoire pour une tâche LLM bien délimitée.', foundationBridgeVisualAlt: 'Tableau pédagogique du pont entre première tâche et preuves', foundationBridgeVisualTitle: 'Rendre la première tâche vérifiable', foundationBridgeVisualBody: 'Choisissez un résultat observable, gardez visibles l’entrée et la limite d’arrêt, conservez ce qui s’est réellement passé, vérifiez un point précis, puis transmettez le résultat avec ses limites.' },
};
Object.entries(foundationBridgeCopy).forEach(([language, strings]) => Object.assign(copy[language], strings));

const foundationEvidenceMapCopy = {
  en: {
    evidenceMapTitle: 'Let the evidence set the decision.', evidenceMapIntro: 'Follow one question from source to observation. The map ends at a deliberate stop when the next proof is missing.', evidenceMapAria: 'Evidence to decision map', evidenceMapNodeQuestion: 'Question', evidenceMapNodeSource: 'Source', evidenceMapNodeObserve: 'Observe', evidenceMapNodeDecide: 'Decide', evidenceMapNodeStop: 'Stop', evidenceMapDetailLabel: 'SELECTED STEP', evidenceMapNextLabel: 'Next check', evidenceMapQuestionBody: 'Name the decision before you search. A broad topic is not yet a checkable question.', evidenceMapQuestionNext: 'What decision would this evidence change?', evidenceMapSourceBody: 'Name the owner, location, date, version, and the source boundary.', evidenceMapSourceNext: 'Can I open and locate the relevant passage?', evidenceMapObserveBody: 'Read the page, diff, test, log, or response. Do not infer an event you did not observe.', evidenceMapObserveNext: 'What did I actually see?', evidenceMapDecideBody: 'Keep the claim supported when the check matches; otherwise mark it candidate or unknown.', evidenceMapDecideNext: 'Does the record support the exact sentence?', evidenceMapStopBody: 'When the next proof is missing, stop and record the smallest safe next check.', evidenceMapStopNext: 'What is the smallest safe next step?', evidenceMapOpenRoute: 'Open this part of the route', evidenceMapFallbackSummary: 'Read the evidence path as text', evidenceMapFallbackIntro: 'Use this sequence without the interactive map. Each step keeps the claim within the record.', evidenceMapFigureAlt: 'Evidence to decision and stop teaching board', evidenceMapFigureCaption: 'Open the project-authored board for a printable view. The interactive map and text sequence carry the same meaning.', evidenceMapBoundary: 'A decision map is a reasoning aid, not proof that a source is correct, a tool ran, or a learner mastered the method.'
  },
  zh: {
    evidenceMapTitle: '让证据决定结论。', evidenceMapIntro: '沿着一个问题，从来源走到可观察结果；下一项证明缺失时，就在地图上明确停下。', evidenceMapAria: '从证据到结论的地图', evidenceMapNodeQuestion: '问题', evidenceMapNodeSource: '来源', evidenceMapNodeObserve: '观察', evidenceMapNodeDecide: '决定', evidenceMapNodeStop: '停止', evidenceMapDetailLabel: '当前步骤', evidenceMapNextLabel: '下一项检查', evidenceMapQuestionBody: '先写清要做的决定，再开始搜索。宽泛主题还不是可检查的问题。', evidenceMapQuestionNext: '这项证据会改变哪个决定？', evidenceMapSourceBody: '写出来源负责人、位置、日期、版本和来源边界。', evidenceMapSourceNext: '我能打开来源并定位相关段落吗？', evidenceMapObserveBody: '阅读页面、差异、测试、日志或回复；不要把未观察到的事件当成事实。', evidenceMapObserveNext: '我实际看到了什么？', evidenceMapDecideBody: '检查吻合时保留为有支持的结论；否则标为 candidate 或 unknown。', evidenceMapDecideNext: '记录是否支持这句完整的话？', evidenceMapStopBody: '下一项证明缺失时，停下来记录最小的安全下一步。', evidenceMapStopNext: '最小的安全下一步是什么？', evidenceMapOpenRoute: '打开这部分学习路线', evidenceMapFallbackSummary: '用文字阅读证据路径', evidenceMapFallbackIntro: '不使用交互地图也可以阅读这条顺序；每一步都把结论限制在记录之内。', evidenceMapFigureAlt: '从证据到结论与停止的教学图', evidenceMapFigureCaption: '打开项目原创图板查看适合打印的版本。交互地图和文字顺序表达的是同一内容。', evidenceMapBoundary: '决策地图只是推理辅助，不证明来源正确、工具已运行或学习者已经掌握方法。'
  },
  es: {
    evidenceMapTitle: 'Deja que la evidencia determine la decisión.', evidenceMapIntro: 'Sigue una pregunta desde la fuente hasta una observación. El mapa termina en una parada deliberada cuando falta la siguiente prueba.', evidenceMapAria: 'Mapa de evidencia a decisión', evidenceMapNodeQuestion: 'Pregunta', evidenceMapNodeSource: 'Fuente', evidenceMapNodeObserve: 'Observar', evidenceMapNodeDecide: 'Decidir', evidenceMapNodeStop: 'Parar', evidenceMapDetailLabel: 'PASO SELECCIONADO', evidenceMapNextLabel: 'Siguiente comprobación', evidenceMapQuestionBody: 'Nombra la decisión antes de buscar. Un tema amplio todavía no es una pregunta comprobable.', evidenceMapQuestionNext: '¿Qué decisión cambiaría con esta evidencia?', evidenceMapSourceBody: 'Anota responsable, ubicación, fecha, versión y límite de la fuente.', evidenceMapSourceNext: '¿Puedo abrirla y localizar el pasaje relevante?', evidenceMapObserveBody: 'Lee la página, el diff, la prueba, el registro o la respuesta. No supongas un hecho que no observaste.', evidenceMapObserveNext: '¿Qué vi realmente?', evidenceMapDecideBody: 'Mantén la afirmación como respaldada si la comprobación coincide; si no, márcala como candidate o unknown.', evidenceMapDecideNext: '¿El registro respalda la frase exacta?', evidenceMapStopBody: 'Si falta la siguiente prueba, detente y registra el siguiente paso seguro más pequeño.', evidenceMapStopNext: '¿Cuál es el siguiente paso seguro más pequeño?', evidenceMapOpenRoute: 'Abrir esta parte del recorrido', evidenceMapFallbackSummary: 'Leer el recorrido de la evidencia como texto', evidenceMapFallbackIntro: 'Usa esta secuencia sin el mapa interactivo. Cada paso mantiene la afirmación dentro del registro.', evidenceMapFigureAlt: 'Tablero didáctico de evidencia, decisión y parada', evidenceMapFigureCaption: 'Abre el tablero original del proyecto para verlo o imprimirlo. El mapa y la secuencia textual expresan lo mismo.', evidenceMapBoundary: 'El mapa ayuda a razonar; no demuestra que una fuente sea correcta, que una herramienta se haya ejecutado ni que se haya aprendido el método.'
  },
  ja: {
    evidenceMapTitle: '判断は証拠に合わせる。', evidenceMapIntro: '1つの問いを出典から観察結果まで追います。次の証拠がなければ、そこで意図的に止まります。', evidenceMapAria: '証拠から判断までのマップ', evidenceMapNodeQuestion: '問い', evidenceMapNodeSource: '出典', evidenceMapNodeObserve: '観察', evidenceMapNodeDecide: '判断', evidenceMapNodeStop: '停止', evidenceMapDetailLabel: '選択中のステップ', evidenceMapNextLabel: '次に確認すること', evidenceMapQuestionBody: '検索する前に、どの判断をするのかを書きます。広いテーマだけでは確認できる問いになりません。', evidenceMapQuestionNext: 'この証拠で、どの判断が変わるか？', evidenceMapSourceBody: '出典の責任者、場所、日付、版、そして出典の限界を記録します。', evidenceMapSourceNext: '開いて関連箇所を特定できるか？', evidenceMapObserveBody: 'ページ、差分、テスト、ログ、応答を読みます。観察していない出来事を推測で埋めません。', evidenceMapObserveNext: '実際に何を確認したか？', evidenceMapDecideBody: '確認が一致すれば、根拠のある主張として残します。一致しなければ candidate または unknown とします。', evidenceMapDecideNext: '記録はその一文を支えているか？', evidenceMapStopBody: '次の証拠がなければ、停止して最小限の安全な次の確認を記録します。', evidenceMapStopNext: '最小限で安全な次の一歩は何か？', evidenceMapOpenRoute: 'この部分の学習ルートを開く', evidenceMapFallbackSummary: '証拠の道筋をテキストで読む', evidenceMapFallbackIntro: 'インタラクティブ表示なしでも使えます。各ステップで、主張を記録の範囲に保ちます。', evidenceMapFigureAlt: '証拠から判断、停止までを示す教材図', evidenceMapFigureCaption: 'プロジェクト作成のボードを開くと印刷しやすい全体版を見られます。マップとテキスト順序は同じ内容です。', evidenceMapBoundary: '判断マップは推論を助けるものであり、出典の正しさ、ツールの実行、学習者の習得を証明するものではありません。'
  },
  ko: {
    evidenceMapTitle: '증거가 판단의 범위를 정하게 하세요.', evidenceMapIntro: '하나의 질문을 출처에서 관찰 결과까지 따라갑니다. 다음 증거가 없으면 의도적으로 멈춥니다.', evidenceMapAria: '증거에서 판단으로 이어지는 지도', evidenceMapNodeQuestion: '질문', evidenceMapNodeSource: '출처', evidenceMapNodeObserve: '관찰', evidenceMapNodeDecide: '판단', evidenceMapNodeStop: '중지', evidenceMapDetailLabel: '선택한 단계', evidenceMapNextLabel: '다음 점검', evidenceMapQuestionBody: '검색하기 전에 어떤 판단을 내릴지 적으세요. 넓은 주제만으로는 확인할 수 있는 질문이 되지 않습니다.', evidenceMapQuestionNext: '이 증거가 바꿀 판단은 무엇인가?', evidenceMapSourceBody: '출처의 책임자, 위치, 날짜, 버전과 출처의 한계를 기록하세요.', evidenceMapSourceNext: '열어서 관련 부분을 찾을 수 있는가?', evidenceMapObserveBody: '페이지, diff, 테스트, 로그 또는 응답을 읽으세요. 직접 관찰하지 않은 사건을 추정하지 마세요.', evidenceMapObserveNext: '실제로 무엇을 확인했는가?', evidenceMapDecideBody: '점검이 일치하면 근거가 있는 주장으로 남기고, 그렇지 않으면 candidate 또는 unknown으로 표시하세요.', evidenceMapDecideNext: '기록이 정확한 문장을 뒷받침하는가?', evidenceMapStopBody: '다음 증거가 없으면 멈추고 가장 작고 안전한 다음 점검을 기록하세요.', evidenceMapStopNext: '가장 작고 안전한 다음 단계는 무엇인가?', evidenceMapOpenRoute: '이 경로의 해당 부분 열기', evidenceMapFallbackSummary: '증거 경로를 텍스트로 읽기', evidenceMapFallbackIntro: '대화형 지도 없이도 이 순서를 사용할 수 있습니다. 각 단계에서 주장을 기록의 범위 안에 둡니다.', evidenceMapFigureAlt: '증거에서 판단과 중지까지 보여 주는 교육 보드', evidenceMapFigureCaption: '프로젝트가 만든 인쇄용 보드를 여세요. 대화형 지도와 텍스트 순서는 같은 내용을 담습니다.', evidenceMapBoundary: '판단 지도는 추론을 돕는 도구일 뿐, 출처의 정확성·도구 실행·학습자의 숙달을 증명하지 않습니다.'
  },
  de: {
    evidenceMapTitle: 'Der Beleg bestimmt die Entscheidung.', evidenceMapIntro: 'Verfolge eine Frage von der Quelle bis zur beobachteten Tatsache. Fehlt der nächste Beleg, endet die Karte mit einem bewussten Stopp.', evidenceMapAria: 'Karte von Beleg zu Entscheidung', evidenceMapNodeQuestion: 'Frage', evidenceMapNodeSource: 'Quelle', evidenceMapNodeObserve: 'Beobachten', evidenceMapNodeDecide: 'Entscheiden', evidenceMapNodeStop: 'Stoppen', evidenceMapDetailLabel: 'AUSGEWÄHLTER SCHRITT', evidenceMapNextLabel: 'Nächste Prüfung', evidenceMapQuestionBody: 'Benenne die Entscheidung, bevor du suchst. Ein breites Thema ist noch keine prüfbare Frage.', evidenceMapQuestionNext: 'Welche Entscheidung würde dieser Beleg ändern?', evidenceMapSourceBody: 'Halte Verantwortliche, Fundstelle, Datum, Version und Quellenbegrenzung fest.', evidenceMapSourceNext: 'Kann ich die relevante Stelle öffnen und finden?', evidenceMapObserveBody: 'Lies Seite, Diff, Test, Protokoll oder Antwort. Erfinde kein Ereignis, das du nicht beobachtet hast.', evidenceMapObserveNext: 'Was habe ich tatsächlich gesehen?', evidenceMapDecideBody: 'Bleibt die Aussage belegt, wenn die Prüfung passt; sonst wird sie als candidate oder unknown markiert.', evidenceMapDecideNext: 'Stützt der Nachweis genau diesen Satz?', evidenceMapStopBody: 'Fehlt der nächste Beleg, halte an und notiere die kleinste sichere nächste Prüfung.', evidenceMapStopNext: 'Was ist der kleinste sichere nächste Schritt?', evidenceMapOpenRoute: 'Diesen Teil des Lernwegs öffnen', evidenceMapFallbackSummary: 'Den Belegweg als Text lesen', evidenceMapFallbackIntro: 'Nutze diese Folge ohne die interaktive Karte. Jeder Schritt hält die Aussage innerhalb des Protokolls.', evidenceMapFigureAlt: 'Lehrtafel von Beleg zu Entscheidung und Stopp', evidenceMapFigureCaption: 'Öffne die projektbezogene Tafel für eine druckfreundliche Ansicht. Karte und Textfolge bedeuten dasselbe.', evidenceMapBoundary: 'Die Entscheidungskarte unterstützt das Denken; sie beweist weder eine richtige Quelle noch einen Tool-Lauf oder den Lernerfolg.'
  },
  'zh-tw': {
    evidenceMapTitle: '讓證據決定判斷。', evidenceMapIntro: '沿著一個問題，從來源走到可觀察結果；下一項證明缺失時，就在地圖上明確停下。', evidenceMapAria: '從證據到判斷的地圖', evidenceMapNodeQuestion: '問題', evidenceMapNodeSource: '來源', evidenceMapNodeObserve: '觀察', evidenceMapNodeDecide: '判斷', evidenceMapNodeStop: '停止', evidenceMapDetailLabel: '目前步驟', evidenceMapNextLabel: '下一項檢查', evidenceMapQuestionBody: '先寫清楚要做的判斷，再開始搜尋。寬泛主題還不是可以檢查的問題。', evidenceMapQuestionNext: '這項證據會改變哪個判斷？', evidenceMapSourceBody: '記下來源負責人、位置、日期、版本與來源界線。', evidenceMapSourceNext: '我能開啟來源並找到相關段落嗎？', evidenceMapObserveBody: '閱讀頁面、差異、測試、紀錄或回覆；不要把沒有觀察到的事件當成事實。', evidenceMapObserveNext: '我實際看到了什麼？', evidenceMapDecideBody: '檢查吻合時保留為有證據支持的主張；否則標為 candidate 或 unknown。', evidenceMapDecideNext: '紀錄是否支持這句完整的話？', evidenceMapStopBody: '下一項證明缺失時，停下來記錄最小且安全的下一項檢查。', evidenceMapStopNext: '最小且安全的下一步是什麼？', evidenceMapOpenRoute: '開啟這段學習路線', evidenceMapFallbackSummary: '用文字閱讀證據路徑', evidenceMapFallbackIntro: '不使用互動地圖也能閱讀這段順序；每一步都把主張留在紀錄範圍內。', evidenceMapFigureAlt: '從證據到判斷與停止的教學圖', evidenceMapFigureCaption: '開啟專案原創圖板，查看適合列印的完整版本。互動地圖與文字順序表達相同內容。', evidenceMapBoundary: '判斷地圖只是推理輔助，不代表來源正確、工具已執行或學習者已經掌握方法。'
  },
  fr: {
    evidenceMapTitle: 'La preuve fixe la décision.', evidenceMapIntro: 'Suivez une question, de la source à l’observation. S’il manque la preuve suivante, le parcours s’arrête volontairement.', evidenceMapAria: 'Carte des preuves vers la décision', evidenceMapNodeQuestion: 'Question', evidenceMapNodeSource: 'Source', evidenceMapNodeObserve: 'Observer', evidenceMapNodeDecide: 'Décider', evidenceMapNodeStop: 'Arrêter', evidenceMapDetailLabel: 'ÉTAPE SÉLECTIONNÉE', evidenceMapNextLabel: 'Contrôle suivant', evidenceMapQuestionBody: 'Formulez la décision avant de chercher. Un thème large n’est pas encore une question vérifiable.', evidenceMapQuestionNext: 'Quelle décision cette preuve pourrait-elle changer ?', evidenceMapSourceBody: 'Indiquez le responsable, l’emplacement, la date, la version et la limite de la source.', evidenceMapSourceNext: 'Puis-je l’ouvrir et trouver le passage pertinent ?', evidenceMapObserveBody: 'Lisez la page, le diff, le test, le journal ou la réponse. N’inférez pas un événement que vous n’avez pas observé.', evidenceMapObserveNext: 'Qu’ai-je réellement observé ?', evidenceMapDecideBody: 'Gardez l’affirmation comme étayée si le contrôle concorde ; sinon classez-la candidate ou unknown.', evidenceMapDecideNext: 'Le relevé soutient-il exactement cette phrase ?', evidenceMapStopBody: 'Si la preuve suivante manque, arrêtez-vous et notez le plus petit contrôle sûr à effectuer ensuite.', evidenceMapStopNext: 'Quelle est la prochaine étape sûre la plus petite ?', evidenceMapOpenRoute: 'Ouvrir cette partie du parcours', evidenceMapFallbackSummary: 'Lire le parcours des preuves en texte', evidenceMapFallbackIntro: 'Utilisez cette séquence sans la carte interactive. Chaque étape maintient l’affirmation dans les limites du relevé.', evidenceMapFigureAlt: 'Tableau pédagogique des preuves vers la décision et l’arrêt', evidenceMapFigureCaption: 'Ouvrez le tableau original du projet pour une vue imprimable. La carte et la séquence textuelle portent le même sens.', evidenceMapBoundary: 'La carte aide au raisonnement ; elle ne prouve ni la justesse d’une source, ni l’exécution d’un outil, ni la maîtrise de la méthode.'
  },
};
