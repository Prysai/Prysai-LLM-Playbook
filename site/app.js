...
Object.assign(copy.en, {
  ...
  heroScope: 'Current guided scope: transferable core + Codex Practice Track. Claude Code and Grok are not runnable routes yet.',
...
Object.assign(copy.zh, {
  ...
  heroScope: '当前可直接跟练的范围：通用协作核心 + Codex 实践路线。Claude Code 和 Grok 暂无可运行路线。',
...
copy.es = {
  ...
  'heroScope': 'Alcance guiado actual: núcleo transferible + Codex Practice Track. Claude Code y Grok aún no son rutas ejecutables.',
...
copy.ja = {
  ...
  'heroScope': '現在のガイド対象範囲:転移可能なコア + Codex プラクティストラック。Claude Code と Grok はまだ実行可能なルートではありません。',
...
copy.ko = {
  ...
  'heroScope': '현재 안내 범위: 전이 가능한 핵심 + Codex 실습 트랙. Claude Code와 Grok은 아직 실행 가능한 경로가 아닙니다.',
...
copy.de = {
  ...
  'heroScope': 'Aktueller geführter Umfang: übertragbarer Kern + Codex-Praxis-Track. Claude Code und Grok sind noch keine ausführbaren Routen.',
