const copy = {
  en: {
    ...
    heroIndex: 'CODEX / LEARNING SYSTEM', heroEyebrow: 'Transferable method · deepest practice in Codex', heroTitle: 'Use Codex for reliable, checkable work.', heroLede: 'Learn a transferable collaboration method, then practise it deeply in Codex: define the outcome, control context and authority, inspect the work, recover from failure, and keep evidence.', heroPrimary: 'Start with a real problem', heroSecondary: 'Open the universal-core route', heroNoteAria: 'Project scope', heroNoteLabel: 'Codex flagship track', heroNoteStatus: 'candidate', heroNoteBody: 'Codex is the deepest worked track. The transferable-core architecture is accepted and its reader route is still being extracted; other named platform tracks are not yet claimed.', heroNoteLink: 'See the evidence boundary', heroFooter: 'Problem → protocol → action → evidence',
    ...
    starterEyebrow: 'Copy now · inspect before action', starterTitle: 'One safe starter prompt.', starterIntro: 'Replace the brackets. The first response may inspect and propose, but it must wait for approval before changing anything.', starterCopy: 'Copy prompt', starterCopied: 'Prompt copied. Review the proposed plan before approving action.', starterCopyFailed: 'Copy failed. Select the prompt text manually.', starterBoundary: 'Copying or sending this prompt proves no action or correct result.', starterProgressionAria: 'Continue from the starter prompt', starterDeepen: 'Deepen the protocol', starterPractice: 'Practise in Lab 002 · draft / not_run', starterEvidence: 'Review claims against evidence',
  ...
  zh: {
    ...
    heroIndex: 'CODEX / 学习系统', heroEyebrow: '可迁移的方法 · 在 Codex 中深入实践', heroTitle: '用 Codex 完成可靠、可检查的真实工作。', heroLede: '先学习一套可迁移的大语言模型协作方法，再在 Codex 中深入实践：定义结果、控制上下文与权限、检查工作、从失败中恢复，并保留证据。', heroPrimary: '从一个真实问题开始', heroSecondary: '打开通用核心路线', heroNoteAria: '项目范围', heroNoteLabel: 'Codex 旗舰轨道', heroNoteStatus: '候选', heroNoteBody: 'Codex 是当前最深入的实践轨道。通用核心架构已经采纳，但读者路线仍在提取中；项目尚未声称已完成其他命名平台课程。', heroNoteLink: '查看证据边界', heroFooter: '问题 → 协议 → 行动 → 证据',
    ...
    skillsEyebrow: '能力层', skillsTitle: '十二个 Skill，各有职责。', skillsIntro: 'Skill 是带触发器、输入检查、边界、停止条件、输出契约和验证方式的方法包。', skillCoach: '选择学习路径和练习边界。', skillProtocol: '把模糊请求变成可执行契约。', skillEvidence: '把完成声明拆成可检查证据。', skillSelector: '选择最小有效能力组合。', skillWorkflow: '管理阶段、检查点和交接。', skillResearch: '把问题收敛为可审查知识。', skillContext: '分开稳定原则和易变事实。', skillLearningName: '学习教练', skillLearning: '通过回忆、纠错、延迟复习和迁移进行练习。', skillSourceName: '来源调查', skillSource: '把宽泛搜索变成有边界、有来源的调查。', skillSignalName: '现场信号整理', skillSignal: '把公开报告整理成有边界的需求证据。', skillAdapterName: '平台适配审查', skillAdapter: '拒绝没有来源、运行和真实差异的平台教程。', skillTriageName: '沟通故障分诊', skillTriage: '诊断一次失败交互，并复测最小修复。', skillBoundaryName: '原创方法优先。', skillBoundary: '外部 Skill 必须保留原项目链接和许可证边界。', skillIndexLink: '打开 Skill 登记表与全部 12 个方法', mobileIndexAria: '完整项目索引', mobileIndexChapters: '章', mobileIndexLabs: '实验', mobileIndexSkills: 'Skill', mobileIndexCases: '现场案例', mobileIndexLocales: '语言记录', mobileIndexVisuals: '教学图板', mobileIndexUpdates: '更新区域', mobileIndexTrust: '可信度类型', skillFootnote: '12 个项目 Skill 均通过结构检查并保持 candidate；新鲜任务证据仍不完整，最新方法只有三项静态盲测。', lab13Status: '维护者参考运行已接受 · 学习者尚未运行',
...
Object.assign(copy.en, {
  ...
  fileSkillsTitle: 'Reusable methods', fileSkillsBody: '12 project Skills with triggers, boundaries, and evidence contracts.',
  ...
  ledgerProject: 'Project', ledgerChapters: 'Chapters · 22', ledgerLabs: 'Labs · 18', ledgerSkills: 'Skills · 12', ledgerResearch: 'Field research', ledgerResearchNote: 'user reports; not locally reproduced', ledgerSource: 'Open the current status source',
...
Object.assign(copy.zh, {
  ...
  fileLabsTitle: '\u53ef\u89c2\u5bdf\u7684\u5b9e\u8df5', fileLabsBody: '17 \u4e2a\u5b9e\u9a8c\uff1b\u5f53\u524d\u72b6\u6001\uff1adraft\uff1b\u8fd0\u884c\u72b6\u6001\uff1anot_run\u3002',
  fileSkillsTitle: '\u53ef\u590d\u7528\u65b9\u6cd5', fileSkillsBody: '12 \u4e2a\u9879\u76ee Skill\uff0c\u5305\u542b\u89e6\u53d1\u3001\u8fb9\u754c\u4e0e\u8bc1\u636e\u5951\u7ea6\u3002',
  fileDocsTitle: '\u6cbb\u7406\u4e0e\u7814\u7a76', fileDocsBody: '\u72b6\u6001\u3001\u6765\u6e90\u3001\u73b0\u5b9e\u95ee\u9898\u3001\u66f4\u65b0\u89c4\u5219\u4e0e\u8d28\u91cf\u8bb0\u5f55\u3002',
  ledgerTitle: '\u5185\u5bb9\u72b6\u6001', ledgerIntro: '\u5f53\u524d\u72b6\u6001\u6e90\u7684\u7b80\u8bfb\u7248\u3002\u72b6\u6001\u63cf\u8ff0\u8bc1\u636e\uff0c\u4e0d\u63cf\u8ff0\u613f\u666f\u3002',
  ledgerProject: '\u9879\u76ee', ledgerChapters: '\u7ae0\u8282 \u00b7 22', ledgerLabs: '\u5b9e\u9a8c \u00b7 18', ledgerSkills: 'Skill \u00b7 12', ledgerResearch: '\u73b0\u5b9e\u95ee\u9898\u7814\u7a76', ledgerResearchNote: '\u7528\u6237\u62a5\u544a\uff1b\u672c\u5730\u672a\u590d\u73b0', ledgerSource: '\u6253\u5f00\u5f53\u524d\u72b6\u6001\u6e90',
...
Object.assign(copy.en, {
  ...
  repositoryLabs: '18 labs · 1 maintainer reference · 0 learner runs',
...
Object.assign(copy.zh, {
  ...
  repositoryLabs: '18 个实验 · 1 个维护者参考运行 · 0 个学习者运行',
